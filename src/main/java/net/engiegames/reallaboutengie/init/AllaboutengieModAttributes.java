...
public class AllaboutengieModAttributes {
	public static final DeferredRegister<Attribute> REGISTRY = DeferredRegister.create(ForgeRegistries.ATTRIBUTES, AllaboutengieMod.MODID);
	public static final RegistryObject<Attribute> ENGIES_ANTIMATTER_BLESSING_CHANCE_FOR_PLAYER = REGISTRY.register("engies_antimatter_blessing_chance_for_player",
			() -> new RangedAttribute("attribute.allaboutengie.engies_antimatter_blessing_chance_for_player", 0.5, 0.05, 0.55).setSyncable(true));
