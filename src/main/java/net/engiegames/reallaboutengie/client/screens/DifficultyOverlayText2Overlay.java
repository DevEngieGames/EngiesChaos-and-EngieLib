...
import net.engiegames.reallaboutengie.procedures.DifficultyOverlayShow3Procedure;
...
public class DifficultyOverlayText2Overlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (DifficultyOverlayShow3Procedure.execute(entity)) {
			if (Difficulty0ReturnTrueCheckProcedure.execute(world)) {
				...
				Minecraft.getInstance().gui.blit(event.getPoseStack(), w - 125, 0, 0, 0, 125, 28, 125, 28);
			}
