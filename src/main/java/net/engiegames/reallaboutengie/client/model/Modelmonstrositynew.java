...
public class Modelmonstrositynew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("allaboutengie", "modelmonstrositynew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition EyeR_r3 = LeftArm.addOrReplaceChild("EyeR_r3", CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4F, 6.375F, -1.4F, 0.0F, -1.5708F, 0.0F));
		PartDefinition EyeR_r4 = LeftArm.addOrReplaceChild("EyeR_r4", CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.3F, 6.375F, 1.6F, 0.0F, -1.5708F, 0.0F));
		PartDefinition EyeR_r5 = LeftArm.addOrReplaceChild("EyeR_r5", CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6F, 8.375F, 1.6F, 0.0F, -1.5708F, 0.0F));
		PartDefinition EyeR_r6 = LeftArm.addOrReplaceChild("EyeR_r6", CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6F, 6.375F, 0.4F, 0.0F, -1.5708F, 0.0F));
		PartDefinition EyeR_r7 = LeftArm.addOrReplaceChild("EyeR_r7", CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
