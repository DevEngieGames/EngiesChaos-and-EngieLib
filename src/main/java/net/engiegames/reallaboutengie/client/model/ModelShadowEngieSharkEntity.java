...
public class ModelShadowEngieSharkEntity<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("allaboutengie", "model_shadow_engie_shark_entity"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = AngelHat.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.416F, -1.1123F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 22).addBox(-2.0F, -1.916F, -2.1123F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 15)
						.addBox(-3.0F, -1.416F, -3.1123F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(30, 28).addBox(-4.0F, -0.916F, -4.1123F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 28)
						.addBox(-5.0F, -0.416F, -5.1123F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 15).addBox(-6.0F, 0.084F, -6.1123F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r7 = AngelHat.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(17, 126).addBox(-6.1123F, -4.1883F, -5.297F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126).addBox(-5.1123F, -3.8347F, -4.2363F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(45, 126).addBox(-4.1123F, -3.4812F, -3.1757F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126).addBox(-3.1123F, -3.1276F, -2.115F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126)
						.addBox(-2.1123F, -2.7741F, -1.0543F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 126).addBox(-1.1123F, -2.4205F, 0.0063F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 126)
						.addBox(-1.1123F, -1.0063F, 1.4205F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126).addBox(-2.1123F, 0.0543F, 1.7741F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126)
						.addBox(-3.1123F, 1.115F, 2.1276F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 126).addBox(-4.1123F, 2.1757F, 2.4812F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126)
						.addBox(-5.1123F, 3.2363F, 2.8347F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 126).addBox(-6.1123F, 4.297F, 3.1883F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = AngelHat.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(19, 126).addBox(-1.0F, -1.0857F, 1.3411F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126).addBox(-2.0F, -0.0251F, 1.6947F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126)
						.addBox(-3.0F, 1.0356F, 2.0482F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 126).addBox(-4.0F, 2.0962F, 2.4018F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126)
						.addBox(-5.0F, 3.1569F, 2.7553F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 126).addBox(-6.0F, 4.2176F, 3.1089F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 126)
						.addBox(-1.0F, -2.5F, -0.0731F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126).addBox(-2.0F, -2.8535F, -1.1338F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126)
						.addBox(-3.0F, -3.2071F, -2.1944F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 126).addBox(-4.0F, -3.5606F, -3.2551F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126)
						.addBox(-5.0F, -3.9142F, -4.3158F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 126).addBox(-7.0F, 5.2782F, 3.4624F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 126)
						.addBox(-7.0F, -4.6213F, -6.4371F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 126).addBox(-6.0F, -4.2677F, -5.3764F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = AngelHat.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(66, 126).addBox(-7.1123F, 5.3576F, 3.5419F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 126).addBox(-7.1123F, -4.5419F, -6.3576F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.405F, 0.1394F, 2.3562F, -1.4835F, -1.5708F));
		...
		PartDefinition L8 = L7.addOrReplaceChild("L8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r10 = L8.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(42, 0).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.75F)),
		...
		PartDefinition R8 = R7.addOrReplaceChild("R8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r11 = R8.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.75F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.375F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition mid2a = mid2.addOrReplaceChild("mid2a", CubeListBuilder.create().texOffs(1, 145).addBox(-2.6563F, -2.6563F, 0.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 3.5156F, 0.0873F, 0.0F, 0.0F));
		PartDefinition dorsal_r2 = mid2a.addOrReplaceChild("dorsal_r2", CubeListBuilder.create().texOffs(31, 141).addBox(-2.4063F, -5.4687F, 1.4063F, 1.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = Scarf.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(5, 74).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.4315F, 2.6042F, -2.3562F, 0.0F, 0.0F));
		PartDefinition cube_r13 = Scarf.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(5, 74).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.4315F, -2.6208F, -0.7854F, 0.0F, 0.0F));
		PartDefinition cube_r14 = Scarf.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(2, 73).addBox(-0.5F, -0.725F, -4.025F, 1.0F, 1.45F, 8.05F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0091F, -2.1409F, 3.675F, 1.5708F, -0.7854F, -1.5708F));
		PartDefinition cube_r15 = Scarf.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(2, 73).addBox(-0.5F, -0.725F, -4.025F, 1.0F, 1.45F, 8.05F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0091F, -2.1409F, -3.675F, 1.5708F, 0.7854F, -1.5708F));
