...
public class TobySitRenderer extends MobRenderer<TobySitEntity, Modeltobysit<TobySitEntity>> {
	...
	private static final class AnimatedModel extends Modeltobysit<TobySitEntity> {
