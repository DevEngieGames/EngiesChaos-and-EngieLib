...
public class MarshalSleepRenderer extends MobRenderer<MarshalSleepEntity, Modellouisandothersleep<MarshalSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(MarshalSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/marshalsleep.png");
	}

	private static final class AnimatedModel extends Modellouisandothersleep<MarshalSleepEntity> {
