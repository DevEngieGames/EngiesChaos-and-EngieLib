...
public class CBESleepRenderer extends MobRenderer<CBESleepEntity, Modelengiedasharkosleep<CBESleepEntity>> {
	...
	public ResourceLocation getTextureLocation(CBESleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/engiedasharkosleep.png");
	}

	private static final class AnimatedModel extends Modelengiedasharkosleep<CBESleepEntity> {
