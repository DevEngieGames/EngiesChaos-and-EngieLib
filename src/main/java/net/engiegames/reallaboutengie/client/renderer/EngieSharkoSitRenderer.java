...
public class EngieSharkoSitRenderer extends MobRenderer<EngieSharkoSitEntity, Modelboyosit<EngieSharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<EngieSharkoSitEntity> {
