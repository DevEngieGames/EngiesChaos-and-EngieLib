...
public class LegendarySharkoLayRenderer extends MobRenderer<LegendarySharkoLayEntity, Modelboyolay<LegendarySharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<LegendarySharkoLayEntity> {
