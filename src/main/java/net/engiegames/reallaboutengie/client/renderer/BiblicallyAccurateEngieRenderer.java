...
public class BiblicallyAccurateEngieRenderer extends MobRenderer<BiblicallyAccurateEngieEntity, Modelhostile<BiblicallyAccurateEngieEntity>> {
	...
	public ResourceLocation getTextureLocation(BiblicallyAccurateEngieEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/biblicallynew_style1.png");
	}

	private static final class AnimatedModel extends Modelhostile<BiblicallyAccurateEngieEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BiblicallyAccurateEngieEntity>() {
			...
			@Override
			public void setupAnim(BiblicallyAccurateEngieEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
