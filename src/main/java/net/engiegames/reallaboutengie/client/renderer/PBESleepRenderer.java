...
public class PBESleepRenderer extends MobRenderer<PBESleepEntity, Modelengiedasharkosleep<PBESleepEntity>> {
	public PBESleepRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelengiedasharkosleep.LAYER_LOCATION)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(PBESleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/engiedasharkobeesleep.png");
	}

	private static final class AnimatedModel extends Modelengiedasharkosleep<PBESleepEntity> {
