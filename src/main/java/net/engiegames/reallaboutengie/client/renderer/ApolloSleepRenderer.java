...
public class ApolloSleepRenderer extends MobRenderer<ApolloSleepEntity, Modellouisandothersleep<ApolloSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(ApolloSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/apollosleep.png");
	}

	private static final class AnimatedModel extends Modellouisandothersleep<ApolloSleepEntity> {
