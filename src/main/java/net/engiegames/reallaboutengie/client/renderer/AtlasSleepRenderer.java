...
public class AtlasSleepRenderer extends MobRenderer<AtlasSleepEntity, Modellouisandothersleep<AtlasSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(AtlasSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/atlassleep.png");
	}

	private static final class AnimatedModel extends Modellouisandothersleep<AtlasSleepEntity> {
