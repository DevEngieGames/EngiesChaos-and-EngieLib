...
public class TigerRenderer extends MobRenderer<TigerEntity, Modellouisandothers<TigerEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothers<TigerEntity> {
