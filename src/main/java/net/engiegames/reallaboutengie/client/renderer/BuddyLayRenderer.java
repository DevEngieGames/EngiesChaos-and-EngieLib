...
public class BuddyLayRenderer extends MobRenderer<BuddyLayEntity, Modellouisandotherlay<BuddyLayEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlay<BuddyLayEntity> {
