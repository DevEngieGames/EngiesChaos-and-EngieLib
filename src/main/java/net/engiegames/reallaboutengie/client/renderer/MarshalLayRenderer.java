...
public class MarshalLayRenderer extends MobRenderer<MarshalLayEntity, Modellouisandotherlay<MarshalLayEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlay<MarshalLayEntity> {
