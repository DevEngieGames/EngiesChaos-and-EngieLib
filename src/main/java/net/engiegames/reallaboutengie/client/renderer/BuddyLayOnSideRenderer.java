...
public class BuddyLayOnSideRenderer extends MobRenderer<BuddyLayOnSideEntity, Modellouisandotherlayonside<BuddyLayOnSideEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlayonside<BuddyLayOnSideEntity> {
