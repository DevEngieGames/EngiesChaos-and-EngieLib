...
public class MarshalSitRenderer extends MobRenderer<MarshalSitEntity, Modellouisandothersit<MarshalSitEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothersit<MarshalSitEntity> {
