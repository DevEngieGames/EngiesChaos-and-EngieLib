...
public class SharkoSleepRenderer extends MobRenderer<SharkoSleepEntity, Modelboyosleep<SharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(SharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/sharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<SharkoSleepEntity> {
