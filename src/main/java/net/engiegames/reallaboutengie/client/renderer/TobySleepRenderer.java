...
public class TobySleepRenderer extends MobRenderer<TobySleepEntity, Modeltobysleep<TobySleepEntity>> {
	public TobySleepRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modeltobysleep.LAYER_LOCATION)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(TobySleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/tobysleep.png");
	}

	private static final class AnimatedModel extends Modeltobysleep<TobySleepEntity> {
