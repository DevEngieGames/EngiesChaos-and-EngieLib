...
public class RareSharkoSleepRenderer extends MobRenderer<RareSharkoSleepEntity, Modelboyosleep<RareSharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(RareSharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/raresharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<RareSharkoSleepEntity> {
