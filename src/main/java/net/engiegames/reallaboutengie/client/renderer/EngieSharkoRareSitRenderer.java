...
public class EngieSharkoRareSitRenderer extends MobRenderer<EngieSharkoRareSitEntity, Modelboyosit<EngieSharkoRareSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<EngieSharkoRareSitEntity> {
