...
public class FinneganSitRenderer extends MobRenderer<FinneganSitEntity, Modelboyosit<FinneganSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<FinneganSitEntity> {
