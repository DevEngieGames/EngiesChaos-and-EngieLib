...
public class LouisLayOnSideRenderer extends MobRenderer<LouisLayOnSideEntity, Modellouisandotherlayonside<LouisLayOnSideEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlayonside<LouisLayOnSideEntity> {
