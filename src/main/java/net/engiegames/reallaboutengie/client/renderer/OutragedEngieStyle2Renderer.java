...
public class OutragedEngieStyle2Renderer extends MobRenderer<OutragedEngieStyle2Entity, Modelhostile<OutragedEngieStyle2Entity>> {
	...
	@Override
	protected void scale(OutragedEngieStyle2Entity entity, PoseStack poseStack, float f) {
		poseStack.scale(0.93f, 0.93f, 0.93f);
	}

	@Override
	public ResourceLocation getTextureLocation(OutragedEngieStyle2Entity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/outragednew_style2.png");
	}

	private static final class AnimatedModel extends Modelhostile<OutragedEngieStyle2Entity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<OutragedEngieStyle2Entity>() {
			...
			@Override
			public void setupAnim(OutragedEngieStyle2Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
