...
public class CBELayRenderer extends MobRenderer<CBELayEntity, Modelengiedasharkolay<CBELayEntity>> {
	...
	private static final class AnimatedModel extends Modelengiedasharkolay<CBELayEntity> {
