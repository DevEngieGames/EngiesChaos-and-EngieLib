...
public class SharkoLayRenderer extends MobRenderer<SharkoLayEntity, Modelboyolay<SharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<SharkoLayEntity> {
