...
public class MarshalLayOnSideRenderer extends MobRenderer<MarshalLayOnSideEntity, Modellouisandotherlayonside<MarshalLayOnSideEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlayonside<MarshalLayOnSideEntity> {
