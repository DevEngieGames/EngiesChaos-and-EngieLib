...
public class MonstrosityEngieRenderer extends MobRenderer<MonstrosityEngieEntity, Modelmonstrositynew<MonstrosityEngieEntity>> {
	...
	public ResourceLocation getTextureLocation(MonstrosityEngieEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/monstrositynew_style1.png");
	}

	private static final class AnimatedModel extends Modelmonstrositynew<MonstrosityEngieEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MonstrosityEngieEntity>() {
			...
			@Override
			public void setupAnim(MonstrosityEngieEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
