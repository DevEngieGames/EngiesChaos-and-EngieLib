...
public class ExoticSharkoTamedRenderer extends MobRenderer<ExoticSharkoTamedEntity, Modelboyotamed<ExoticSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<ExoticSharkoTamedEntity> {
