...
public class ApolloRenderer extends MobRenderer<ApolloEntity, Modellouisandothers<ApolloEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothers<ApolloEntity> {
