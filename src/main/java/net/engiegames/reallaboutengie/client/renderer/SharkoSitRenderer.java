...
public class SharkoSitRenderer extends MobRenderer<SharkoSitEntity, Modelboyosit<SharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<SharkoSitEntity> {
