...
public class BuddySitRenderer extends MobRenderer<BuddySitEntity, Modellouisandothersit<BuddySitEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothersit<BuddySitEntity> {
