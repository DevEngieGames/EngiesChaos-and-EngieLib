...
public class EngieSharkoRareLayRenderer extends MobRenderer<EngieSharkoRareLayEntity, Modelboyolay<EngieSharkoRareLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<EngieSharkoRareLayEntity> {
