...
public class AtlasLayOnSideRenderer extends MobRenderer<AtlasLayOnSideEntity, Modellouisandotherlayonside<AtlasLayOnSideEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlayonside<AtlasLayOnSideEntity> {
