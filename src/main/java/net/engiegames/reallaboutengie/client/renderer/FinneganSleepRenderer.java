...
public class FinneganSleepRenderer extends MobRenderer<FinneganSleepEntity, Modelboyosleep<FinneganSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(FinneganSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/rareengiesharkonewsleepfox.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<FinneganSleepEntity> {
