...
public class MythicSharkoSitRenderer extends MobRenderer<MythicSharkoSitEntity, Modelboyosit<MythicSharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<MythicSharkoSitEntity> {
