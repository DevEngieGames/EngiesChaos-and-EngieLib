...
public class Bothan2netRenderer extends MobRenderer<Bothan2netEntity, Modellouisandothers<Bothan2netEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothers<Bothan2netEntity> {
