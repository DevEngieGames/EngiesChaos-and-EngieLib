...
public class Bothan2netSleepRenderer extends MobRenderer<Bothan2netSleepEntity, Modellouisandothersleep<Bothan2netSleepEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothersleep<Bothan2netSleepEntity> {
