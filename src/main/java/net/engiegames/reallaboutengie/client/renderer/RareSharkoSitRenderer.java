...
public class RareSharkoSitRenderer extends MobRenderer<RareSharkoSitEntity, Modelboyosit<RareSharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<RareSharkoSitEntity> {
