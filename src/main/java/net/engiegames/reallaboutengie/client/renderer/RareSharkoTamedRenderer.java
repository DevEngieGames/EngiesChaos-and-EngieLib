...
public class RareSharkoTamedRenderer extends MobRenderer<RareSharkoTamedEntity, Modelboyotamed<RareSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<RareSharkoTamedEntity> {
