...
public class EngieSharkoRareSleepRenderer extends MobRenderer<EngieSharkoRareSleepEntity, Modelboyosleep<EngieSharkoRareSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(EngieSharkoRareSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/rareengiesharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<EngieSharkoRareSleepEntity> {
