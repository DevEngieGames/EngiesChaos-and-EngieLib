...
public class CBERenderer extends MobRenderer<CBEEntity, Modelengiedasharko<CBEEntity>> {
	public CBERenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelengiedasharko.LAYER_LOCATION)), 0.5f);
	}
	...
	private static final class AnimatedModel extends Modelengiedasharko<CBEEntity> {
