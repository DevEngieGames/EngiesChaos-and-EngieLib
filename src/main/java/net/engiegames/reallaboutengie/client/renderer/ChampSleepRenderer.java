...
public class ChampSleepRenderer extends MobRenderer<ChampSleepEntity, Modelchampsleep<ChampSleepEntity>> {
	public ChampSleepRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelchampsleep.LAYER_LOCATION)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(ChampSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/champsleep.png");
	}

	private static final class AnimatedModel extends Modelchampsleep<ChampSleepEntity> {
