...
public class FinneganRenderer extends MobRenderer<FinneganEntity, Modelboyotamed<FinneganEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<FinneganEntity> {
