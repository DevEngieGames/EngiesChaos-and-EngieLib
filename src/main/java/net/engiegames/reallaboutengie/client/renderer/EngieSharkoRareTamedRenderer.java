...
public class EngieSharkoRareTamedRenderer extends MobRenderer<EngieSharkoRareTamedEntity, Modelboyotamed<EngieSharkoRareTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<EngieSharkoRareTamedEntity> {
