...
public class EnragedEngieStyle2Renderer extends MobRenderer<EnragedEngieStyle2Entity, Modelhostile<EnragedEngieStyle2Entity>> {
	...
	@Override
	protected void scale(EnragedEngieStyle2Entity entity, PoseStack poseStack, float f) {
		poseStack.scale(0.93f, 0.93f, 0.93f);
	}

	@Override
	public ResourceLocation getTextureLocation(EnragedEngieStyle2Entity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/enragednew_style2.png");
	}

	private static final class AnimatedModel extends Modelhostile<EnragedEngieStyle2Entity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<EnragedEngieStyle2Entity>() {
			...
			@Override
			public void setupAnim(EnragedEngieStyle2Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
