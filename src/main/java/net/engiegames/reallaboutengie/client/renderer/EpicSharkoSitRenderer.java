...
public class EpicSharkoSitRenderer extends MobRenderer<EpicSharkoSitEntity, Modelboyosit<EpicSharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<EpicSharkoSitEntity> {
