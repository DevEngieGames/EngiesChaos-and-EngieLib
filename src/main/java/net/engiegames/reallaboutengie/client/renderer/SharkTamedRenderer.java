...
public class SharkTamedRenderer extends MobRenderer<SharkTamedEntity, Modelboyotamed<SharkTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<SharkTamedEntity> {
