...
public class AngryEngieStyle2Renderer extends MobRenderer<AngryEngieStyle2Entity, Modelhostile<AngryEngieStyle2Entity>> {
	...
	@Override
	protected void scale(AngryEngieStyle2Entity entity, PoseStack poseStack, float f) {
		poseStack.scale(0.93f, 0.93f, 0.93f);
	}

	@Override
	public ResourceLocation getTextureLocation(AngryEngieStyle2Entity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/angrynew_style2.png");
	}

	private static final class AnimatedModel extends Modelhostile<AngryEngieStyle2Entity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<AngryEngieStyle2Entity>() {
			...
			@Override
			public void setupAnim(AngryEngieStyle2Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
