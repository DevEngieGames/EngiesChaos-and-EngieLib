...
public class LouisLayRenderer extends MobRenderer<LouisLayEntity, Modellouisandotherlay<LouisLayEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlay<LouisLayEntity> {
