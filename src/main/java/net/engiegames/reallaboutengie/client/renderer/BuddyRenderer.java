...
public class BuddyRenderer extends MobRenderer<BuddyEntity, Modellouisandothers<BuddyEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothers<BuddyEntity> {
