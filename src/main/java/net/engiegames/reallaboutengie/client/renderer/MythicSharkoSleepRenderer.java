...
public class MythicSharkoSleepRenderer extends MobRenderer<MythicSharkoSleepEntity, Modelboyosleep<MythicSharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(MythicSharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/mythicsharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<MythicSharkoSleepEntity> {
