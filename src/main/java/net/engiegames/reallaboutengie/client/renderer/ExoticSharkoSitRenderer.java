...
public class ExoticSharkoSitRenderer extends MobRenderer<ExoticSharkoSitEntity, Modelboyosit<ExoticSharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<ExoticSharkoSitEntity> {
