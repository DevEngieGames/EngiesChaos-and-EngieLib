...
public class AtlasSitRenderer extends MobRenderer<AtlasSitEntity, Modellouisandothersit<AtlasSitEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothersit<AtlasSitEntity> {
