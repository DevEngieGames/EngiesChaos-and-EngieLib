...
public class BuddySleepRenderer extends MobRenderer<BuddySleepEntity, Modellouisandothersleep<BuddySleepEntity>> {
	...
	public ResourceLocation getTextureLocation(BuddySleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/buddysleep.png");
	}

	private static final class AnimatedModel extends Modellouisandothersleep<BuddySleepEntity> {
