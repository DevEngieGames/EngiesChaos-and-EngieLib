...
public class ApolloLayRenderer extends MobRenderer<ApolloLayEntity, Modellouisandotherlay<ApolloLayEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlay<ApolloLayEntity> {
