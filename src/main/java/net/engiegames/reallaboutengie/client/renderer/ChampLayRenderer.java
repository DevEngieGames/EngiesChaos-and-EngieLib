...
public class ChampLayRenderer extends MobRenderer<ChampLayEntity, Modelchamplay<ChampLayEntity>> {
	public ChampLayRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelchamplay.LAYER_LOCATION)), 0.5f);
	}
	...
	private static final class AnimatedModel extends Modelchamplay<ChampLayEntity> {
