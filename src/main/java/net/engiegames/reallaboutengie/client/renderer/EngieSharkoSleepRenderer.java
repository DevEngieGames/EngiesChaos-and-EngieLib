...
public class EngieSharkoSleepRenderer extends MobRenderer<EngieSharkoSleepEntity, Modelboyosleep<EngieSharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(EngieSharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/engiesharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<EngieSharkoSleepEntity> {
