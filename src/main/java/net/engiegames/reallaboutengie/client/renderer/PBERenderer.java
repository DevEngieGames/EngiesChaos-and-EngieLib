...
public class PBERenderer extends MobRenderer<PBEEntity, Modelengiedasharko<PBEEntity>> {
	...
	private static final class AnimatedModel extends Modelengiedasharko<PBEEntity> {
