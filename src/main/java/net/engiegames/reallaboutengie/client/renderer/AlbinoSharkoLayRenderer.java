...
public class AlbinoSharkoLayRenderer extends MobRenderer<AlbinoSharkoLayEntity, Modelboyolay<AlbinoSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<AlbinoSharkoLayEntity> {
