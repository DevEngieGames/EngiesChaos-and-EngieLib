...
public class LegendarySharkoSleepRenderer extends MobRenderer<LegendarySharkoSleepEntity, Modelboyosleep<LegendarySharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(LegendarySharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/legendarysharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<LegendarySharkoSleepEntity> {
