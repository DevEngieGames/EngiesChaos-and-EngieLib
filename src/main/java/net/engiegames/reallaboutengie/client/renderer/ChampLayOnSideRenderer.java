...
import net.engiegames.reallaboutengie.client.model.animations.engiedaboyolayonsideAnimation;
import net.engiegames.reallaboutengie.client.model.Modelchamplayonside;

import com.mojang.math.Vector3f;

public class ChampLayOnSideRenderer extends MobRenderer<ChampLayOnSideEntity, Modelchamplayonside<ChampLayOnSideEntity>> {
	public ChampLayOnSideRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelchamplayonside.LAYER_LOCATION)), 0.5f);
	}
	...
	private static final class AnimatedModel extends Modelchamplayonside<ChampLayOnSideEntity> {
