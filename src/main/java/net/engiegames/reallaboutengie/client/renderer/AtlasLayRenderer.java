...
public class AtlasLayRenderer extends MobRenderer<AtlasLayEntity, Modellouisandotherlay<AtlasLayEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlay<AtlasLayEntity> {
