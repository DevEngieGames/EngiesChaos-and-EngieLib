...
public class AlbinoSharkoSleepRenderer extends MobRenderer<AlbinoSharkoSleepEntity, Modelboyosleep<AlbinoSharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(AlbinoSharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/albinosharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<AlbinoSharkoSleepEntity> {
