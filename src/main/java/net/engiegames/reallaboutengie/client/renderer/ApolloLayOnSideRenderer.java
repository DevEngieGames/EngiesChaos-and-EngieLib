...
public class ApolloLayOnSideRenderer extends MobRenderer<ApolloLayOnSideEntity, Modellouisandotherlayonside<ApolloLayOnSideEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandotherlayonside<ApolloLayOnSideEntity> {
