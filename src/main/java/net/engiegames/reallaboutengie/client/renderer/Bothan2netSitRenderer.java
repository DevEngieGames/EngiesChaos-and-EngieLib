...
public class Bothan2netSitRenderer extends MobRenderer<Bothan2netSitEntity, Modellouisandothersit<Bothan2netSitEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothersit<Bothan2netSitEntity> {
