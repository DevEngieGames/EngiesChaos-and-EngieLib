...
public class RareSharkoLayRenderer extends MobRenderer<RareSharkoLayEntity, Modelboyolay<RareSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<RareSharkoLayEntity> {
