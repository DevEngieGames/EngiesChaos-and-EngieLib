...
public class AlbinoSharkoSitRenderer extends MobRenderer<AlbinoSharkoSitEntity, Modelboyosit<AlbinoSharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<AlbinoSharkoSitEntity> {
