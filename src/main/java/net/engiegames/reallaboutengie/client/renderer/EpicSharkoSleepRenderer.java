...
public class EpicSharkoSleepRenderer extends MobRenderer<EpicSharkoSleepEntity, Modelboyosleep<EpicSharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(EpicSharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/epicsharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<EpicSharkoSleepEntity> {
