...
public class AlbinoSharkoTamedRenderer extends MobRenderer<AlbinoSharkoTamedEntity, Modelboyotamed<AlbinoSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<AlbinoSharkoTamedEntity> {
