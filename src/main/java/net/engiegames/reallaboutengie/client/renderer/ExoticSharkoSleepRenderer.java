...
public class ExoticSharkoSleepRenderer extends MobRenderer<ExoticSharkoSleepEntity, Modelboyosleep<ExoticSharkoSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(ExoticSharkoSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/exoticsharkonewsleep.png");
	}

	private static final class AnimatedModel extends Modelboyosleep<ExoticSharkoSleepEntity> {
