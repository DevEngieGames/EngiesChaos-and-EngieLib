...
public class TigerSitRenderer extends MobRenderer<TigerSitEntity, Modellouisandothersit<TigerSitEntity>> {
	...
	@Override
	protected void scale(TigerSitEntity entity, PoseStack poseStack, float f) {
	...
	private static final class AnimatedModel extends Modellouisandothersit<TigerSitEntity> {
