...
public class ExoticSharkoLayRenderer extends MobRenderer<ExoticSharkoLayEntity, Modelboyolay<ExoticSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<ExoticSharkoLayEntity> {
