...
public class TigerLayRenderer extends MobRenderer<TigerLayEntity, Modellouisandotherlay<TigerLayEntity>> {
	...
	@Override
	protected void scale(TigerLayEntity entity, PoseStack poseStack, float f) {
	...
	private static final class AnimatedModel extends Modellouisandotherlay<TigerLayEntity> {
