...
public class MythicSharkoTamedRenderer extends MobRenderer<MythicSharkoTamedEntity, Modelboyotamed<MythicSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<MythicSharkoTamedEntity> {
