...
public class MarshalRenderer extends MobRenderer<MarshalEntity, Modellouisandothers<MarshalEntity>> {
	...
	private static final class AnimatedModel extends Modellouisandothers<MarshalEntity> {
