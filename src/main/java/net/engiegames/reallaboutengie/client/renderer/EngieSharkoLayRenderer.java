...
public class EngieSharkoLayRenderer extends MobRenderer<EngieSharkoLayEntity, Modelboyolay<EngieSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<EngieSharkoLayEntity> {
