...
public class MythicSharkoLayRenderer extends MobRenderer<MythicSharkoLayEntity, Modelboyolay<MythicSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyolay<MythicSharkoLayEntity> {
