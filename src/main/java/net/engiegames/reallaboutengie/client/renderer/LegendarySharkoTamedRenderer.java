...
public class LegendarySharkoTamedRenderer extends MobRenderer<LegendarySharkoTamedEntity, Modelboyotamed<LegendarySharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<LegendarySharkoTamedEntity> {
