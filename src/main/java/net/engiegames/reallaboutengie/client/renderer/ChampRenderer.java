...
public class ChampRenderer extends MobRenderer<ChampEntity, Modelchamp<ChampEntity>> {
	public ChampRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelchamp.LAYER_LOCATION)), 0.5f);
	}
	...
	private static final class AnimatedModel extends Modelchamp<ChampEntity> {
