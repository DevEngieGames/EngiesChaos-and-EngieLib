...
public class LouisSleepRenderer extends MobRenderer<LouisSleepEntity, Modellouisandothersleep<LouisSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(LouisSleepEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/louissleep.png");
	}

	private static final class AnimatedModel extends Modellouisandothersleep<LouisSleepEntity> {
