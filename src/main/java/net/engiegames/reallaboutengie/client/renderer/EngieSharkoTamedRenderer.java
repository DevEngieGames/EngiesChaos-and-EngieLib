...
public class EngieSharkoTamedRenderer extends MobRenderer<EngieSharkoTamedEntity, Modelboyotamed<EngieSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotamed<EngieSharkoTamedEntity> {
