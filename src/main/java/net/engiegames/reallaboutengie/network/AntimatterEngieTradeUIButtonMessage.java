...
import net.engiegames.reallaboutengie.procedures.EngieSwapFromAntimatterProcedure;
import net.engiegames.reallaboutengie.procedures.AntimatterEngieTradeUIButtonClickedProcedure;
...
public class AntimatterEngieTradeUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(AntimatterEngieTradeUIButtonMessage.class, AntimatterEngieTradeUIButtonMessage::buffer, AntimatterEngieTradeUIButtonMessage::new, AntimatterEngieTradeUIButtonMessage::handler);
	}
}