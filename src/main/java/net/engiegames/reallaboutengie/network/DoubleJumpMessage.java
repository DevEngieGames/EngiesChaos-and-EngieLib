...
import net.engiegames.reallaboutengie.procedures.DoubleJumpOnKeyReleasedProcedure;
import net.engiegames.reallaboutengie.procedures.DoubleJumpOnKeyPressedProcedure;
...
public class DoubleJumpMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(DoubleJumpMessage.class, DoubleJumpMessage::buffer, DoubleJumpMessage::new, DoubleJumpMessage::handler);
	}
}