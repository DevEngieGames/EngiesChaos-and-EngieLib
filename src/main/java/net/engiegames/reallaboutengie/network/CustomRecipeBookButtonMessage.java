...
import net.engiegames.reallaboutengie.procedures.SwapCraftsToAntimatterButtonClickedProcedure;
import net.engiegames.reallaboutengie.procedures.RecipeBookUpOnePageProcedure;
import net.engiegames.reallaboutengie.procedures.RecipeBookUpMaxPagesProcedure;
import net.engiegames.reallaboutengie.procedures.RecipeBookUpFivePagesProcedure;
import net.engiegames.reallaboutengie.procedures.RecipeBookDownOnePageProcedure;
import net.engiegames.reallaboutengie.procedures.RecipeBookDownFivePagesProcedure;
import net.engiegames.reallaboutengie.procedures.RecipeBookDownAllPagesProcedure;
...
public class CustomRecipeBookButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 6) {
			...
			SwapCraftsToAntimatterButtonClickedProcedure.execute(entity);
		}
	}
