...
import net.engiegames.reallaboutengie.procedures.RoughianEngieGamesTradeButtonClickedProcedure;
...
public class RoughianEngieGamesTradeUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(RoughianEngieGamesTradeUIButtonMessage.class, RoughianEngieGamesTradeUIButtonMessage::buffer, RoughianEngieGamesTradeUIButtonMessage::new, RoughianEngieGamesTradeUIButtonMessage::handler);
	}
}