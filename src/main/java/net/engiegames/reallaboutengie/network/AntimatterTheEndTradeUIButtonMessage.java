...
import net.engiegames.reallaboutengie.procedures.TheEndSwapFromAntimatterProcedure;
import net.engiegames.reallaboutengie.procedures.AntimatterTheEndTradeButtonClickedProcedure;
...
public class AntimatterTheEndTradeUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(AntimatterTheEndTradeUIButtonMessage.class, AntimatterTheEndTradeUIButtonMessage::buffer, AntimatterTheEndTradeUIButtonMessage::new, AntimatterTheEndTradeUIButtonMessage::handler);
	}
}