...
import net.engiegames.reallaboutengie.procedures.StunOnKeyPressedProcedure;
...
public class StunMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			StunOnKeyPressedProcedure.execute(world, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(StunMessage.class, StunMessage::buffer, StunMessage::new, StunMessage::handler);
	}
}