...
import net.engiegames.reallaboutengie.procedures.CosmicEngieGamesPickaxeSpecialInformationProcedure;
...
public abstract class CosmicEngieGamessItem extends ArmorItem {
	public CosmicEngieGamessItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{900, 900, 900, 900}[slot.getIndex()];
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.COSMIC_ENGIE_COIN.get()));
			}

			@Override
			public String getName() {
				return "cosmic_engie_gamess";
			}
	...
	public static class Helmet extends CosmicEngieGamessItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/cosmicarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends CosmicEngieGamessItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/cosmicarmorlayer2.png";
		}
	}
