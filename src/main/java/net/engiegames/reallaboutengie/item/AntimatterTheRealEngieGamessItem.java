...
public abstract class AntimatterTheRealEngieGamessItem extends ArmorItem {
	public AntimatterTheRealEngieGamessItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 875;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{875, 875, 875, 875}[slot.getIndex()];
			}
			...
			public String getName() {
				return "antimatter_the_real_engie_gamess";
			}
	...
	public static class Helmet extends AntimatterTheRealEngieGamessItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/antimattertherealengiegamesarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends AntimatterTheRealEngieGamessItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/antimattertherealengiegamesarmorlayer2.png";
		}
	}
