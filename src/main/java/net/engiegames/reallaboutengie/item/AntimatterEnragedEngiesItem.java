...
public abstract class AntimatterEnragedEngiesItem extends ArmorItem {
	public AntimatterEnragedEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "antimatter_enraged_engies";
			}
	...
	public static class Helmet extends AntimatterEnragedEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterenragedengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends AntimatterEnragedEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterenragedengie_layer_2.png";
		}
	}
