...
import net.engiegames.reallaboutengie.procedures.AEBootsProcedure;
...
public abstract class AntimatterAngryEngiesItem extends ArmorItem {
	public AntimatterAngryEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 650;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{650, 650, 650, 650}[slot.getIndex()];
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ANTIMATTER_ANGRY_ENGIE_ESSENCE.get()));
			}

			@Override
			public String getName() {
				return "antimatter_angry_engies";
			}
	...
	public static class Helmet extends AntimatterAngryEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterangryengi_layer_1.png";
		}
	}
	...
	public static class Leggings extends AntimatterAngryEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterangryengi_layer_2.png";
		}
	}
