...
import net.engiegames.reallaboutengie.procedures.BAEChestplateProcedure;
import net.engiegames.reallaboutengie.procedures.BAEBootsProcedure;
...
public abstract class AntimatterBiblicallyAccurateEngiesItem extends ArmorItem {
	public AntimatterBiblicallyAccurateEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ANTIMATTER_BIBLICALLY_ACCURATE_ENGIE_ESSENCE.get()));
			}
	...
	public static class Helmet extends AntimatterBiblicallyAccurateEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterbiblicallyaccurateengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends AntimatterBiblicallyAccurateEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterbiblicallyaccurateengie_layer_2.png";
		}
	}
