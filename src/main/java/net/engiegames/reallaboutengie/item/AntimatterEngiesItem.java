...
public abstract class AntimatterEngiesItem extends ArmorItem {
	public AntimatterEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 625;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{625, 625, 625, 625}[slot.getIndex()];
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ANTIMATTER_ENGIE_GEM.get()));
			}

			@Override
			public String getName() {
				return "antimatter_engies";
			}
	...
	public static class Helmet extends AntimatterEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends AntimatterEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/antimatterengie_layer_2.png";
		}
	}
