...
import net.engiegames.reallaboutengie.procedures.CrackersInBowlOnPlayerStoppedUsingProcedure;
...
public class CrackersInBowlItem extends Item {
	public CrackersInBowlItem() {
		super(new Item.Properties().tab(AllaboutengieModTabs.TAB_AAE_ITEMS_FOOD).durability(21).food((new FoodProperties.Builder()).nutrition(3).saturationMod(0.3f).build()));
	}
