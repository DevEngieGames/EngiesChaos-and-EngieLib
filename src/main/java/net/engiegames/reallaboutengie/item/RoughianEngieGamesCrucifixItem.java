...
public class RoughianEngieGamesCrucifixItem extends Item {
	public RoughianEngieGamesCrucifixItem() {
		super(new Item.Properties().tab(AllaboutengieModTabs.TAB_AAE_ITEMS_ITEMS).durability(450).rarity(Rarity.EPIC));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.allaboutengie.roughian_engie_games_crucifix.description_0"));
	}
}