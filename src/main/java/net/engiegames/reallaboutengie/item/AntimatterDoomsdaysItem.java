...
public abstract class AntimatterDoomsdaysItem extends ArmorItem {
	public AntimatterDoomsdaysItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ANTIMATTER_DOOMSDAY_COIN.get()));
			}
	...
	public static class Helmet extends AntimatterDoomsdaysItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/antimatterdoomsdayarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends AntimatterDoomsdaysItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/antimatterdoomsdayarmorlayer2.png";
		}
	}
