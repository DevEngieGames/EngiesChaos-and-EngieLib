...
public abstract class RoughianEngieGamessItem extends ArmorItem {
	public RoughianEngieGamessItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 950;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{950, 950, 950, 950}[slot.getIndex()];
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ENRAGED_COIN.get()), new ItemStack(AllaboutengieModItems.DOOMS_DAY_COIN.get()), new ItemStack(AllaboutengieModItems.SUPER_DOOMS_DAY_COIN.get()),
						new ItemStack(AllaboutengieModItems.THE_END_COIN.get()), new ItemStack(AllaboutengieModItems.ENGIE_COIN.get()), new ItemStack(AllaboutengieModItems.ANTIMATTER_THE_END_COIN.get()),
						new ItemStack(AllaboutengieModItems.ANTIMATTER_ENGIE_COIN.get()), new ItemStack(AllaboutengieModItems.ANTIMATTER_DOOMSDAY_COIN.get()), new ItemStack(AllaboutengieModItems.ANTIMATTER_SUPER_DOOMSDAY_COIN.get()),
						new ItemStack(AllaboutengieModItems.COSMIC_ENGIE_COIN.get()), new ItemStack(AllaboutengieModItems.ANGRY_ENGIE_ESSENCE.get()), new ItemStack(AllaboutengieModItems.ENRAGED_ENGIE_ESSENCE.get()),
						...
						new ItemStack(AllaboutengieModItems.ANTIMATTER_MONSTROSITY_ENGIE_ESSENCE.get()));
			}

			@Override
			public String getName() {
				return "roughian_engie_gamess";
			}
	...
	public static class Helmet extends RoughianEngieGamessItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/rougharmorlayer1.png";
		}
	}

	public static class Chestplate extends RoughianEngieGamessItem {
		public Chestplate() {
	...
	public static class Leggings extends RoughianEngieGamessItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/rougharmorlayer2.png";
		}
	}

	public static class Boots extends RoughianEngieGamessItem {
		public Boots() {
