...
import net.engiegames.reallaboutengie.procedures.ChallengeInsanityEngiePlushRightclickedProcedure;
import net.engiegames.reallaboutengie.procedures.ChallengeInsanityEngiePlushItemInInventoryTickProcedure;
...
public class ChallengeInsanityEngiePlushItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.allaboutengie.challenge_insanity_engie_plush.description_0"));
	}
