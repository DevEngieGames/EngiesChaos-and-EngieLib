...
public abstract class XEngieItem extends ArmorItem {
	public XEngieItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ENGIE_GEM.get()), new ItemStack(AllaboutengieModItems.ANGRY_ENGIE_ESSENCE.get()), new ItemStack(AllaboutengieModItems.ENRAGED_ENGIE_ESSENCE.get()),
						...
						new ItemStack(AllaboutengieModItems.ANTIMATTER_ENGIE_GAMES_COIN.get()), new ItemStack(AllaboutengieModItems.ENGIE_GAMES_TESSERACT.get()));
			}
	...
	public static class Helmet extends XEngieItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.allaboutengie.x_engie_helmet.description_0"));
			list.add(Component.translatable("item.allaboutengie.x_engie_helmet.description_1"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/xengiearmor.png";
		}
	}

	public static class Chestplate extends XEngieItem {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.allaboutengie.x_engie_chestplate.description_0"));
			list.add(Component.translatable("item.allaboutengie.x_engie_chestplate.description_1"));
		}
	...
	public static class Leggings extends XEngieItem {
		public Leggings() {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.allaboutengie.x_engie_leggings.description_0"));
			list.add(Component.translatable("item.allaboutengie.x_engie_leggings.description_1"));
		}
	...
	public static class Boots extends XEngieItem {
		public Boots() {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.allaboutengie.x_engie_boots.description_0"));
			list.add(Component.translatable("item.allaboutengie.x_engie_boots.description_1"));
		}
