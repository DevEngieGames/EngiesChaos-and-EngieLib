...
public class MindscapeTradeUITickProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (getAmountInGUISlot(entity, 0) >= 64 && getAmountInGUISlot(entity, 1) >= 64 && getAmountInGUISlot(entity, 2) >= 64) {
			...
			if (((entity instanceof Player _entity17 && _entity17.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu17) ? _menu17.getMenuState(1, "scythetrade", false) : false)
					&& !((entity instanceof Player _entity18 && _entity18.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu18) ? _menu18.getMenuState(1, "bantrade", false) : false)) {
				if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
			...
			} else if (((entity instanceof Player _entity20 && _entity20.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu20) ? _menu20.getMenuState(1, "bantrade", false) : false)
					&& !((entity instanceof Player _entity21 && _entity21.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu21) ? _menu21.getMenuState(1, "scythetrade", false) : false)) {
				if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
					...
					&& !((entity instanceof Player _entity24 && _entity24.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu24) ? _menu24.getMenuState(1, "scythetrade", false) : false)) {
		...
		} else if (((entity instanceof Player _entity81 && _entity81.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu81) ? _menu81.getMenuState(1, "scythetrade", false) : false)
				&& ((entity instanceof Player _entity82 && _entity82.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu82) ? _menu82.getMenuState(1, "bantrade", false) : false)) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
