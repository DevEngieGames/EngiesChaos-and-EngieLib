...
public class CosmicDeathSharkoTameRCProcedure {
				...
				entity.discard();
			{
				...
				if (!_ent.level.isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level.getServer(), _ent), "summon allaboutengie:cosmic_death_sharko_lay ~ ~ ~");
				}
			}
			AllaboutengieMod.queueServerWork(1, () -> {
				if ((findEntityInWorldRange(world, CosmicDeathSharkoLayEntity.class, x, y, z, 1)) instanceof CosmicDeathSharkoLayEntity) {
					if (!(entity.getDisplayName().getString()).equals("Cosmic Death Sharko")) {
						(findEntityInWorldRange(world, CosmicDeathSharkoLayEntity.class, x, y, z, 1)).setCustomName(Component.literal((entity.getDisplayName().getString())));
					}
				}
				if ((findEntityInWorldRange(world, CosmicDeathSharkoLayEntity.class, x, y, z, 1)) instanceof LivingEntity _entity)
