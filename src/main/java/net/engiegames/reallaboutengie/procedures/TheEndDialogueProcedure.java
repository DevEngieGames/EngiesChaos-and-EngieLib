															...
															AllaboutengieMod.queueServerWork(20, () -> {
																...
																AllaboutengieMod.queueServerWork(20, () -> {
																	...
																	AllaboutengieMod.queueServerWork(100, () -> {
																		...
																		if (world instanceof Level _level) {
																			if (!_level.isClientSide()) {
																				_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("allaboutengie:doomsday_start")), SoundSource.MUSIC, (float) 1.5,
																						1);
																			} else {
