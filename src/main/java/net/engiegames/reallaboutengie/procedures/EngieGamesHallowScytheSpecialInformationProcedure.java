...
public class EngieGamesHallowScytheSpecialInformationProcedure {
	public static String execute(LevelAccessor world, ItemStack itemstack) {
		if (EnchantmentHelper.getItemEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_BLESSING.get(), itemstack) != 0 && !(EnchantmentHelper.getItemEnchantmentLevel(Enchantments.MOB_LOOTING, itemstack) != 0)
			...
			return ("Current chance of antimatter drops for item: " + new java.text.DecimalFormat("\u00A7e##").format(itemstack.getEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_ANTIMATTER_BLESSING.get()) + 5) + "%" + "\n") + "\u00A78"
					...
					+ "\u00A7c- Engie's \u00A76Blessing" + "\n" + "\u00A73Enchantment Level: " + new java.text.DecimalFormat("\u00A7e##").format(itemstack.getEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_BLESSING.get())) + "\n"
		...
		} else if (EnchantmentHelper.getItemEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_BLESSING.get(), itemstack) != 0 && EnchantmentHelper.getItemEnchantmentLevel(Enchantments.MOB_LOOTING, itemstack) != 0
				&& !(EnchantmentHelper.getItemEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_ANTIMATTER_BLESSING.get(), itemstack) != 0)) {
			return ("Current chance of antimatter drops for item: " + new java.text.DecimalFormat("\u00A7e##").format(itemstack.getEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_ANTIMATTER_BLESSING.get()) + 5) + "%" + "\n") + "\u00A78"
					+ "EngieGames's Hallow Scythe" + " - Kills: " + new java.text.DecimalFormat("##").format(itemstack.getOrCreateTag().getDouble("engiegameshallowscythestatclockcount")) + "\n" + "\u00A7eCustom Enchantments:" + "\n"
					+ "\u00A7c- Engie's \u00A76Blessing" + "\n" + "\u00A73Enchantment Level: " + new java.text.DecimalFormat("\u00A7e##").format(itemstack.getEnchantmentLevel(AllaboutengieModEnchantments.ENGIES_BLESSING.get())) + "\n"
