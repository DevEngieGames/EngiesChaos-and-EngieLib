																														...
																														if (entity instanceof ServerPlayer _plr28 && _plr28.level instanceof ServerLevel && _plr28.getAdvancements().getOrStartProgress(
																															...
																															if (entity instanceof ServerPlayer _plr29 && _plr29.level instanceof ServerLevel
																																	&& _plr29.getAdvancements().getOrStartProgress(_plr29.server.getAdvancements()
																																			.getAdvancement(new ResourceLocation("allaboutengie:doomsday_ban_scythe_obtain"))).isDone()) {
																																if (entity instanceof ServerPlayer _plr30 && _plr30.level instanceof ServerLevel
																																		&& _plr30.getAdvancements()
																																				.getOrStartProgress(_plr30.server.getAdvancements()
																																						.getAdvancement(new ResourceLocation("allaboutengie:super_doomsday_ban_scythe_obtain")))
																																				.isDone()) {
																																	if (entity instanceof ServerPlayer _plr31 && _plr31.level instanceof ServerLevel
																																			&& _plr31.getAdvancements().getOrStartProgress(_plr31.server.getAdvancements()
																																					.getAdvancement(new ResourceLocation("allaboutengie:the_end_ban_scythe_obtain"))).isDone()) {
																																		if (entity instanceof ServerPlayer _plr32 && _plr32.level instanceof ServerLevel
																																				&& _plr32.getAdvancements()
																																						.getOrStartProgress(_plr32.server.getAdvancements()
																																								.getAdvancement(new ResourceLocation("allaboutengie:engies_ban_scythe_obtain")))
																																						.isDone()) {
																																			if (entity instanceof ServerPlayer _plr33 && _plr33.level instanceof ServerLevel
																																					&& _plr33.getAdvancements()
																																							.getOrStartProgress(_plr33.server.getAdvancements()
																																									.getAdvancement(new ResourceLocation("allaboutengie:mindscape_ban_scythe_obtain")))
																																							.isDone()) {
																																				if (entity instanceof ServerPlayer _plr34 && _plr34.level instanceof ServerLevel
																																						&& _plr34.getAdvancements()
																																								.getOrStartProgress(_plr34.server.getAdvancements()
																																										.getAdvancement(new ResourceLocation("allaboutengie:engie_games_sword_obtained")))
																																								.isDone()) {
																																					if (entity instanceof ServerPlayer _plr35 && _plr35.level instanceof ServerLevel
																																							&& _plr35.getAdvancements()
																																									.getOrStartProgress(_plr35.server.getAdvancements()
																																											.getAdvancement(new ResourceLocation("allaboutengie:doomsday_coin_obtained")))
																																									.isDone()) {
																																						if (entity instanceof ServerPlayer _plr36 && _plr36.level instanceof ServerLevel
																																								&& _plr36.getAdvancements()
																																										.getOrStartProgress(_plr36.server.getAdvancements().getAdvancement(
																																												new ResourceLocation("allaboutengie:super_doomsday_coin_obtained")))
																																										.isDone()) {
																																							if (entity instanceof ServerPlayer _plr37 && _plr37.level instanceof ServerLevel
																																									&& _plr37.getAdvancements()
																																											.getOrStartProgress(_plr37.server.getAdvancements().getAdvancement(
																																													new ResourceLocation("allaboutengie:the_end_coin_obtained")))
																																											.isDone()) {
																																								if (entity instanceof ServerPlayer _plr38 && _plr38.level instanceof ServerLevel
																																										&& _plr38.getAdvancements()
																																												.getOrStartProgress(_plr38.server.getAdvancements().getAdvancement(
																																														new ResourceLocation("allaboutengie:engie_coin_obtained")))
																																												.isDone()) {
																																											...
																																											&& _plr39.getAdvancements()
																																													.getOrStartProgress(_plr39.server.getAdvancements()
																																															.getAdvancement(new ResourceLocation(
																																																	"allaboutengie:engie_games_coin_obtained")))
																																													.isDone()) {
																																																																													...
																																																																													&& _plr73
																																																																															...
																																																																															.getOrStartProgress(
																																																																																	_plr73.server
																																																																																			...
																																																																																			.getAdvancement(
																																																																																					new ResourceLocation(
																																																																																							"allaboutengie:mindscape_ban_scythe_obtain")))
																																																																															.isDone()) {
																																																																														...
																																																																														&& _plr74
																																																																																...
																																																																																.getOrStartProgress(
																																																																																		_plr74.server
																																																																																				...
																																																																																				.getAdvancement(
																																																																																						new ResourceLocation(
																																																																																								"allaboutengie:engie_games_sword_obtained")))
																																																																																.isDone()) {
																																																																																...
																																																																																if (entity instanceof ServerPlayer _plr78
																																																																																	...
																																																																																	if (entity instanceof ServerPlayer _plr79
																																																																																		...
																																																																																		if ((world
																																																																																				...
																																																																																				.getGameRules()
																																																																																				.getBoolean(
																																																																																						AllaboutengieModGameRules.TRUE_HARDCORE) == false
																																																																																				|| world.getLevelData()
																																																																																						.getGameRules()
																																																																																						.getBoolean(
																																																																																								AllaboutengieModGameRules.ONE_HP) == true)
																																																																																				&& world.getLevelData()
																																																																																						.getGameRules()
																																																																																						.getBoolean(
																																																																																				...
																																																																																				&& world.getLevelData()
																																																																																						.getGameRules()
																																																																																						.getBoolean(
																																																																																								AllaboutengieModGameRules.DOOMSDAY_TOGGLE) == false) {
																																																																																			if (entity instanceof ServerPlayer _plr84
																																																																																				...
																																																																																				.getGameRules()
																																																																																				.getBoolean(
																																																																																						AllaboutengieModGameRules.TRUE_HARDCORE) == true
																																																																																				&& world.getLevelData()
																																																																																						.getGameRules()
																																																																																						.getBoolean(
																																																																																								AllaboutengieModGameRules.ONE_HP) == false
																																																																																				&& world.getLevelData()
																																																																																						.getGameRules()
																																																																																						.getBoolean(
																																																																																								AllaboutengieModGameRules.DETECTIVE_MODE) == false
																																																																																				&& world.getLevelData()
																																																																																						.getGameRules()
																																																																																						.getBoolean(
																																																																																												...
																																																																																												if (entity instanceof ServerPlayer _plr105
																																																																																													...
																																																																																													if (entity instanceof ServerPlayer _plr106
																																																																																															...
																																																																																															&& _plr106
																																																																																																	...
																																																																																																	.isDone()
																																																																																															|| entity instanceof ServerPlayer _plr107
																																																																																													...
																																																																																													if (entity instanceof ServerPlayer _plr130
																																																																																														...
																																																																																														if (entity instanceof ServerPlayer _plr132
																																																																																															...
																																																																																															if (!(entity instanceof ServerPlayer _plr133
																																																																																																	&& _plr133.level instanceof ServerLevel
																																																																																																	&& _plr133
																																																																																																			.getAdvancements()
																																																																																																			.getOrStartProgress(
																																																																																																					_plr133.server
																																																																																																			...
																																																																																																			_plr152.server
																																																																																																					...
																																																																																																					.getAdvancement(
																																																																																																							new ResourceLocation(
																																																																																																									"allaboutengie:challenge_destroyed")))
																																																																																																	.isDone()
																																																																																															|| entity instanceof ServerPlayer _plr153
																																																																																			...
																																																																																			if (entity instanceof ServerPlayer _plr167
																																																																																				...
																																																																																				&& world.getLevelData()
																																																																																						...
																																																																																						.getBoolean(
																																																																																								AllaboutengieModGameRules.DOOMSDAY_TOGGLE) == false) {
																																																																																			if (!(entity instanceof ServerPlayer _plr177
																																																																																					&& _plr177.level instanceof ServerLevel
																																																																																					&& _plr177
																																																																																							.getAdvancements()
																																																																																							.getOrStartProgress(
																																																																																									_plr177.server
																																																																																			...
																																																																																			if (entity instanceof ServerPlayer _plr179
																																																																																					&& _plr179.level instanceof ServerLevel
																																																																																					&& _plr179
																																																																																							.getAdvancements()
																																																																																							.getOrStartProgress(
																																																																																									_plr179.server
																																																																																											...
																																																																																											.getAdvancement(
																																																																																													new ResourceLocation(
																																																																																															"allaboutengie:secret_advancements_completed")))
																																																																																							.isDone()) {
																																																																																				if (!(entity instanceof ServerPlayer _plr180
																																																																																						&& _plr180.level instanceof ServerLevel
																																																																																						&& _plr180
																																																																																								.getAdvancements()
																																																																																								.getOrStartProgress(
																																																																																										_plr180.server
