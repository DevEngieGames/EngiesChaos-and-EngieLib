...
public class RegularMetalBundleNameChangeProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.REGULAR_ENGIE_BUNDLE.get()) {
		...
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.REGULAR_ENGIE_BUNDLE.get()) {
			...
			new ItemStack(AllaboutengieModItems.REGULAR_ENGIE_BUNDLE.get())
