...
public class AngryDeathSharkoRCTameProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (!world.isClientSide()) {
			if (Math.random() > 0.01) {
				...
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = new AngryDeathSharkoTamedEntity(AllaboutengieModEntities.ANGRY_DEATH_SHARKO_TAMED.get(), _level);
