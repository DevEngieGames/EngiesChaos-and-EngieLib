				...
				AllaboutengieMod.queueServerWork(1, () -> {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
							_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("allaboutengie:missile_explosion")), SoundSource.NEUTRAL, (float) 0.25, 1);
						} else {
							_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("allaboutengie:missile_explosion")), SoundSource.NEUTRAL, (float) 0.25, 1, false);
						}
					}
				});
				if (world instanceof ServerLevel _level)
