...
import net.engiegames.reallaboutengie.procedures.AntimatterEngieGamesTradeUITickProcedure;
...
public class AntimatterEngieGamesTradeUIMenu extends AbstractContainerMenu implements AllaboutengieModMenus.MenuAccessor {
	...
	public AntimatterEngieGamesTradeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AllaboutengieModMenus.ANTIMATTER_ENGIE_GAMES_TRADE_UI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 80, 8) {
			...
			public boolean mayPlace(ItemStack stack) {
				return AllaboutengieModItems.ANTIMATTER_ENGIE_GAMES_COIN.get() == stack.getItem();
			}
		}));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof AntimatterEngieGamesTradeUIMenu menu) {
			...
			double y = menu.y;
			double z = menu.z;
			AntimatterEngieGamesTradeUITickProcedure.execute(world, entity);
		}
	}
}