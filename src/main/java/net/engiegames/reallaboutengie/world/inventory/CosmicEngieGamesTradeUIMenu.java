...
import net.engiegames.reallaboutengie.procedures.CosmicEngieGamesTradeUIWhileThisGUIIsOpenTickProcedure;
	...
	public CosmicEngieGamesTradeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 80, 8) {
			...
			public boolean mayPlace(ItemStack stack) {
				return AllaboutengieModBlocks.COSMIC_ENGIE_GAMES_COIN_BLOCK.get().asItem() == stack.getItem();
			}
		}));
