...
import net.engiegames.reallaboutengie.procedures.MindscapeTradeUITickProcedure;
...
public class MindscapeTradeUIMenu extends AbstractContainerMenu implements AllaboutengieModMenus.MenuAccessor {
	...
	public MindscapeTradeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AllaboutengieModMenus.MINDSCAPE_TRADE_UI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 80, 8) {
			...
			public boolean mayPlace(ItemStack stack) {
				return AllaboutengieModBlocks.MINDSCAPE_COIN_BLOCK.get().asItem() == stack.getItem();
			}
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 107, 8) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return AllaboutengieModItems.MINDSCAPE_COIN.get() == stack.getItem();
			}
		}));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof MindscapeTradeUIMenu menu) {
