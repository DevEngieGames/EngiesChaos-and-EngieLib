...
public class BiblicallyAccurateEngieColdSeasonEntity extends PathfinderMob {
	...
	public BiblicallyAccurateEngieColdSeasonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIBLICALLY_ACCURATE_ENGIE_COLD_SEASON.get(), world);
	}
