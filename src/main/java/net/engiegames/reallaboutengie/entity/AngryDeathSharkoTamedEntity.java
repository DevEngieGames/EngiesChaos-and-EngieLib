...
import net.engiegames.reallaboutengie.procedures.AngryDeathSharkoTameRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class AngryDeathSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AngryDeathSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ANGRY_DEATH_SHARKO_TAMED.get(), world);
	}

	public AngryDeathSharkoTamedEntity(EntityType<AngryDeathSharkoTamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AngryDeathSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
