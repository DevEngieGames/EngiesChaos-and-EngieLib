...
public class EnragedEngieHalloweenEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public EnragedEngieHalloweenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_ENGIE_HALLOWEEN.get(), world);
	}

	public EnragedEngieHalloweenEntity(EntityType<EnragedEngieHalloweenEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = EnragedEngieHalloweenEntity.this.getX();
				double y = EnragedEngieHalloweenEntity.this.getY();
				double z = EnragedEngieHalloweenEntity.this.getZ();
				Entity entity = EnragedEngieHalloweenEntity.this;
				Level world = EnragedEngieHalloweenEntity.this.level;
