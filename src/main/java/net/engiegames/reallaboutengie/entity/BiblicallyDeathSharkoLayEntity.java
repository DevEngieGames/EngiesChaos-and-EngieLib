...
import net.engiegames.reallaboutengie.procedures.BiblicallyDeathSharkoLayRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class BiblicallyDeathSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BiblicallyDeathSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIBLICALLY_DEATH_SHARKO_LAY.get(), world);
	}

	public BiblicallyDeathSharkoLayEntity(EntityType<BiblicallyDeathSharkoLayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BiblicallyDeathSharkoLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
