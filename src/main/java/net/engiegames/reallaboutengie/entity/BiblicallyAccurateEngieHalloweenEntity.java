...
public class BiblicallyAccurateEngieHalloweenEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BiblicallyAccurateEngieHalloweenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIBLICALLY_ACCURATE_ENGIE_HALLOWEEN.get(), world);
	}

	public BiblicallyAccurateEngieHalloweenEntity(EntityType<BiblicallyAccurateEngieHalloweenEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 60;
		setNoAi(false);
