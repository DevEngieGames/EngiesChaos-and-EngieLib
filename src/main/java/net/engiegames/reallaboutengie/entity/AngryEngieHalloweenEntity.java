...
public class AngryEngieHalloweenEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public AngryEngieHalloweenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ANGRY_ENGIE_HALLOWEEN.get(), world);
	}

	public AngryEngieHalloweenEntity(EntityType<AngryEngieHalloweenEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 15;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = AngryEngieHalloweenEntity.this.getX();
				double y = AngryEngieHalloweenEntity.this.getY();
				double z = AngryEngieHalloweenEntity.this.getZ();
				Entity entity = AngryEngieHalloweenEntity.this;
				Level world = AngryEngieHalloweenEntity.this.level;
