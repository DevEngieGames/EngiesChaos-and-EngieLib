...
import net.engiegames.reallaboutengie.procedures.WormholeEngieOnInitialEntitySpawnProcedure;
import net.engiegames.reallaboutengie.procedures.WormholeEngieOnEntityTickUpdateProcedure;
...
public class WormholeEngieEntity extends PathfinderMob {
	public WormholeEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.WORMHOLE_ENGIE.get(), world);
	}
