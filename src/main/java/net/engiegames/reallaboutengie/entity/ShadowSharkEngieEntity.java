...
import net.engiegames.reallaboutengie.procedures.ShadowSharkEngieOnInitialEntitySpawnProcedure;
import net.engiegames.reallaboutengie.procedures.ShadowSharkEngieOnEntityTickUpdateProcedure;
...
public class ShadowSharkEngieEntity extends PathfinderMob {
	...
	public ShadowSharkEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHADOW_SHARK_ENGIE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.SHADOW_SHARK_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
