...
import net.engiegames.reallaboutengie.procedures.TheRealEngieGamesOnEntityTickUpdate2Procedure;
...
public class TheRealEngieGamesHalloweenEntity extends PathfinderMob {
	public TheRealEngieGamesHalloweenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.THE_REAL_ENGIE_GAMES_HALLOWEEN.get(), world);
	}
