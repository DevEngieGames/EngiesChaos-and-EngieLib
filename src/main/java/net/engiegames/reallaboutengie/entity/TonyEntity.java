...
import net.engiegames.reallaboutengie.procedures.TonyRCProcedure;
...
public class TonyEntity extends PathfinderMob {
	...
	public TonyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TONY.get(), world);
	}
