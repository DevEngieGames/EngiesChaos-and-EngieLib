...
import net.engiegames.reallaboutengie.procedures.TheRealEngieGamesOnInitialEntitySpawnProcedure;
import net.engiegames.reallaboutengie.procedures.TheRealEngieGamesOnEntityTickUpdateProcedure;
import net.engiegames.reallaboutengie.procedures.NPCNaturalEntitySpawningProcedure;
...
public class TheRealEngieGamesEntity extends PathfinderMob {
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.THE_REAL_ENGIE_GAMES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
