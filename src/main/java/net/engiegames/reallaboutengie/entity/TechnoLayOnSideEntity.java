...
import net.engiegames.reallaboutengie.procedures.TechnoLayOnSideRCProcedure;
import net.engiegames.reallaboutengie.procedures.SharkoKilledByPlayersCountUpProcedure;
import net.engiegames.reallaboutengie.procedures.SharkoChanceForSleepProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class TechnoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TechnoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TECHNO_LAY_ON_SIDE.get(), world);
	}

	public TechnoLayOnSideEntity(EntityType<TechnoLayOnSideEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TechnoLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
