...
public class OutragedEngieHalloweenEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public OutragedEngieHalloweenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.OUTRAGED_ENGIE_HALLOWEEN.get(), world);
	}

	public OutragedEngieHalloweenEntity(EntityType<OutragedEngieHalloweenEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 35;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = OutragedEngieHalloweenEntity.this.getX();
				double y = OutragedEngieHalloweenEntity.this.getY();
				double z = OutragedEngieHalloweenEntity.this.getZ();
				Entity entity = OutragedEngieHalloweenEntity.this;
				Level world = OutragedEngieHalloweenEntity.this.level;
