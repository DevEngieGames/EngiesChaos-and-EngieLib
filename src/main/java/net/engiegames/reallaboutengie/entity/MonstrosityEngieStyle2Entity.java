...
public class MonstrosityEngieStyle2Entity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public MonstrosityEngieStyle2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MONSTROSITY_ENGIE_STYLE_2.get(), world);
	}

	public MonstrosityEngieStyle2Entity(EntityType<MonstrosityEngieStyle2Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 45;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = MonstrosityEngieStyle2Entity.this.getX();
				double y = MonstrosityEngieStyle2Entity.this.getY();
				double z = MonstrosityEngieStyle2Entity.this.getZ();
				Entity entity = MonstrosityEngieStyle2Entity.this;
				Level world = MonstrosityEngieStyle2Entity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.MONSTROSITY_ENGIE_STYLE_2.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
