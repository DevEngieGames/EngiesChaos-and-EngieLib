...
public class MonstrosityEngieColdSeasonEntity extends Monster {
	...
	public MonstrosityEngieColdSeasonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MONSTROSITY_ENGIE_COLD_SEASON.get(), world);
	}
