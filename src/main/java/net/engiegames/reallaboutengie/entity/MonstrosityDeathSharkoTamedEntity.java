...
import net.engiegames.reallaboutengie.procedures.SharkTamedOnEntityTickUpdateProcedure;
import net.engiegames.reallaboutengie.procedures.MonstrosityDeathSharkoTameRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class MonstrosityDeathSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MonstrosityDeathSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MONSTROSITY_DEATH_SHARKO_TAMED.get(), world);
	}

	public MonstrosityDeathSharkoTamedEntity(EntityType<MonstrosityDeathSharkoTamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MonstrosityDeathSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
