...
import net.engiegames.reallaboutengie.procedures.TonyLayRCProcedure;
...
public class TonyLayEntity extends PathfinderMob {
	...
	public TonyLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TONY_LAY.get(), world);
	}
