...
import net.engiegames.reallaboutengie.procedures.MonstrosityDeathSharkoLayRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class MonstrosityDeathSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MonstrosityDeathSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MONSTROSITY_DEATH_SHARKO_LAY.get(), world);
	}

	public MonstrosityDeathSharkoLayEntity(EntityType<MonstrosityDeathSharkoLayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MonstrosityDeathSharkoLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
