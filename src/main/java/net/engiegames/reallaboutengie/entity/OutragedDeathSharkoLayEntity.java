...
import net.engiegames.reallaboutengie.procedures.OutragedDeathSharkoLayRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class OutragedDeathSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public OutragedDeathSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.OUTRAGED_DEATH_SHARKO_LAY.get(), world);
	}

	public OutragedDeathSharkoLayEntity(EntityType<OutragedDeathSharkoLayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		OutragedDeathSharkoLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
