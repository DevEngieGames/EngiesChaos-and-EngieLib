...
import net.engiegames.reallaboutengie.procedures.CosmicDeathSharkoRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class CosmicDeathSharkoEntity extends PathfinderMob {
	public CosmicDeathSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.COSMIC_DEATH_SHARKO.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CosmicDeathSharkoRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.COSMIC_DEATH_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
