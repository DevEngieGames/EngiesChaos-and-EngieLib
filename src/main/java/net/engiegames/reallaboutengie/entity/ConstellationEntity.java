...
import net.engiegames.reallaboutengie.procedures.ConstellationRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class ConstellationEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ConstellationEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CONSTELLATION.get(), world);
	}

	public ConstellationEntity(EntityType<ConstellationEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ConstellationRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
