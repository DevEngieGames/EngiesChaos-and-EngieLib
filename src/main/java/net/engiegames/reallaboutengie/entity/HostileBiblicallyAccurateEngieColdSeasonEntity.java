...
public class HostileBiblicallyAccurateEngieColdSeasonEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public HostileBiblicallyAccurateEngieColdSeasonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.HOSTILE_BIBLICALLY_ACCURATE_ENGIE_COLD_SEASON.get(), world);
	}

	public HostileBiblicallyAccurateEngieColdSeasonEntity(EntityType<HostileBiblicallyAccurateEngieColdSeasonEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 60;
		setNoAi(false);
