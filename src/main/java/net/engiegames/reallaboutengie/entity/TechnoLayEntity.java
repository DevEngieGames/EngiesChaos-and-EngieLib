...
import net.engiegames.reallaboutengie.procedures.TechnoLayRCProcedure;
...
public class TechnoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TechnoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TECHNO_LAY.get(), world);
	}

	public TechnoLayEntity(EntityType<TechnoLayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TechnoLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
