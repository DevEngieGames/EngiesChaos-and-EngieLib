...
public class HostileBiblicallyAccurateEngieEntity extends Monster {
	...
	public HostileBiblicallyAccurateEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.HOSTILE_BIBLICALLY_ACCURATE_ENGIE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.HOSTILE_BIBLICALLY_ACCURATE_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
