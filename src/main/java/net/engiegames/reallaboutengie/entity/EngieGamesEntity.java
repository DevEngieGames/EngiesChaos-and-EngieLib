...
import net.engiegames.reallaboutengie.procedures.EngieGamesRightClickedOnEntityTradeProcedure;
import net.engiegames.reallaboutengie.procedures.EngieGamesOnEntityTickUpdateProcedure;
...
public class EngieGamesEntity extends PathfinderMob {
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ENGIE_GAMES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
