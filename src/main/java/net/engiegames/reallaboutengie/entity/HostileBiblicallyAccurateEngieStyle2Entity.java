...
public class HostileBiblicallyAccurateEngieStyle2Entity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public HostileBiblicallyAccurateEngieStyle2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.HOSTILE_BIBLICALLY_ACCURATE_ENGIE_STYLE_2.get(), world);
	}

	public HostileBiblicallyAccurateEngieStyle2Entity(EntityType<HostileBiblicallyAccurateEngieStyle2Entity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 60;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.HOSTILE_BIBLICALLY_ACCURATE_ENGIE_STYLE_2.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
