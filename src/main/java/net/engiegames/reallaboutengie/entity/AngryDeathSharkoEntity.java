...
import net.engiegames.reallaboutengie.procedures.AngryDeathSharkoRCTameProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class AngryDeathSharkoEntity extends PathfinderMob {
	public AngryDeathSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ANGRY_DEATH_SHARKO.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AngryDeathSharkoRCTameProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ANGRY_DEATH_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
