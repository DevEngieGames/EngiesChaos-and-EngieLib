...
public class MonstrosityEngieHalloweenEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public MonstrosityEngieHalloweenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MONSTROSITY_ENGIE_HALLOWEEN.get(), world);
	}

	public MonstrosityEngieHalloweenEntity(EntityType<MonstrosityEngieHalloweenEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 45;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = MonstrosityEngieHalloweenEntity.this.getX();
				double y = MonstrosityEngieHalloweenEntity.this.getY();
				double z = MonstrosityEngieHalloweenEntity.this.getZ();
				Entity entity = MonstrosityEngieHalloweenEntity.this;
				Level world = MonstrosityEngieHalloweenEntity.this.level;
