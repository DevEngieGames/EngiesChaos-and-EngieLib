...
import net.engiegames.reallaboutengie.procedures.EnragedDeathSharkoTameRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class EnragedDeathSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EnragedDeathSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_DEATH_SHARKO_TAMED.get(), world);
	}

	public EnragedDeathSharkoTamedEntity(EntityType<EnragedDeathSharkoTamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EnragedDeathSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
