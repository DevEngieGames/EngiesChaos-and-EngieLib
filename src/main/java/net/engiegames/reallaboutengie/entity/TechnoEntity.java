...
import net.engiegames.reallaboutengie.procedures.TechnoRCProcedure;
...
public class TechnoEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TechnoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TECHNO.get(), world);
	}

	public TechnoEntity(EntityType<TechnoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TechnoRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
