...
import net.engiegames.reallaboutengie.procedures.EnragedDeathSharkoLayRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class EnragedDeathSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EnragedDeathSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_DEATH_SHARKO_LAY.get(), world);
	}

	public EnragedDeathSharkoLayEntity(EntityType<EnragedDeathSharkoLayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EnragedDeathSharkoLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
