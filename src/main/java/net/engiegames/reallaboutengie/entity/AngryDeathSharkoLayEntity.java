...
import net.engiegames.reallaboutengie.procedures.AngryDeathSharkoLayRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class AngryDeathSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AngryDeathSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ANGRY_DEATH_SHARKO_LAY.get(), world);
	}

	public AngryDeathSharkoLayEntity(EntityType<AngryDeathSharkoLayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AngryDeathSharkoLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
