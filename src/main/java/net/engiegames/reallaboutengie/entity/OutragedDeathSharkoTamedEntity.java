...
import net.engiegames.reallaboutengie.procedures.OutragedDeathSharkoTameRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class OutragedDeathSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public OutragedDeathSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.OUTRAGED_DEATH_SHARKO_TAMED.get(), world);
	}

	public OutragedDeathSharkoTamedEntity(EntityType<OutragedDeathSharkoTamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		OutragedDeathSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
