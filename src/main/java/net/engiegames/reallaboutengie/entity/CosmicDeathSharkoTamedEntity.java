...
import net.engiegames.reallaboutengie.procedures.CosmicDeathSharkoTameRCProcedure;
import net.engiegames.reallaboutengie.init.AllaboutengieModEntities;

public class CosmicDeathSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public CosmicDeathSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.COSMIC_DEATH_SHARKO_TAMED.get(), world);
	}

	public CosmicDeathSharkoTamedEntity(EntityType<CosmicDeathSharkoTamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CosmicDeathSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
