...
public class TechnoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TechnoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TECHNO_SLEEP.get(), world);
	}

	public TechnoSleepEntity(EntityType<TechnoSleepEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
