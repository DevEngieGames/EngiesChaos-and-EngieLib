...
public class OutragedEngieHalloweenedDisplayProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof AngryCreatorEntity _datEntL0 && _datEntL0.getEntityData().get(AngryCreatorEntity.DATA_coldseasoned)) == false
				&& (entity instanceof AngryCreatorEntity _datEntL1 && _datEntL1.getEntityData().get(AngryCreatorEntity.DATA_holloweened)) == true) {
			return true;
		}
		return false;
	}
