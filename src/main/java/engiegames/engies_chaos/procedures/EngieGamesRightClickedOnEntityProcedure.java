...
public class EngieGamesRightClickedOnEntityProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((world instanceof ServerLevel _serverLevelGR0 && _serverLevelGR0.getGameRules().getBoolean(EngiesChaosModGameRules.DETECTIVE_MODE)) == true) {
			if ((entity instanceof ServerPlayer _plr1 && _plr1.level() instanceof ServerLevel && _plr1.getAdvancements().getOrStartProgress(_plr1.server.getAdvancements().get(ResourceLocation.parse("engies_chaos:found_engie"))).isDone()) == false) {
				if (entity instanceof ServerPlayer _player) {
					AdvancementHolder _adv = _player.server.getAdvancements().get(ResourceLocation.parse("engies_chaos:found_engie"));
					if (_adv != null) {
						...
						EngiesChaosMod.queueServerWork(200, () -> {
							...
							EngiesChaosMod.queueServerWork(200, () -> {
								...
								EngiesChaosMod.queueServerWork(160, () -> {
									...
									EngiesChaosMod.queueServerWork(220, () -> {
										{
											Entity _ent = entity;
											if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										...
										if (world instanceof ServerLevel _serverLevel)
											_serverLevel.getGameRules().getRule(EngiesChaosModGameRules.DETECTIVE_MODE).set(false, world.getServer());
										{
											Entity _ent = entity;
											if (!_ent.level().isClientSide() && _ent.getServer() != null) {
