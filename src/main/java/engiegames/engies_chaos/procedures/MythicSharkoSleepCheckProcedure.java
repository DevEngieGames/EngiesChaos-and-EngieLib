...
public class MythicSharkoSleepCheckProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof MythicSharkoEntity _datEntI ? _datEntI.getEntityData().get(MythicSharkoEntity.DATA_SharkoState) : 0) == 4) {
			return false;
		} else if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof MythicSharkoEntity _datEntI ? _datEntI.getEntityData().get(MythicSharkoEntity.DATA_SharkoState) : 0) != 4) {
			return true;
		}
		return false;
	}
