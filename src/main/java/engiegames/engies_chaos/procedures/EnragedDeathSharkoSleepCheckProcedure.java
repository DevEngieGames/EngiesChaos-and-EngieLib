...
public class EnragedDeathSharkoSleepCheckProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof EnragedDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(EnragedDeathSharkoEntity.DATA_SharkoState) : 0) == 4) {
			return false;
		} else if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof EnragedDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(EnragedDeathSharkoEntity.DATA_SharkoState) : 0) != 4) {
			return true;
		}
		return false;
	}
