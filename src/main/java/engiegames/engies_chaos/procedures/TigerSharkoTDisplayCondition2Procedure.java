...
public class TigerSharkoTDisplayCondition2Procedure {
	public static boolean execute(Entity entity) {
		...
		if (!((entity.getDisplayName().getString()).equals("Tiger") || (entity.getDisplayName().getString()).equals("Void") || (entity.getDisplayName().getString()).equals("Smokey") || (entity.getDisplayName().getString()).equals("Tony")
				...
				&& (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof TigerSharkoEntity _datEntI ? _datEntI.getEntityData().get(TigerSharkoEntity.DATA_SharkoState) : 0) == 1) {
			return true;
		}
		return false;
	}
