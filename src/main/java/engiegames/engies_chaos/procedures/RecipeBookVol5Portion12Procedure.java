...
public class RecipeBookVol5Portion12Procedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 51) {
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 52) {
			if (itemstack.getCapability(Capabilities.ItemHandler.ITEM, null) instanceof IItemHandlerModifiable _modHandlerItemSetSlot) {
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 53) {
			if (itemstack.getCapability(Capabilities.ItemHandler.ITEM, null) instanceof IItemHandlerModifiable _modHandlerItemSetSlot) {
				ItemStack _setstack = new ItemStack(Items.STRING).copy();
				_setstack.setCount(1);
				_modHandlerItemSetSlot.setStackInSlot(0, _setstack);
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 54) {
			if (itemstack.getCapability(Capabilities.ItemHandler.ITEM, null) instanceof IItemHandlerModifiable _modHandlerItemSetSlot) {
				ItemStack _setstack = new ItemStack(Items.STRING).copy();
				_setstack.setCount(1);
				_modHandlerItemSetSlot.setStackInSlot(0, _setstack);
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 55) {
			if (itemstack.getCapability(Capabilities.ItemHandler.ITEM, null) instanceof IItemHandlerModifiable _modHandlerItemSetSlot) {
				ItemStack _setstack = new ItemStack(Items.STRING).copy();
				_setstack.setCount(1);
				_modHandlerItemSetSlot.setStackInSlot(0, _setstack);
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 56) {
			if (itemstack.getCapability(Capabilities.ItemHandler.ITEM, null) instanceof IItemHandlerModifiable _modHandlerItemSetSlot) {
				ItemStack _setstack = new ItemStack(Items.STRING).copy();
				_setstack.setCount(1);
				_modHandlerItemSetSlot.setStackInSlot(0, _setstack);
		...
		} else if (entity.getData(EngiesChaosModVariables.PLAYER_VARIABLES).pageNumber == 57) {
			if (itemstack.getCapability(Capabilities.ItemHandler.ITEM, null) instanceof IItemHandlerModifiable _modHandlerItemSetSlot) {
				ItemStack _setstack = new ItemStack(Items.STRING).copy();
				_setstack.setCount(1);
				_modHandlerItemSetSlot.setStackInSlot(0, _setstack);
