...
public class EnragedEngieStyle3DisplayProcedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity instanceof EnragedEngieEntity _datEntI ? _datEntI.getEntityData().get(EnragedEngieEntity.DATA_style) : 0) == 3
