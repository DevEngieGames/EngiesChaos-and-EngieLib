	...
	private static void execute(@Nullable Event event, LevelAccessor world) {
		if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == Level.OVERWORLD && !world.isClientSide()) {
			if (EngiesChaosModVariables.MapVariables.get(world).thestart == true && EngiesChaosModVariables.MapVariables.get(world).TheEndStart == true) {
				...
				EngiesChaosModVariables.MapVariables.get(world).theendtimer = EngiesChaosModVariables.MapVariables.get(world).theendtimer - 0.05;
				...
				if (EngiesChaosModVariables.MapVariables.get(world).darknessretrycooldown <= 0) {
					EngiesChaosModVariables.MapVariables.get(world).darknessretrycooldown = Mth.nextDouble(RandomSource.create(), 0, 5);
					EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					if (Math.random() <= 0.3) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands()
				...
				if (EngiesChaosModVariables.MapVariables.get(world).darknessretrycooldown <= 0) {
					EngiesChaosModVariables.MapVariables.get(world).darknessretrycooldown = Mth.nextDouble(RandomSource.create(), 5, 25);
					EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					if (Math.random() <= 0.5) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands()
				...
				if (EngiesChaosModVariables.MapVariables.get(world).DDayAvalancheAmount >= (world instanceof ServerLevel _serverLevelGR50 ? _serverLevelGR50.getGameRules().getInt(EngiesChaosModGameRules.DOOMSDAY_SUB_DISASTER_LIMIT) : 0)) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(
								new CommandSourceStack(CommandSource.NULL, new Vec3((world.getLevelData().getSpawnPos().getX()), (world.getLevelData().getSpawnPos().getY()), (world.getLevelData().getSpawnPos().getZ())), Vec2.ZERO, _level, 4, "",
										Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
				...
				if (EngiesChaosModVariables.MapVariables.get(world).DDayRiftAmount >= (world instanceof ServerLevel _serverLevelGR55 ? _serverLevelGR55.getGameRules().getInt(EngiesChaosModGameRules.DOOMSDAY_SUB_DISASTER_LIMIT) : 0)) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands()
				...
				if (EngiesChaosModVariables.MapVariables.get(world).DDaySpikeAmount >= (world instanceof ServerLevel _serverLevelGR60 ? _serverLevelGR60.getGameRules().getInt(EngiesChaosModGameRules.DOOMSDAY_SUB_DISASTER_LIMIT) : 0)) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(
								new CommandSourceStack(CommandSource.NULL, new Vec3((world.getLevelData().getSpawnPos().getX()), (world.getLevelData().getSpawnPos().getY()), (world.getLevelData().getSpawnPos().getZ())), Vec2.ZERO, _level, 4, "",
										Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
				...
				if (EngiesChaosModVariables.MapVariables.get(world).DDayMissileAmount >= (world instanceof ServerLevel _serverLevelGR65 ? _serverLevelGR65.getGameRules().getInt(EngiesChaosModGameRules.DOOMSDAY_SUB_DISASTER_LIMIT) : 0)) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(
								new CommandSourceStack(CommandSource.NULL, new Vec3((world.getLevelData().getSpawnPos().getX()), (world.getLevelData().getSpawnPos().getY()), (world.getLevelData().getSpawnPos().getZ())), Vec2.ZERO, _level, 4, "",
										Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
				...
				if (EngiesChaosModVariables.MapVariables.get(world).DDayRiftedEntityCount >= (world instanceof ServerLevel _serverLevelGR70 ? _serverLevelGR70.getGameRules().getInt(EngiesChaosModGameRules.DOOMSDAY_SUB_DISASTER_LIMIT) : 0)) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(
								new CommandSourceStack(CommandSource.NULL, new Vec3((world.getLevelData().getSpawnPos().getX()), (world.getLevelData().getSpawnPos().getY()), (world.getLevelData().getSpawnPos().getZ())), Vec2.ZERO, _level, 4, "",
										Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
				...
				if (EngiesChaosModVariables.MapVariables.get(world).missilecooldown <= 0) {
					EngiesChaosModVariables.MapVariables.get(world).missilecooldown = Mth.nextDouble(RandomSource.create(), 5, 10);
					EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					TheEndMissilesProcedure.execute(world);
				}
				if (EngiesChaosModVariables.MapVariables.get(world).riftcooldown <= 0) {
					EngiesChaosModVariables.MapVariables.get(world).riftcooldown = Mth.nextDouble(RandomSource.create(), 5, 10);
					EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					TheEndRiftsProcedure.execute(world);
				}
				if (EngiesChaosModVariables.MapVariables.get(world).spikecooldown <= 0) {
					EngiesChaosModVariables.MapVariables.get(world).spikecooldown = Mth.nextDouble(RandomSource.create(), 5, 10);
					EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					TheEndSpikesProcedure.execute(world);
				}
				if (EngiesChaosModVariables.MapVariables.get(world).avalanchecooldown <= 0) {
					EngiesChaosModVariables.MapVariables.get(world).avalanchecooldown = Mth.nextDouble(RandomSource.create(), 5, 10);
					EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					TheEndAvalanchesProcedure.execute(world);
				}
			}
		}
	}
