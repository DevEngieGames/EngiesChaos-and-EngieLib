...
public class EngieGamesTradeTickProcedure {
	public static void execute(Entity entity) {
		...
		if (getAmountInGUISlot(entity, 0) >= 64 && getAmountInGUISlot(entity, 1) >= 64) {
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				ItemStack _setstack = new ItemStack(EngiesChaosModItems.ENGIE_GAMES_SCYTHE.get()).copy();
				_setstack.setCount(1);
				_menu.getSlots().get(3).set(_setstack);
				_player.containerMenu.broadcastChanges();
			}
		...
		if (getAmountInGUISlot(entity, 4) >= 64 && getAmountInGUISlot(entity, 5) >= 64) {
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				ItemStack _setstack = new ItemStack(EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_BAN_HAMMER.get()).copy();
				_setstack.setCount(1);
				_menu.getSlots().get(6).set(_setstack);
				_player.containerMenu.broadcastChanges();
			}
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				ItemStack _setstack = new ItemStack(EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_SCYTHE.get()).copy();
				_setstack.setCount(1);
				_menu.getSlots().get(7).set(_setstack);
				_player.containerMenu.broadcastChanges();
			}
		...
		if (getAmountInGUISlot(entity, 8) >= 64 && getAmountInGUISlot(entity, 9) >= 64) {
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				ItemStack _setstack = new ItemStack(EngiesChaosModItems.DARK_MATTER_ENGIE_GAMES_BAN_HAMMER.get()).copy();
				_setstack.setCount(1);
				_menu.getSlots().get(10).set(_setstack);
				_player.containerMenu.broadcastChanges();
			}
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				ItemStack _setstack = new ItemStack(EngiesChaosModItems.DARK_MATTER_ENGIE_GAMES_SCYTHE.get()).copy();
				_setstack.setCount(1);
				_menu.getSlots().get(11).set(_setstack);
				_player.containerMenu.broadcastChanges();
			}
