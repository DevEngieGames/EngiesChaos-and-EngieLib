													...
													EngiesChaosMod.queueServerWork(200, () -> {
														...
														EngiesChaosMod.queueServerWork(1, () -> {
															if (EngiesChaosModVariables.MapVariables.get(world).sddaytimerminutes == 30) {
																EngiesChaosModVariables.MapVariables.get(world).sddaytimerseconds = Math.round(Mth.nextDouble(RandomSource.create(), 0, 30));
																EngiesChaosModVariables.MapVariables.get(world).syncData(world);
															} else if (EngiesChaosModVariables.MapVariables.get(world).sddaytimerminutes == 7) {
																EngiesChaosModVariables.MapVariables.get(world).sddaytimerseconds = Math.round(Mth.nextDouble(RandomSource.create(), 42, 59));
																EngiesChaosModVariables.MapVariables.get(world).syncData(world);
															} else {
																EngiesChaosModVariables.MapVariables.get(world).sddaytimerseconds = Math.round(Mth.nextDouble(RandomSource.create(), 0, 59));
																EngiesChaosModVariables.MapVariables.get(world).syncData(world);
															}
														});
														...
														EngiesChaosMod.queueServerWork(3, () -> {
															EngiesChaosModVariables.MapVariables.get(world).superdoomsdaytimer = EngiesChaosModVariables.MapVariables.get(world).superdoomsdaymaxtime;
															EngiesChaosModVariables.MapVariables.get(world).syncData(world);
														});
														EngiesChaosModVariables.MapVariables.get(world).darknessretrycooldown = Math.round(Mth.nextDouble(RandomSource.create(), 1, 15)) + 3;
														EngiesChaosModVariables.MapVariables.get(world).syncData(world);
														EngiesChaosModVariables.MapVariables.get(world).missilecooldown = Math.round(Mth.nextDouble(RandomSource.create(), 1, 15)) + 3;
														EngiesChaosModVariables.MapVariables.get(world).syncData(world);
														EngiesChaosModVariables.MapVariables.get(world).riftcooldown = Math.round(Mth.nextDouble(RandomSource.create(), 1, 15)) + 3;
														EngiesChaosModVariables.MapVariables.get(world).syncData(world);
														EngiesChaosModVariables.MapVariables.get(world).spikecooldown = Math.round(Mth.nextDouble(RandomSource.create(), 1, 15)) + 3;
														EngiesChaosModVariables.MapVariables.get(world).syncData(world);
														EngiesChaosModVariables.MapVariables.get(world).avalanchecooldown = Math.round(Mth.nextDouble(RandomSource.create(), 1, 15)) + 3;
														EngiesChaosModVariables.MapVariables.get(world).syncData(world);
														EngiesChaosModVariables.MapVariables.get(world).hordecooldown = Math.round(Mth.nextDouble(RandomSource.create(), 4, 15)) + 3;
														EngiesChaosModVariables.MapVariables.get(world).syncData(world);
