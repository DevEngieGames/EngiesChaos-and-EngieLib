...
public class OutragedEngieStyle2DisplayProcedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity instanceof AngryCreatorEntity _datEntI ? _datEntI.getEntityData().get(AngryCreatorEntity.DATA_style) : 0) == 2
