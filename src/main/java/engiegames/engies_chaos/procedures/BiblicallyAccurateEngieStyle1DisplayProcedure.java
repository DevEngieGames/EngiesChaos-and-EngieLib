...
public class BiblicallyAccurateEngieStyle1DisplayProcedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity instanceof BiblicallyAccurateEngieEntity _datEntI ? _datEntI.getEntityData().get(BiblicallyAccurateEngieEntity.DATA_style) : 0) == 1
