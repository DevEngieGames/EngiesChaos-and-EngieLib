...
public class CosmicEngieGamesTradeButtonClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(3).getItem() : ItemStack.EMPTY).getItem() == EngiesChaosModItems.COSMIC_ENGIE_GAMES_CRUCIFIX
				.get()) {
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				EngiesChaosMod.queueServerWork(1, () -> {
					(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu7 ? _menu7.getSlots().get(4).getItem() : ItemStack.EMPTY)
							.enchant(EngiesChaosModEnchantments.ENGIES_BLESSING.get(), 25);
