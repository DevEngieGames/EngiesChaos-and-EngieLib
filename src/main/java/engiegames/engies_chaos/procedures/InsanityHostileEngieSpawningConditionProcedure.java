		...
		if ((world instanceof ServerLevel _serverLevelGR0 && _serverLevelGR0.getGameRules().getBoolean(EngiesChaosModGameRules.ENGIES_CHAOS_TOGGLE)) == true) {
			if ((world instanceof ServerLevel _serverLevelGR1 && _serverLevelGR1.getGameRules().getBoolean(EngiesChaosModGameRules.AMBIENCE_MODE)) == false) {
				if ((world instanceof ServerLevel _serverLevelGR2 && _serverLevelGR2.getGameRules().getBoolean(EngiesChaosModGameRules.INSANITY_DIFFICULTY)) == true
						...
						|| (world instanceof ServerLevel _serverLevelGR4 && _serverLevelGR4.getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC)) == true) {
				...
				} else if (!((world instanceof ServerLevel _serverLevelGR14 && _serverLevelGR14.getGameRules().getBoolean(EngiesChaosModGameRules.INSANITY_DIFFICULTY)) == true
						|| (world instanceof ServerLevel _serverLevelGR15 && _serverLevelGR15.getGameRules().getBoolean(EngiesChaosModGameRules.APOCALYPSE_THREE)) == true
						|| (world instanceof ServerLevel _serverLevelGR16 && _serverLevelGR16.getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC)) == true)) {
					return false;
				}
			} else if ((world instanceof ServerLevel _serverLevelGR17 && _serverLevelGR17.getGameRules().getBoolean(EngiesChaosModGameRules.AMBIENCE_MODE)) == true) {
				return false;
			}
		} else if ((world instanceof ServerLevel _serverLevelGR18 && _serverLevelGR18.getGameRules().getBoolean(EngiesChaosModGameRules.ENGIES_CHAOS_TOGGLE)) == false) {
			return false;
		}
		return false;
	}
