...
public class AngryEngieStyle2DisplayProcedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity instanceof AngryEngieEntity _datEntI ? _datEntI.getEntityData().get(AngryEngieEntity.DATA_style) : 0) == 2
