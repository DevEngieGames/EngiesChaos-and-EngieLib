...
public class DoomsdayDialogueProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (EngiesChaosModVariables.MapVariables.get(world).OHBOY == true && EngiesChaosModVariables.MapVariables.get(world).DoomsDayStart == true) {
					...
					if (EngiesChaosModVariables.MapVariables.get(world).DoomsdayEeriePlayOnce == false) {
						...
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("engies_chaos:doomsday_eerie")), SoundSource.AMBIENT, (float) 0.5, 1);
							} else {
								_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("engies_chaos:doomsday_eerie")), SoundSource.AMBIENT, (float) 0.5, 1, false);
							}
						}
					}
					...
					if (EngiesChaosModVariables.MapVariables.get(world).ddaydialoguetimeblock == false) {
						...
						if (EngiesChaosModVariables.MapVariables.get(world).ddaydialoguetimeblock == false) {
							if (entity.getPersistentData().getDouble("DialogueCooldownStart") >= 36.1) {
								...
								if (world instanceof Level _level) {
									if (!_level.isClientSide()) {
										_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("engies_chaos:churchbells")), SoundSource.AMBIENT, (float) 0.5, 1);
									} else {
										_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("engies_chaos:churchbells")), SoundSource.AMBIENT, (float) 0.5, 1, false);
									}
								}
									...
									EngiesChaosMod.queueServerWork(188, () -> {
										...
										EngiesChaosMod.queueServerWork(200, () -> {
											...
											EngiesChaosMod.queueServerWork(200, () -> {
												...
												if (world instanceof Level _level) {
													if (!_level.isClientSide()) {
														_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("engies_chaos:doomsday_start")), SoundSource.MUSIC, (float) 0.5, 1);
													} else {
														_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("engies_chaos:doomsday_start")), SoundSource.MUSIC, (float) 0.5, 1, false);
													}
												}
			...
			} else if (EngiesChaosModVariables.MapVariables.get(world).OHBOY == false && EngiesChaosModVariables.MapVariables.get(world).DoomsDayStart == true) {
				EngiesChaosMod.LOGGER.warn("Global rule \"DoomsDayStart\" is enabled when it's not supposed to be enabled, this is a bug!");
			} else if (EngiesChaosModVariables.MapVariables.get(world).OHBOY == false && EngiesChaosModVariables.MapVariables.get(world).DoomsDayStart == false) {
				if (EngiesChaosModVariables.MapVariables.get(world).waittildoomsday == true) {
					...
					if (entity.getPersistentData().getDouble("waittoreset") >= 0.5) {
						...
						EngiesChaosModVariables.MapVariables.get(world).syncData(world);
						EngiesChaosModVariables.MapVariables.get(world).ddaywait = false;
						EngiesChaosModVariables.MapVariables.get(world).syncData(world);
					...
					if (entity.getPersistentData().getDouble("waittoreset2") >= 0.5) {
						...
						if (EngiesChaosModVariables.MapVariables.get(world).OHBOY == true && EngiesChaosModVariables.MapVariables.get(world).ddaywait == false) {
							EngiesChaosModVariables.MapVariables.get(world).DoomsDayStart = true;
							EngiesChaosModVariables.MapVariables.get(world).syncData(world);
						} else if (EngiesChaosModVariables.MapVariables.get(world).OHBOY == true && EngiesChaosModVariables.MapVariables.get(world).ddaywait == true) {
