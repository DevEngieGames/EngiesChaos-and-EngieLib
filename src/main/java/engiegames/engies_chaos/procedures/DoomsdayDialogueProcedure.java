				...
				if (EngiesChaosModVariables.MapVariables.get(world).OHBOY == true && EngiesChaosModVariables.MapVariables.get(world).DoomsDayStart == true) {
					...
					if (EngiesChaosModVariables.MapVariables.get(world).ddaydialoguetimeblock == false) {
						...
						if (EngiesChaosModVariables.MapVariables.get(world).DialogueCooldownStart >= 36) {
							...
							EngiesChaosModVariables.MapVariables.get(world).syncData(world);
							EngiesChaosMod.queueServerWork(300, () -> {
								...
								EngiesChaosMod.queueServerWork(200, () -> {
									...
									EngiesChaosMod.queueServerWork(200, () -> {
										...
										EngiesChaosMod.queueServerWork(200, () -> {
											...
											EngiesChaosModVariables.MapVariables.get(world).syncData(world);
											EngiesChaosMod.queueServerWork(1, () -> {
												if (EngiesChaosModVariables.MapVariables.get(world).ddaytimerminutes == 25) {
											...
											EngiesChaosModVariables.MapVariables.get(world).darknessretrycooldown = Mth.nextDouble(RandomSource.create(), 5, 18) + 3;
											EngiesChaosModVariables.MapVariables.get(world).syncData(world);
											EngiesChaosModVariables.MapVariables.get(world).missilecooldown = Mth.nextDouble(RandomSource.create(), 5, 18) + 3;
											EngiesChaosModVariables.MapVariables.get(world).syncData(world);
											EngiesChaosModVariables.MapVariables.get(world).riftcooldown = Mth.nextDouble(RandomSource.create(), 5, 18) + 3;
											EngiesChaosModVariables.MapVariables.get(world).syncData(world);
											EngiesChaosModVariables.MapVariables.get(world).spikecooldown = Mth.nextDouble(RandomSource.create(), 5, 18) + 3;
											EngiesChaosModVariables.MapVariables.get(world).syncData(world);
											EngiesChaosModVariables.MapVariables.get(world).avalanchecooldown = Mth.nextDouble(RandomSource.create(), 5, 18) + 3;
											EngiesChaosModVariables.MapVariables.get(world).syncData(world);
