...
public class AngryEngieHolloweenedDisplayProcedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity instanceof AngryEngieEntity _datEntL0 && _datEntL0.getEntityData().get(AngryEngieEntity.DATA_holloweened)) == true
