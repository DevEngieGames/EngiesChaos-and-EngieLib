...
public class MobDifficultyCheckProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Advancement advancement) {
		...
		if (world instanceof Level _lvl1 && _lvl1.getServer() != null && _lvl1.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:big_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl2 && _lvl2.getServer() != null && _lvl2.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:large_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl3 && _lvl3.getServer() != null && _lvl3.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:huge_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl4 && _lvl4.getServer() != null && _lvl4.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:enormous_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl5 && _lvl5.getServer() != null && _lvl5.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:gigantic_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl6 && _lvl6.getServer() != null && _lvl6.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:massive_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl7 && _lvl7.getServer() != null && _lvl7.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:biblically_accurate_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl8 && _lvl8.getServer() != null && _lvl8.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:monstrosity_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl9 && _lvl9.getServer() != null && _lvl9.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:doomsday_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl10 && _lvl10.getServer() != null && _lvl10.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:super_doomsday_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl11 && _lvl11.getServer() != null && _lvl11.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:the_end_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl12 && _lvl12.getServer() != null && _lvl12.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:engies_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl13 && _lvl13.getServer() != null && _lvl13.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:mindscape_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl14 && _lvl14.getServer() != null && _lvl14.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:engie_games_sword_obtained")).equals(advancement)) {
		...
		if (world instanceof Level _lvl15 && _lvl15.getServer() != null && _lvl15.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_mini_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl17 && _lvl17.getServer() != null && _lvl17.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl18 && _lvl18.getServer() != null && _lvl18.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_large_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl19 && _lvl19.getServer() != null && _lvl19.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_huge_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl20 && _lvl20.getServer() != null && _lvl20.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_enormous_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl21 && _lvl21.getServer() != null && _lvl21.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_gigantic_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl22 && _lvl22.getServer() != null && _lvl22.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_massive_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl23 && _lvl23.getServer() != null && _lvl23.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_biblically_accurate_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl24 && _lvl24.getServer() != null && _lvl24.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_monstrosity_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl25 && _lvl25.getServer() != null && _lvl25.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_doomsday_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl26 && _lvl26.getServer() != null && _lvl26.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_super_doomsday_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl27 && _lvl27.getServer() != null && _lvl27.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_the_end_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl28 && _lvl28.getServer() != null && _lvl28.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_engies_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl29 && _lvl29.getServer() != null && _lvl29.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:antimatter_engie_games_sword_obtained")).equals(advancement)) {
		...
		if (world instanceof Level _lvl30 && _lvl30.getServer() != null && _lvl30.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:cosmic_sword_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl31 && _lvl31.getServer() != null && _lvl31.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:roughian_scythe_obtained")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl32 && _lvl32.getServer() != null && _lvl32.getServer().getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:engie_roughian_scythe_obtained")).equals(advancement)) {
