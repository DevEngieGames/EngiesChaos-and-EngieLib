...
public class ApolloDisplayCondition6Procedure {
	public static boolean execute(Entity entity) {
		if ((entity.getDisplayName().getString()).equals("Apollo") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
