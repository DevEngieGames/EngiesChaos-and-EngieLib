...
public class BiblicallyAccurateEngieColdSeasonedProcedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		...
		if ((EngiesChaosModVariables.MapVariables.get(world).seasonautumn == true || EngiesChaosModVariables.MapVariables.get(world).seasonwinter == true)
				&& (entity instanceof BiblicallyAccurateEngieEntity _datEntL0 && _datEntL0.getEntityData().get(BiblicallyAccurateEngieEntity.DATA_coldseasoned)) == true) {
			return true;
		}
		return false;
	}
