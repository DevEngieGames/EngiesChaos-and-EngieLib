...
public class OutragedDeathSharkoTDisplayCondition7Procedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof OutragedDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(OutragedDeathSharkoEntity.DATA_SharkoState) : 0) == 4
				&& (entity instanceof OutragedDeathSharkoEntity _datEntL2 && _datEntL2.getEntityData().get(OutragedDeathSharkoEntity.DATA_AlternateState)) == true) {
			return true;
		}
		return false;
	}
