...
public class DarkCollectorsHallowsTickProcedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (itemstack.getOrCreateTag().getDouble("engiegameshallowscythestatclockcount") > 0) {
			itemstack.getOrCreateTag().putDouble("darkcollectorshallowskillcount", (itemstack.getOrCreateTag().getDouble("engiegameshallowscythestatclockcount")));
