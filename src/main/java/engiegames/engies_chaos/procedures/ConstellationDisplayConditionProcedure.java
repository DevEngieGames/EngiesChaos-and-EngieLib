...
public class ConstellationDisplayConditionProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity.getDisplayName().getString()).equals("Constellation") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
				&& (entity instanceof CosmicDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(CosmicDeathSharkoEntity.DATA_SharkoState) : 0) == 0) {
			return true;
		}
		return false;
	}
