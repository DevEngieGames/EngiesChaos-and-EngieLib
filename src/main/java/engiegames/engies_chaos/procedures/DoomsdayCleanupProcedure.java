...
public class DoomsdayCleanupProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (EngiesChaosModVariables.MapVariables.get(world).DDAYCleanup == true) {
			...
			EngiesChaosModVariables.MapVariables.get(world).syncData(world);
			EngiesChaosModVariables.MapVariables.get(world).waittiltheend = true;
			EngiesChaosModVariables.MapVariables.get(world).syncData(world);
			...
			EngiesChaosModVariables.MapVariables.get(world).syncData(world);
			EngiesChaosModVariables.MapVariables.get(world).waittilewrath = true;
			EngiesChaosModVariables.MapVariables.get(world).syncData(world);
			...
			EngiesChaosModVariables.MapVariables.get(world).engieswrathstart = false;
			EngiesChaosModVariables.MapVariables.get(world).syncData(world);
			EngiesChaosModVariables.MapVariables.get(world).ewrathwait = true;
			EngiesChaosModVariables.MapVariables.get(world).syncData(world);
