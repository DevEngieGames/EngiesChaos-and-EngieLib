...
public class SmokeyDisplayCondition3Procedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity.getDisplayName().getString()).equals("Smokey") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
