...
public class MonstrosityEngieColdSeasonedProcedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		...
		if ((EngiesChaosModVariables.MapVariables.get(world).seasonautumn == true || EngiesChaosModVariables.MapVariables.get(world).seasonwinter == true)
				&& (entity instanceof MonstrosityEngieEntity _datEntL0 && _datEntL0.getEntityData().get(MonstrosityEngieEntity.DATA_coldseasoned)) == true) {
			return true;
		}
		return false;
	}
