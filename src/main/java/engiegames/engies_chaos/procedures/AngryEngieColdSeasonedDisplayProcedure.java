...
public class AngryEngieColdSeasonedDisplayProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof AngryEngieEntity _datEntL0 && _datEntL0.getEntityData().get(AngryEngieEntity.DATA_holloweened)) == false
				&& (entity instanceof AngryEngieEntity _datEntL1 && _datEntL1.getEntityData().get(AngryEngieEntity.DATA_coldseasoned)) == true) {
			return true;
		}
		return false;
	}
