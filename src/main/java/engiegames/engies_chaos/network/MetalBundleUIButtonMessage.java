...
import engiegames.engies_chaos.procedures.MetalBundleNameChangeProcedure;
import engiegames.engies_chaos.EngiesChaosMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record MetalBundleUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {

	public static final Type<MetalBundleUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EngiesChaosMod.MODID, "engie_bundle_ui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(MetalBundleUIButtonMessage.TYPE, MetalBundleUIButtonMessage.STREAM_CODEC, MetalBundleUIButtonMessage::handleData);
	}
}