...
public class ETCEngieBundleUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(ETCEngieBundleUIButtonMessage.class, ETCEngieBundleUIButtonMessage::buffer, ETCEngieBundleUIButtonMessage::new, ETCEngieBundleUIButtonMessage::handler);
	}
}