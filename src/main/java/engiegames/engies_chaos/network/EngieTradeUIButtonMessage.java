...
public class EngieTradeUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(EngieTradeUIButtonMessage.class, EngieTradeUIButtonMessage::buffer, EngieTradeUIButtonMessage::new, EngieTradeUIButtonMessage::handler);
	}
}