...
import engiegames.engies_chaos.procedures.SDDaySwapToAntimatterProcedure;
...
public record SuperDoomsDayTradeUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<SuperDoomsDayTradeUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EngiesChaosMod.MODID, "super_dooms_day_trade_ui_buttons"));
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SDDaySwapToAntimatterProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(SuperDoomsDayTradeUIButtonMessage.TYPE, SuperDoomsDayTradeUIButtonMessage.STREAM_CODEC, SuperDoomsDayTradeUIButtonMessage::handleData);
	}
}