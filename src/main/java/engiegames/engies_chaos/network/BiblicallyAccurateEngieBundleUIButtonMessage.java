...
import engiegames.engies_chaos.procedures.BiblicallyAccurateEngieBundleNameChangeProcedure;
...
public record BiblicallyAccurateEngieBundleUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<BiblicallyAccurateEngieBundleUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EngiesChaosMod.MODID, "biblically_accurate_engie_bundle_ui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(BiblicallyAccurateEngieBundleUIButtonMessage.TYPE, BiblicallyAccurateEngieBundleUIButtonMessage.STREAM_CODEC, BiblicallyAccurateEngieBundleUIButtonMessage::handleData);
	}
}