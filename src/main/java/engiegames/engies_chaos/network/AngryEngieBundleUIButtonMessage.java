...
public class AngryEngieBundleUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(AngryEngieBundleUIButtonMessage.class, AngryEngieBundleUIButtonMessage::buffer, AngryEngieBundleUIButtonMessage::new, AngryEngieBundleUIButtonMessage::handler);
	}
}