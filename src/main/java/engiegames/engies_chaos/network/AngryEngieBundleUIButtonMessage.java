...
import engiegames.engies_chaos.procedures.AngryEngieBundleNameChangeProcedure;
...
public record AngryEngieBundleUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<AngryEngieBundleUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EngiesChaosMod.MODID, "angry_engie_bundle_ui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(AngryEngieBundleUIButtonMessage.TYPE, AngryEngieBundleUIButtonMessage.STREAM_CODEC, AngryEngieBundleUIButtonMessage::handleData);
	}
}