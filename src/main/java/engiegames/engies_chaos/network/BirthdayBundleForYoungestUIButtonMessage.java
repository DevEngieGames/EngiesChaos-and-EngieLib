...
public class BirthdayBundleForYoungestUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(BirthdayBundleForYoungestUIButtonMessage.class, BirthdayBundleForYoungestUIButtonMessage::buffer, BirthdayBundleForYoungestUIButtonMessage::new, BirthdayBundleForYoungestUIButtonMessage::handler);
	}
}