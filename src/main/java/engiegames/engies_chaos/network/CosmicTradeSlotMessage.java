...
public class CosmicTradeSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public CosmicTradeSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public CosmicTradeSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(CosmicTradeSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CosmicTradeSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(CosmicTradeSlotMessage.class, CosmicTradeSlotMessage::buffer, CosmicTradeSlotMessage::new, CosmicTradeSlotMessage::handler);
	}
}