...
public class RoughianTradeSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public RoughianTradeSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public RoughianTradeSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(RoughianTradeSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(RoughianTradeSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(RoughianTradeSlotMessage.class, RoughianTradeSlotMessage::buffer, RoughianTradeSlotMessage::new, RoughianTradeSlotMessage::handler);
	}
}