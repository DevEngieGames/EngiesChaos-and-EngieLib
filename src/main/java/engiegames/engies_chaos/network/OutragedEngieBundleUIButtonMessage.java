...
public class OutragedEngieBundleUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(OutragedEngieBundleUIButtonMessage.class, OutragedEngieBundleUIButtonMessage::buffer, OutragedEngieBundleUIButtonMessage::new, OutragedEngieBundleUIButtonMessage::handler);
	}
}