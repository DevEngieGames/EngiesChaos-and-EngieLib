...
import engiegames.engies_chaos.procedures.OutragedEngieBundleNameChangeProcedure;
...
public record OutragedEngieBundleUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<OutragedEngieBundleUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EngiesChaosMod.MODID, "outraged_engie_bundle_ui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(OutragedEngieBundleUIButtonMessage.TYPE, OutragedEngieBundleUIButtonMessage.STREAM_CODEC, OutragedEngieBundleUIButtonMessage::handleData);
	}
}