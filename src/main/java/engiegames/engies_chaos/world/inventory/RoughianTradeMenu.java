...
public class RoughianTradeMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public RoughianTradeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.ROUGHIAN_TRADE.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 17, 16) {
			...
			private int x = RoughianTradeMenu.this.x;
			private int y = RoughianTradeMenu.this.y;
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			EngiesChaosMod.PACKET_HANDLER.sendToServer(new RoughianTradeSlotMessage(slotid, x, y, z, ctype, meta));
			RoughianTradeSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof RoughianTradeMenu menu) {
