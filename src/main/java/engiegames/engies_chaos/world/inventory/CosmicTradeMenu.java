...
import engiegames.engies_chaos.network.CosmicTradeSlotMessage;
import engiegames.engies_chaos.init.EngiesChaosModMenus;
import engiegames.engies_chaos.init.EngiesChaosModItems;
import engiegames.engies_chaos.EngiesChaosMod;

@Mod.EventBusSubscriber
public class CosmicTradeMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public CosmicTradeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.COSMIC_TRADE.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 17, 16) {
			...
			private int x = CosmicTradeMenu.this.x;
			private int y = CosmicTradeMenu.this.y;
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 143, 16) {
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 107, 42) {
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 143, 42) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			EngiesChaosMod.PACKET_HANDLER.sendToServer(new CosmicTradeSlotMessage(slotid, x, y, z, ctype, meta));
			CosmicTradeSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CosmicTradeMenu menu) {
