...
import engiegames.engies_chaos.client.gui.TheEndTradeScreen;
import engiegames.engies_chaos.client.gui.SuperDoomsdayTradeScreen;
import engiegames.engies_chaos.client.gui.RoughianTradeScreen;
...
import engiegames.engies_chaos.client.gui.MindscapeTradeScreen;
...
import engiegames.engies_chaos.client.gui.EngieTradeScreen;
import engiegames.engies_chaos.client.gui.EngieGamesTradeScreen;
import engiegames.engies_chaos.client.gui.ETCEngieBundleUIScreen;
import engiegames.engies_chaos.client.gui.DoomsdayTradeScreen;
...
import engiegames.engies_chaos.client.gui.CosmicTradeScreen;
...
public class EngiesChaosModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(EngiesChaosModMenus.DOOMSDAY_TRADE.get(), DoomsdayTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.SUPER_DOOMSDAY_TRADE.get(), SuperDoomsdayTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.THE_END_TRADE.get(), TheEndTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.ENGIE_TRADE.get(), EngieTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.MINDSCAPE_TRADE.get(), MindscapeTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.ENGIE_GAMES_TRADE.get(), EngieGamesTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.COSMIC_TRADE.get(), CosmicTradeScreen::new);
			MenuScreens.register(EngiesChaosModMenus.ROUGHIAN_TRADE.get(), RoughianTradeScreen::new);
		});
	}
