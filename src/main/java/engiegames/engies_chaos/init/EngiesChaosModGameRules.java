...
public class EngiesChaosModGameRules {
	public static final GameRules.Key<GameRules.BooleanValue> LORE_MODE = GameRules.register("detectiveMode", GameRules.Category.MISC, GameRules.BooleanValue.create(false));
