...
public class EngiesChaosModSounds {
	...
	public static final RegistryObject<SoundEvent> CHURCHBELLS2 = REGISTRY.register("churchbells2", () -> new SoundEvent(new ResourceLocation("engies_chaos", "churchbells2")));
	public static final RegistryObject<SoundEvent> PLAYERSTUNMOBS = REGISTRY.register("playerstunmobs", () -> new SoundEvent(new ResourceLocation("engies_chaos", "playerstunmobs")));
	public static final RegistryObject<SoundEvent> PLAYERSTUNABILOFFCOOLDOWN = REGISTRY.register("playerstunabiloffcooldown", () -> new SoundEvent(new ResourceLocation("engies_chaos", "playerstunabiloffcooldown")));
	public static final RegistryObject<SoundEvent> MISSILE_EXPLOSION = REGISTRY.register("missile_explosion", () -> new SoundEvent(new ResourceLocation("engies_chaos", "missile_explosion")));
	public static final RegistryObject<SoundEvent> ENGIESWRATH_EERIE = REGISTRY.register("engieswrath_eerie", () -> new SoundEvent(new ResourceLocation("engies_chaos", "engieswrath_eerie")));
	public static final RegistryObject<SoundEvent> DOOMSDAY_EERIE = REGISTRY.register("doomsday_eerie", () -> new SoundEvent(new ResourceLocation("engies_chaos", "doomsday_eerie")));
	public static final RegistryObject<SoundEvent> NIGHTMARE_FOOTSTEP = REGISTRY.register("nightmare_footstep", () -> new SoundEvent(new ResourceLocation("engies_chaos", "nightmare_footstep")));
	public static final RegistryObject<SoundEvent> MISSILE_SPAWN = REGISTRY.register("missile_spawn", () -> new SoundEvent(new ResourceLocation("engies_chaos", "missile_spawn")));
	public static final RegistryObject<SoundEvent> LIGHTNING_STRIKE = REGISTRY.register("lightning_strike", () -> new SoundEvent(new ResourceLocation("engies_chaos", "lightning_strike")));
	public static final RegistryObject<SoundEvent> EXTREME_LIGHTNING_STRIKE = REGISTRY.register("extreme_lightning_strike", () -> new SoundEvent(new ResourceLocation("engies_chaos", "extreme_lightning_strike")));
	public static final RegistryObject<SoundEvent> DDAYLIGHTNING = REGISTRY.register("ddaylightning", () -> new SoundEvent(new ResourceLocation("engies_chaos", "ddaylightning")));
