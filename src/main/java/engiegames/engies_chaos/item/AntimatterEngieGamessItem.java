...
public abstract class AntimatterEngieGamessItem extends ArmorItem {
	public AntimatterEngieGamessItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "antimatter_engie_gamess";
			}
	...
	public static class Helmet extends AntimatterEngieGamessItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/antimatterengiegamesarmorlayer1.png";
		}
	}
