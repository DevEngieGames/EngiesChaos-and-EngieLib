...
public abstract class AntimatterEngieGamessItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(575, Map.of(ArmorType.BOOTS, 575, ArmorType.LEGGINGS, 575, ArmorType.CHESTPLATE, 575, ArmorType.HELMET, 575, ArmorType.BODY, 575), 22,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 70f, 2f, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:antimatter_engie_gamess_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("engies_chaos:antimatter_engie_gamess")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/antimatterengiegamesarmorlayer1.png");
			}
		}, EngiesChaosModItems.ANTIMATTER_ENGIE_GAMESS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.ANTIMATTER_ENGIE_GAMESS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/antimatterengiegamesarmorlayer2.png");
			}
		}, EngiesChaosModItems.ANTIMATTER_ENGIE_GAMESS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.ANTIMATTER_ENGIE_GAMESS_BOOTS.get());
	}
	...
	public static class Helmet extends AntimatterEngieGamessItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.engies_chaos.antimatter_engie_gamess_helmet.description_0"));
		}
	}
	...
	public static class Chestplate extends AntimatterEngieGamessItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.antimatter_engie_gamess_chestplate.description_0"));
		}
	}
	...
	public static class Leggings extends AntimatterEngieGamessItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.antimatter_engie_gamess_leggings.description_0"));
		}
	}
	...
	public static class Boots extends AntimatterEngieGamessItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.antimatter_engie_gamess_boots.description_0"));
		}
	}
}