...
public abstract class DarkMatterTheEndsItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(900, Map.of(ArmorType.BOOTS, 900, ArmorType.LEGGINGS, 900, ArmorType.CHESTPLATE, 900, ArmorType.HELMET, 900, ArmorType.BODY, 900), 22,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 165f, 5f, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:dark_matter_the_ends_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("engies_chaos:dark_matter_the_ends")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/darkmattertheendarmorlayer1.png");
			}
		}, EngiesChaosModItems.DARK_MATTER_THE_ENDS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.DARK_MATTER_THE_ENDS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/darkmattertheendlayer2.png");
			}
		}, EngiesChaosModItems.DARK_MATTER_THE_ENDS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.DARK_MATTER_THE_ENDS_BOOTS.get());
	}

	private DarkMatterTheEndsItem(ArmorType type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends DarkMatterTheEndsItem {
	...
	public static class Chestplate extends DarkMatterTheEndsItem {
	...
	public static class Leggings extends DarkMatterTheEndsItem {
	...
	public static class Boots extends DarkMatterTheEndsItem {
