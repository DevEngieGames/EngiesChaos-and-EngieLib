...
public class MonstrosityEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 12500, 30f, 0, 10, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:monstrosity_engie_paxel_repair_items")));
