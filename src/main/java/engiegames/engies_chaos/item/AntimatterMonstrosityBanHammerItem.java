...
public class AntimatterMonstrosityBanHammerItem extends Item {
	public AntimatterMonstrosityBanHammerItem(Item.Properties properties) {
		super(properties.durability(49600).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 7249, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
