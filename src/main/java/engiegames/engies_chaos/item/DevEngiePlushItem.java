...
public class DevEngiePlushItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.engies_chaos.dev_engie_plush.description_0"));
		list.add(Component.translatable("item.engies_chaos.dev_engie_plush.description_1"));
	}
}