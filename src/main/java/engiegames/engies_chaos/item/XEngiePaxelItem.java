...
public class XEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 128000, 250f, 0, 22, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:x_engie_aiot_repair_items")));

	public XEngiePaxelItem(Item.Properties properties) {
