...
public class DarkMatterEngieGamesHallowScytheItem extends SwordItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 96000, 152f, 0, 22,
			TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:dark_matter_engie_games_hallow_scythe_repair_items")));

	public DarkMatterEngieGamesHallowScytheItem(Item.Properties properties) {
		super(TOOL_MATERIAL, 13799f, -3f, properties);
	}
