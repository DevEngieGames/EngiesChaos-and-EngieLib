...
public class ChallengeInsanityEngieGamesPlushMultiplayerItem extends Item {
	public ChallengeInsanityEngieGamesPlushMultiplayerItem(Item.Properties properties) {
