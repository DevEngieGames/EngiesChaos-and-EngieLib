...
public class EngiesBanHammerItem extends Item {
	public EngiesBanHammerItem(Item.Properties properties) {
		super(properties.durability(32000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 2999, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
