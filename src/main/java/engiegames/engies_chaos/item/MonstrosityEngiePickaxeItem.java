...
public class MonstrosityEngiePickaxeItem extends PickaxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2500, 30f, 0, 10, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:monstrosity_engie_pickaxe_repair_items")));
