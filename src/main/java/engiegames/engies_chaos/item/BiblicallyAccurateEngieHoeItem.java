...
public class BiblicallyAccurateEngieHoeItem extends HoeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2250, 27f, 0, 9, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:biblically_accurate_engie_hoe_repair_items")));
