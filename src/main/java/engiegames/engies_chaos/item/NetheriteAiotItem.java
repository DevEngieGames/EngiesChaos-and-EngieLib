...
public class NetheriteAiotItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 10160, 9f, 0, 15, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:netherite_aiot_repair_items")));

	public NetheriteAiotItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 9f, -2.4f)
