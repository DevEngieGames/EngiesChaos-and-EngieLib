...
public class DarkMatterEngiesBanHammerItem extends Item {
	public DarkMatterEngiesBanHammerItem(Item.Properties properties) {
		super(properties.durability(89000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 13049, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
