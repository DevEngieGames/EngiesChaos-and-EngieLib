...
public class MindscapeBanHammerItem extends Item {
	public MindscapeBanHammerItem(Item.Properties properties) {
		super(properties.durability(38000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 3249, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
