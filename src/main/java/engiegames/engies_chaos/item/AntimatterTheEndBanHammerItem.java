...
public class AntimatterTheEndBanHammerItem extends Item {
	public AntimatterTheEndBanHammerItem(Item.Properties properties) {
		super(properties.durability(68000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 7999, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
