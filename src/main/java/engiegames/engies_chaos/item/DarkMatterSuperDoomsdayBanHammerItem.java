...
public class DarkMatterSuperDoomsdayBanHammerItem extends Item {
	public DarkMatterSuperDoomsdayBanHammerItem(Item.Properties properties) {
		super(properties.durability(85000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 12549, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
