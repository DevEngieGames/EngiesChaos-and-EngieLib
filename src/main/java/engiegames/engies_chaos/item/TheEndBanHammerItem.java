...
public class TheEndBanHammerItem extends Item {
	public TheEndBanHammerItem(Item.Properties properties) {
		super(properties.durability(28000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 2749, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
