...
public class AngryEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 5000, 16f, 0, 6, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:angry_engie_aiot_repair_items")));
