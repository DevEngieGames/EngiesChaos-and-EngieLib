...
public class EngieGamesScytheItem extends SwordItem {
	public EngieGamesScytheItem() {
		super(new Tier() {
			public int getUses() {
				return 14000;
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(EngiesChaosModItems.ENGIE_GAMES_COIN.get()));
			}
