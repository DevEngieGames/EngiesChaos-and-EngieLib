...
public abstract class AntimatterTheEndsItem extends ArmorItem {
	public AntimatterTheEndsItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 825;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{825, 825, 825, 825}[slot.getIndex()];
			}
	...
	public static class Helmet extends AntimatterTheEndsItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/antimattertheendlayer_1.png";
		}
	}
	...
	public static class Leggings extends AntimatterTheEndsItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/antimattertheendlayer_2.png";
		}
	}
