...
public class EnragedEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 8750, 19f, 0, 7, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:enraged_engie_aiot_repair_items")));
