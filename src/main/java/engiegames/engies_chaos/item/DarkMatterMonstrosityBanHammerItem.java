...
public class DarkMatterMonstrosityBanHammerItem extends Item {
	public DarkMatterMonstrosityBanHammerItem(Item.Properties properties) {
		super(properties.durability(82600).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 12049, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
