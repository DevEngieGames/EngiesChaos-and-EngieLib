...
public class DoomsDayPaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 25000, 33f, 0, 11, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:dooms_day_aiot_repair_items")));
