...
public abstract class AntimatterSuperDoomsdaysItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(525, Map.of(ArmorType.BOOTS, 525, ArmorType.LEGGINGS, 525, ArmorType.CHESTPLATE, 525, ArmorType.HELMET, 525, ArmorType.BODY, 525), 22,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 60f, 1.8f, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:antimatter_super_doomsdays_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("engies_chaos:antimatter_super_doomsdays")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/antimattersuperdoomsdayarmorlayer1.png");
			}
		}, EngiesChaosModItems.ANTIMATTER_SUPER_DOOMSDAYS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.ANTIMATTER_SUPER_DOOMSDAYS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/antimattersuperdoomsdayarmorlayer2.png");
			}
		}, EngiesChaosModItems.ANTIMATTER_SUPER_DOOMSDAYS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/antimatterdoomsdayarmorlayer1.png");
			}
		}, EngiesChaosModItems.ANTIMATTER_SUPER_DOOMSDAYS_BOOTS.get());
	}
	...
	public static class Helmet extends AntimatterSuperDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.engies_chaos.antimatter_super_doomsdays_helmet.description_0"));
		}
	}
	...
	public static class Chestplate extends AntimatterSuperDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.antimatter_super_doomsdays_chestplate.description_0"));
		}
	}
	...
	public static class Leggings extends AntimatterSuperDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.antimatter_super_doomsdays_leggings.description_0"));
		}
	}
	...
	public static class Boots extends AntimatterSuperDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.antimatter_super_doomsdays_boots.description_0"));
		}
	}
}