...
public abstract class DarkMatterOutragedEngiesItem extends ArmorItem {
	public DarkMatterOutragedEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "dark_matter_outraged_engies";
			}
	...
	public static class Helmet extends DarkMatterOutragedEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/darkmatteroutragedengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends DarkMatterOutragedEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/darkmatteroutragedengie_layer_2.png";
		}
	}
