...
public class AntimatterBiblicallyAccurateEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 75000, 72f, 0, 22,
			TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:antimatter_biblically_accurate_engie_aiot_repair_items")));
