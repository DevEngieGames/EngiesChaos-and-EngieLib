...
public class BiblicallyAccurateEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 11250, 27f, 0, 9, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:biblically_accurate_engie_aiot_repair_items")));
