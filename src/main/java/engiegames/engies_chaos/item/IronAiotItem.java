...
public class IronAiotItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 1250, 6f, 0, 14, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:iron_aiot_repair_items")));

	public IronAiotItem(Item.Properties properties) {
