...
public class WoodenAiotItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 295, 2f, 0, 15, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:wooden_aiot_repair_items")));

	public WoodenAiotItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 6f, -2.4f)
