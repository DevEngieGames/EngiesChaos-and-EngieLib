...
public class SuperDoomsDayPaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 30000, 36f, 0, 12, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:super_dooms_day_aiot_repair_items")));
