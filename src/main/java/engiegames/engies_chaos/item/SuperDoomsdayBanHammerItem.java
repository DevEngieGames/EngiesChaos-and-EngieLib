...
public class SuperDoomsdayBanHammerItem extends Item {
	public SuperDoomsdayBanHammerItem(Item.Properties properties) {
		super(properties.durability(24000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 2499, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
