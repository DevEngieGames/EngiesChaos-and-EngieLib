...
public class DarkMatterRoughianEngieGamesPickaxeItem extends PickaxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 52000, 152f, 0, 22,
			TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:dark_matter_roughian_engie_games_pickaxe_repair_items")));

	public DarkMatterRoughianEngieGamesPickaxeItem(Item.Properties properties) {
