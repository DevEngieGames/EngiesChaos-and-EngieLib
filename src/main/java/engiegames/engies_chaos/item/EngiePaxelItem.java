...
public class EngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 3750, 12f, 0, 5, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:engie_aiot_repair_items")));
