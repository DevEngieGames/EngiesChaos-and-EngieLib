...
public class StartersHoeItem extends HoeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 375, 6f, 0, 2, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:starters_hoe_repair_items")));
