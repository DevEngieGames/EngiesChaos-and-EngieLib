...
public abstract class DarkMatterDoomsdaysItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(850, Map.of(ArmorType.BOOTS, 850, ArmorType.LEGGINGS, 850, ArmorType.CHESTPLATE, 850, ArmorType.HELMET, 850, ArmorType.BODY, 850), 22,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 155f, 5f, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:dark_matter_doomsdays_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("engies_chaos:dark_matter_doomsdays")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/darkmatterdoomsdayarmorlayer1.png");
			}
		}, EngiesChaosModItems.DARK_MATTER_DOOMSDAYS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.DARK_MATTER_DOOMSDAYS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/darkmatterdoomsdayarmorlayer2.png");
			}
		}, EngiesChaosModItems.DARK_MATTER_DOOMSDAYS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, EngiesChaosModItems.DARK_MATTER_DOOMSDAYS_BOOTS.get());
	}

	private DarkMatterDoomsdaysItem(ArmorType type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends DarkMatterDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.engies_chaos.dark_matter_doomsdays_helmet.description_0"));
		}
	}

	public static class Chestplate extends DarkMatterDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.dark_matter_doomsdays_chestplate.description_0"));
		}
	}

	public static class Leggings extends DarkMatterDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.dark_matter_doomsdays_leggings.description_0"));
		}
	}

	public static class Boots extends DarkMatterDoomsdaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.engies_chaos.dark_matter_doomsdays_boots.description_0"));
		}
	}
}