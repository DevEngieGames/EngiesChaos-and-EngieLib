...
public class AntimatterEngiesBanHammerItem extends Item {
	public AntimatterEngiesBanHammerItem(Item.Properties properties) {
		super(properties.durability(72000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 8249, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
