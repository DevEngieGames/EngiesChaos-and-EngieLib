...
public class AntimatterDoomsdayBanHammerItem extends Item {
	public AntimatterDoomsdayBanHammerItem(Item.Properties properties) {
		super(properties.durability(60000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 7499, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
