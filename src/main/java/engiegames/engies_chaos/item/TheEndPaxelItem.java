...
public class TheEndPaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 35000, 39f, 0, 13, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:the_end_aiot_repair_items")));
