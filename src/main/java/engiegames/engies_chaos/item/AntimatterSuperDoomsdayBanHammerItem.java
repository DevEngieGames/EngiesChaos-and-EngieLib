...
public class AntimatterSuperDoomsdayBanHammerItem extends Item {
	public AntimatterSuperDoomsdayBanHammerItem(Item.Properties properties) {
		super(properties.durability(64000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 7749, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
