...
public class EngieGamesGoldenAnchorItem extends PickaxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 71000, 125f, 0, 22, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:engie_games_golden_anchor_repair_items")));

	public EngieGamesGoldenAnchorItem(Item.Properties properties) {
