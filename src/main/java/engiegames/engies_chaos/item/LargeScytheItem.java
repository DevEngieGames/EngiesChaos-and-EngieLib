...
public class LargeScytheItem extends SwordItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 2112, 4f, 0, 10, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:large_scythe_repair_items")));
