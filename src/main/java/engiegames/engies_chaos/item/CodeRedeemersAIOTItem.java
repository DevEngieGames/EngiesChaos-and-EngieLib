...
public class CodeRedeemersAIOTItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 5000, 60f, 0, 20, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:code_redeemers_aiot_repair_items")));

	public CodeRedeemersAIOTItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 299f, 2f)
