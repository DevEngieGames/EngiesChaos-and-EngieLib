...
public class DarkMatterBiblicallyAccurateEngiePickaxeItem extends PickaxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 44000, 120f, 0, 22,
			TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:dark_matter_biblically_accurate_engie_pickaxe_repair_items")));

	public DarkMatterBiblicallyAccurateEngiePickaxeItem(Item.Properties properties) {
