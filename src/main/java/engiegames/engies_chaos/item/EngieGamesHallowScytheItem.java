...
public class EngieGamesHallowScytheItem extends SwordItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 72600, 125f, 0, 22, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:engie_games_hallow_scythe_repair_items")));

	public EngieGamesHallowScytheItem(Item.Properties properties) {
