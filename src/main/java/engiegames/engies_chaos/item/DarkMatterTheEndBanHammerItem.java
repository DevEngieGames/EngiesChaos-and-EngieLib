...
public class DarkMatterTheEndBanHammerItem extends Item {
	public DarkMatterTheEndBanHammerItem(Item.Properties properties) {
		super(properties.durability(87000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 12799, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
