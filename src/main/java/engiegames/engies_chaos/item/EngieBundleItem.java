...
public class EngieBundleItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.engies_chaos.engie_bundle.description_0"));
		list.add(Component.translatable("item.engies_chaos.engie_bundle.description_1"));
	}
