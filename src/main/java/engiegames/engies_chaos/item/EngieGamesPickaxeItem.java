...
public class EngieGamesPickaxeItem extends PickaxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 25000, 52f, 0, 16, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:engie_games_pickaxe_repair_items")));
