...
public class RoughianEngieGamesSwordItem extends SwordItem {
	public RoughianEngieGamesSwordItem() {
		super(new Tier() {
			public int getUses() {
				return 100000;
			}
		...
		}, 3, 11f, new Item.Properties().tab(EngiesChaosModTabs.TAB_ENGIES_CHAOS_ITEMS));
	}
