...
public abstract class CosmicEngieGamessItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(625, Map.of(ArmorType.BOOTS, 625, ArmorType.LEGGINGS, 625, ArmorType.CHESTPLATE, 625, ArmorType.HELMET, 625, ArmorType.BODY, 625), 22,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 80f, 2.2f, TagKey.create(Registries.ITEM, ResourceLocation.parse("engies_chaos:cosmic_engie_gamess_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("engies_chaos:cosmic_engie_gamess")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head",
						new ModelPart(Collections.emptyList(),
								Map.of("head", new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))),
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/cosmicarmorlayer1.png");
			}
		}, EngiesChaosModItems.COSMIC_ENGIE_GAMESS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("body", new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).Body, "left_arm",
								new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).LeftArm, "right_arm",
								new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).RightArm, "head",
		...
		}, EngiesChaosModItems.COSMIC_ENGIE_GAMESS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("left_leg", new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).LeftLeg2, "right_leg",
								new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).RightLeg2, "head",
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("engies_chaos:textures/entities/cosmicarmorlayer2.png");
			}
		}, EngiesChaosModItems.COSMIC_ENGIE_GAMESS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("left_leg", new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).LeftLeg, "right_leg",
								new Modelcosmicengiearmor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcosmicengiearmor.LAYER_LOCATION)).RightLeg, "head",
								new ModelPart(Collections.emptyList(), Map.of("hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))), "body", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_arm",
								new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()))));
			}
		...
		}, EngiesChaosModItems.COSMIC_ENGIE_GAMESS_BOOTS.get());
	}

	private CosmicEngieGamessItem(ArmorType type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends CosmicEngieGamessItem {
	...
	public static class Chestplate extends CosmicEngieGamessItem {
	...
	public static class Leggings extends CosmicEngieGamessItem {
	...
	public static class Boots extends CosmicEngieGamessItem {
