...
public class DarkMatterDoomsdayBanHammerItem extends Item {
	public DarkMatterDoomsdayBanHammerItem(Item.Properties properties) {
		super(properties.durability(83000).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 12299, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
