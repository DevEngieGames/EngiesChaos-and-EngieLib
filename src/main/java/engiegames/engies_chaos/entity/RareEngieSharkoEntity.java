...
import engiegames.engies_chaos.procedures.RareEngieSharkoSleepCheckProcedure;
import engiegames.engies_chaos.procedures.RareEngieSharkoRightClickedOnEntityProcedure;
import engiegames.engies_chaos.procedures.RareEngieSharkoOnEntityTickUpdateProcedure;
import engiegames.engies_chaos.procedures.RareEngieSharkoMoveAroundCheckProcedure;
...
public class RareEngieSharkoEntity extends TamableAnimal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		RareEngieSharkoEntity retval = EngiesChaosModEntities.RARE_ENGIE_SHARKO.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.RARE_ENGIE_SHARKO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
