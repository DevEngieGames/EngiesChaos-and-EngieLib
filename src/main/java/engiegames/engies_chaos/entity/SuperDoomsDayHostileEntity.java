...
import engiegames.engies_chaos.procedures.HostileSuperDoomsDayNaturalEntitySpawningConditionProcedure;
...
public class SuperDoomsDayHostileEntity extends Monster {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.SUPER_DOOMS_DAY_HOSTILE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return HostileSuperDoomsDayNaturalEntitySpawningConditionProcedure.execute(world);
