...
public class EngieGamesEntity extends PathfinderMob {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canUse() {
				double x = EngieGamesEntity.this.getX();
				double y = EngieGamesEntity.this.getY();
				double z = EngieGamesEntity.this.getZ();
				Entity entity = EngieGamesEntity.this;
				Level world = EngieGamesEntity.this.level();
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.ENGIE_GAMES.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
