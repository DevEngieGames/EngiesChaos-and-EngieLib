...
import engiegames.engies_chaos.procedures.AngryEngieTickProcedure;
import engiegames.engies_chaos.procedures.AngryEngieOnInitialEntitySpawnProcedure;
import engiegames.engies_chaos.init.EngiesChaosModEntities;

public class AngryEngieEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_style = SynchedEntityData.defineId(AngryEngieEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_coldseasoned = SynchedEntityData.defineId(AngryEngieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_holloweened = SynchedEntityData.defineId(AngryEngieEntity.class, EntityDataSerializers.BOOLEAN);

	public AngryEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ANGRY_ENGIE.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		AngryEngieOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		AngryEngieTickProcedure.execute(this.level, this);
	}

	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ANGRY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
