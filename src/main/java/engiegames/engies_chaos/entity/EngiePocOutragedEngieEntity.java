...
public class EngiePocOutragedEngieEntity extends Monster {
	public EngiePocOutragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_POC_OUTRAGED_ENGIE.get(), world);
	}

	public EngiePocOutragedEngieEntity(EntityType<EngiePocOutragedEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 35;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngiePocOutragedEngieEntity.this.getX();
				double y = EngiePocOutragedEngieEntity.this.getY();
				double z = EngiePocOutragedEngieEntity.this.getZ();
				Entity entity = EngiePocOutragedEngieEntity.this;
				Level world = EngiePocOutragedEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_POC_OUTRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
