...
import engiegames.engies_chaos.procedures.LegendarySharkoSleepCheckProcedure;
import engiegames.engies_chaos.procedures.LegendarySharkoRightClickedOnEntityProcedure;
import engiegames.engies_chaos.procedures.LegendarySharkoOnEntityTickUpdateProcedure;
import engiegames.engies_chaos.procedures.LegendarySharkoMoveAroundCheckProcedure;
...
public class LegendarySharkoEntity extends TamableAnimal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new OwnerHurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = LegendarySharkoEntity.this.getX();
				double y = LegendarySharkoEntity.this.getY();
				double z = LegendarySharkoEntity.this.getZ();
				Entity entity = LegendarySharkoEntity.this;
				Level world = LegendarySharkoEntity.this.level();
				return super.canUse() && LegendarySharkoMoveAroundCheckProcedure.execute(entity);
			}
			...
			public boolean canContinueToUse() {
				...
				Entity entity = LegendarySharkoEntity.this;
				Level world = LegendarySharkoEntity.this.level();
				return super.canContinueToUse() && LegendarySharkoMoveAroundCheckProcedure.execute(entity);
			}
		});
		...
		this.goalSelector.addGoal(8, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canUse() {
				...
				Entity entity = LegendarySharkoEntity.this;
				Level world = LegendarySharkoEntity.this.level();
				return super.canUse() && LegendarySharkoSleepCheckProcedure.execute(entity);
			}
			...
			public boolean canContinueToUse() {
				...
				Entity entity = LegendarySharkoEntity.this;
				Level world = LegendarySharkoEntity.this.level();
				return super.canContinueToUse() && LegendarySharkoSleepCheckProcedure.execute(entity);
			}
		});
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LegendarySharkoRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		LegendarySharkoOnEntityTickUpdateProcedure.execute(this.level(), this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LegendarySharkoEntity retval = EngiesChaosModEntities.LEGENDARY_SHARKO.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.LEGENDARY_SHARKO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
