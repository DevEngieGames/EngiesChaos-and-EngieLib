...
public class LegendarySharkoEntity extends TamableAnimal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LegendarySharkoEntity retval = EngiesChaosModEntities.LEGENDARY_SHARKO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.LEGENDARY_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
