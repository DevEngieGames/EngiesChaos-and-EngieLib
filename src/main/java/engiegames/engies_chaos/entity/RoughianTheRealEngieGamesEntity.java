...
public class RoughianTheRealEngieGamesEntity extends PathfinderMob {
	public RoughianTheRealEngieGamesEntity(EntityType<RoughianTheRealEngieGamesEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Level 514 | clippedbyengie"));
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(EngiesChaosModItems.ROUGHIAN_ENGIE_GAMESS_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(EngiesChaosModItems.ROUGHIAN_ENGIE_GAMESS_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(EngiesChaosModItems.ROUGHIAN_ENGIE_GAMESS_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(EngiesChaosModItems.ROUGHIAN_ENGIE_GAMESS_BOOTS.get()));
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canUse() {
				double x = RoughianTheRealEngieGamesEntity.this.getX();
				double y = RoughianTheRealEngieGamesEntity.this.getY();
				double z = RoughianTheRealEngieGamesEntity.this.getZ();
				Entity entity = RoughianTheRealEngieGamesEntity.this;
				Level world = RoughianTheRealEngieGamesEntity.this.level();
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.ROUGHIAN_THE_REAL_ENGIE_GAMES.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
