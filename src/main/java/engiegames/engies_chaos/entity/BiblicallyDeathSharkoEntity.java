...
public class BiblicallyDeathSharkoEntity extends TamableAnimal {
	public static final EntityDataAccessor<Integer> DATA_SharkoState = SynchedEntityData.defineId(BiblicallyDeathSharkoEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_AlternateState = SynchedEntityData.defineId(BiblicallyDeathSharkoEntity.class, EntityDataSerializers.BOOLEAN);

	public BiblicallyDeathSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.BIBLICALLY_DEATH_SHARKO.get(), world);
	}

	public BiblicallyDeathSharkoEntity(EntityType<BiblicallyDeathSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new OwnerHurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = BiblicallyDeathSharkoEntity.this.getX();
				double y = BiblicallyDeathSharkoEntity.this.getY();
				double z = BiblicallyDeathSharkoEntity.this.getZ();
				Entity entity = BiblicallyDeathSharkoEntity.this;
				Level world = BiblicallyDeathSharkoEntity.this.level;
				return super.canUse() && BiblicallyDeathSharkoMoveAroundCheckProcedure.execute(entity);
			}
			...
			public boolean canContinueToUse() {
				...
				Entity entity = BiblicallyDeathSharkoEntity.this;
				Level world = BiblicallyDeathSharkoEntity.this.level;
				return super.canContinueToUse() && BiblicallyDeathSharkoMoveAroundCheckProcedure.execute(entity);
			}
		});
		...
		this.goalSelector.addGoal(8, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canUse() {
				...
				Entity entity = BiblicallyDeathSharkoEntity.this;
				Level world = BiblicallyDeathSharkoEntity.this.level;
				return super.canUse() && BiblicallyDeathSharkoSleepCheckProcedure.execute(entity);
			}
			...
			public boolean canContinueToUse() {
				...
				Entity entity = BiblicallyDeathSharkoEntity.this;
				Level world = BiblicallyDeathSharkoEntity.this.level;
				return super.canContinueToUse() && BiblicallyDeathSharkoSleepCheckProcedure.execute(entity);
			}
		});
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BiblicallyDeathSharkoEntity retval = EngiesChaosModEntities.BIBLICALLY_DEATH_SHARKO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.BIBLICALLY_DEATH_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
