...
public class HostileBiblicallyAccurateEngieEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = HostileBiblicallyAccurateEngieEntity.this.getX();
				double y = HostileBiblicallyAccurateEngieEntity.this.getY();
				double z = HostileBiblicallyAccurateEngieEntity.this.getZ();
				Entity entity = HostileBiblicallyAccurateEngieEntity.this;
				Level world = HostileBiblicallyAccurateEngieEntity.this.level();
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.HOSTILE_BIBLICALLY_ACCURATE_ENGIE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
