...
public class EngiePocEnragedEngieEntity extends Monster {
	public EngiePocEnragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_POC_ENRAGED_ENGIE.get(), world);
	}

	public EngiePocEnragedEngieEntity(EntityType<EngiePocEnragedEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngiePocEnragedEngieEntity.this.getX();
				double y = EngiePocEnragedEngieEntity.this.getY();
				double z = EngiePocEnragedEngieEntity.this.getZ();
				Entity entity = EngiePocEnragedEngieEntity.this;
				Level world = EngiePocEnragedEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_POC_ENRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
