...
public class EngiePocAngryEngieEntity extends Monster {
	public EngiePocAngryEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_POC_ANGRY_ENGIE.get(), world);
	}

	public EngiePocAngryEngieEntity(EntityType<EngiePocAngryEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 15;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngiePocAngryEngieEntity.this.getX();
				double y = EngiePocAngryEngieEntity.this.getY();
				double z = EngiePocAngryEngieEntity.this.getZ();
				Entity entity = EngiePocAngryEngieEntity.this;
				Level world = EngiePocAngryEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_POC_ANGRY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
