...
import engiegames.engies_chaos.procedures.GlitchSharkoSpawningProcedure;
import engiegames.engies_chaos.procedures.GlitchSharkoSleepCheckProcedure;
import engiegames.engies_chaos.procedures.GlitchSharkoRightClickedOnEntityProcedure;
import engiegames.engies_chaos.procedures.GlitchSharkoOnEntityTickUpdateProcedure;
import engiegames.engies_chaos.procedures.GlitchSharkoMoveAroundCheckProcedure;
import engiegames.engies_chaos.init.EngiesChaosModItems;
import engiegames.engies_chaos.init.EngiesChaosModEntities;

public class GlitchSharkoEntity extends TamableAnimal {
	public static final EntityDataAccessor<Integer> DATA_SharkoState = SynchedEntityData.defineId(GlitchSharkoEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_AlternateState = SynchedEntityData.defineId(GlitchSharkoEntity.class, EntityDataSerializers.BOOLEAN);

	public GlitchSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.GLITCH_SHARKO.get(), world);
	}

	public GlitchSharkoEntity(EntityType<GlitchSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new OwnerHurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = GlitchSharkoEntity.this.getX();
				double y = GlitchSharkoEntity.this.getY();
				double z = GlitchSharkoEntity.this.getZ();
				Entity entity = GlitchSharkoEntity.this;
				Level world = GlitchSharkoEntity.this.level;
				return super.canUse() && GlitchSharkoMoveAroundCheckProcedure.execute(entity);
			}
			...
			public boolean canContinueToUse() {
				...
				Entity entity = GlitchSharkoEntity.this;
				Level world = GlitchSharkoEntity.this.level;
				return super.canContinueToUse() && GlitchSharkoMoveAroundCheckProcedure.execute(entity);
			}
		});
		...
		this.goalSelector.addGoal(8, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canUse() {
				...
				Entity entity = GlitchSharkoEntity.this;
				Level world = GlitchSharkoEntity.this.level;
				return super.canUse() && GlitchSharkoSleepCheckProcedure.execute(entity);
			}
			...
			public boolean canContinueToUse() {
				...
				Entity entity = GlitchSharkoEntity.this;
				Level world = GlitchSharkoEntity.this.level;
				return super.canContinueToUse() && GlitchSharkoSleepCheckProcedure.execute(entity);
			}
		});
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		GlitchSharkoRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		GlitchSharkoOnEntityTickUpdateProcedure.execute(this.level, this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GlitchSharkoEntity retval = EngiesChaosModEntities.GLITCH_SHARKO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.GLITCH_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return GlitchSharkoSpawningProcedure.execute(world, x, y, z);
		});
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ARMOR, 95);
