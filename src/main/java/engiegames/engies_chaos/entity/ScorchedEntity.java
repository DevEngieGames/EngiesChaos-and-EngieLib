	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canUse() {
				double x = ScorchedEntity.this.getX();
				double y = ScorchedEntity.this.getY();
				double z = ScorchedEntity.this.getZ();
				Entity entity = ScorchedEntity.this;
				Level world = ScorchedEntity.this.level();
