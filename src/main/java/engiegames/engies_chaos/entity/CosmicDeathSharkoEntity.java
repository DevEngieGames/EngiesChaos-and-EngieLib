...
public class CosmicDeathSharkoEntity extends TamableAnimal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(8, new LookAtPlayerGoal(this, Player.class, (float) 12) {
			...
			public boolean canContinueToUse() {
				...
				Entity entity = CosmicDeathSharkoEntity.this;
				Level world = CosmicDeathSharkoEntity.this.level();
				return super.canContinueToUse() && CosmicDeathSharkoSleepCheckProcedure.execute(entity);
			}
		});
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CosmicDeathSharkoEntity retval = EngiesChaosModEntities.COSMIC_DEATH_SHARKO.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EngiesChaosModEntities.COSMIC_DEATH_SHARKO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
