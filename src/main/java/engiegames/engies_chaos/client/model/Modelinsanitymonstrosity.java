...
public class Modelinsanitymonstrosity extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelinsanitymonstrosity"), "main");
	...
	public Modelinsanitymonstrosity(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				...
				PartPose.offsetAndRotation(5.0F, 2.0F, 0.0F, -0.2182F, 0.1309F, -0.2182F));
		PartDefinition LeftArm2 = partdefinition.addOrReplaceChild("LeftArm2",
				CubeListBuilder.create().texOffs(96, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(112, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(5.0F, 2.0F, 0.0F, -0.4421F, 0.1621F, 0.1622F));
		PartDefinition LeftArm3 = partdefinition.addOrReplaceChild("LeftArm3",
				CubeListBuilder.create().texOffs(96, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(112, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(5.0F, 2.0F, 0.0F, 0.2182F, -0.1309F, -0.2182F));
		PartDefinition LeftArm4 = partdefinition.addOrReplaceChild("LeftArm4",
				CubeListBuilder.create().texOffs(96, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(112, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(5.0F, 2.0F, 0.0F, 0.4396F, -0.1186F, 0.1626F));
		...
		PartDefinition RightArm2 = partdefinition.addOrReplaceChild("RightArm2",
				CubeListBuilder.create().texOffs(104, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, -0.4456F, -0.1974F, -0.1247F));
		PartDefinition RightArm3 = partdefinition.addOrReplaceChild("RightArm3",
				CubeListBuilder.create().texOffs(104, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, 0.2182F, 0.1309F, 0.2182F));
		PartDefinition RightArm4 = partdefinition.addOrReplaceChild("RightArm4",
				CubeListBuilder.create().texOffs(104, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, 0.4396F, 0.1186F, -0.1626F));
	...
	public void setupAnim(LivingEntityRenderState state) {
		...
		this.RightArm4.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * limbSwingAmount;
		this.LeftArm3.xRot = Mth.cos(limbSwing * 0.6662F) * limbSwingAmount;
		this.LeftArm4.xRot = Mth.cos(limbSwing * 0.6662F) * limbSwingAmount;
