...
public class Modelbigboyosit extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelbigboyosit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = Head.addOrReplaceChild("Hat",
				CubeListBuilder.create().texOffs(0, 58).addBox(-6.5F, 2.6176F, -6.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 58).addBox(-6.0F, 1.8926F, -6.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = Hat.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 48).addBox(-6.0F, -0.5F, -6.0F, 11.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 1.6676F, -0.5F, 0.0F, 3.1416F, 0.0F));
		PartDefinition cube_r2 = Hat.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 47).addBox(-4.0F, -2.5F, -4.0F, 10.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 1.1426F, 1.0F, 0.0F, 3.1416F, 0.0F));
		PartDefinition cube_r3 = Hat.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 58).addBox(-5.0F, -0.5F, -6.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.3926F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r4 = Hat.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 58).addBox(-6.0F, -0.5F, -6.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.3926F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r13 = Collar.addOrReplaceChild("cube_r13",
		...
		PartDefinition cube_r14 = Collar.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(0, 40).addBox(-5.0F, 0.5F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0F, 1.0252F, -0.1829F, -0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r15 = Collar.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(0, 40).addBox(-5.0F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.05F)),
		...
		PartDefinition cube_r16 = Bell.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(22, 40).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, 0.0F, 3.1416F));
		PartDefinition cube_r17 = Bell.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(22, 40).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)),
				PartPose.offsetAndRotation(-1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));
		PartDefinition cube_r18 = Bell.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(22, 40).mirror().addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false),
				PartPose.offsetAndRotation(1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition cube_r19 = Fin.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(44, 31).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.4875F, 0.0F, 0.0F, 0.0F, -0.4363F, 0.0F));
		PartDefinition cube_r20 = Fin.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(44, 31).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(-0.4875F, 0.0F, 0.0F, 0.0F, 0.4363F, 0.0F));
