...
public class Modelxengiegamesarmor extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelxengiegamesarmor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Crown = Head.addOrReplaceChild("Crown",
				CubeListBuilder.create().texOffs(71, 101).addBox(-4.9977F, 0.75F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(71, 101).addBox(-4.9977F, 0.75F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(71, 92)
						.addBox(4.0023F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(71, 92).addBox(-4.9977F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(93, 92)
						.addBox(4.0023F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(93, 101).addBox(-4.9977F, -0.25F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(93, 92)
						.addBox(-4.9977F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(93, 101).addBox(-4.9977F, -0.25F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(116, 101)
						.addBox(-0.9977F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(122, 101).addBox(-0.9977F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(122, 97)
						.addBox(-4.9977F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(122, 99).addBox(3.0023F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(122, 93)
						.addBox(-0.9977F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(122, 91).addBox(-4.9977F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(122, 95)
						.addBox(3.0023F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(116, 101).addBox(-4.9977F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(115, 100)
						.addBox(-4.9977F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(115, 100).addBox(4.0023F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(115, 100)
						.addBox(-4.9977F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(115, 100).addBox(4.0023F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(115, 100)
						.addBox(4.0023F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(122, 112).addBox(-5.2477F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(122, 118)
						.addBox(-5.2477F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(122, 115).addBox(-5.2477F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(122, 103)
						.addBox(4.2273F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(122, 106).addBox(4.2273F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(122, 109)
						.addBox(4.2273F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(115, 100).addBox(-4.9977F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(116, 101)
						.addBox(3.0023F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(116, 101).addBox(3.0023F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(116, 101)
						.addBox(-4.9977F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(116, 101).addBox(-0.9977F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)),
