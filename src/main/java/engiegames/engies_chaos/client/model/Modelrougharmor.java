...
public class Modelrougharmor extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelrougharmor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Muffs = Head.addOrReplaceChild("Muffs",
				CubeListBuilder.create().texOffs(0, 95).addBox(4.0053F, 0.2316F, -2.0F, 1.3F, 4.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(14, 98).addBox(4.0553F, 1.0316F, -1.2F, 1.4F, 2.4F, 2.4F, new CubeDeformation(0.025F)).texOffs(22, 94)
						...
						.addBox(-4.2447F, -2.1684F, -1.0F, 8.5F, 0.4F, 2.0F, new CubeDeformation(0.0F)).texOffs(21, 50).addBox(-4.6447F, -2.5684F, -1.0F, 9.3F, 0.3F, 0.5F, new CubeDeformation(0.0F)).texOffs(21, 50)
		...
		PartDefinition Goggles = Head.addOrReplaceChild("Goggles",
				CubeListBuilder.create().texOffs(73, 68).addBox(-4.0F, 0.6419F, -3.0662F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 118).addBox(-4.025F, 0.6419F, -2.0912F, 0.025F, 2.0F, 8.05F, new CubeDeformation(0.0F)).texOffs(0, 118)
						...
						.addBox(-2.225F, 0.45F, -2.7F, 0.2F, 0.2F, 0.2F, new CubeDeformation(0.0F)).texOffs(0, 124).addBox(-2.025F, -2.4081F, 5.9088F, 4.05F, 3.05F, 0.05F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.6419F, -1.9338F));
		PartDefinition cube_r1 = Goggles.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 124).addBox(-2.025F, -0.025F, -0.025F, 4.05F, 3.15F, 0.05F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = AngelHat.addOrReplaceChild("cube_r9",
		...
		PartDefinition cube_r10 = AngelHat.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, -0.5F, -4.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-4.0F, 0.5F, -6.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
						.addBox(-5.0F, 1.0F, -7.0F, 10.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11).addBox(-6.0F, 1.5F, -8.0F, 12.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
						.addBox(-7.0F, 2.0F, -9.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.025F, 0.0F, -1.5708F, 0.0F));
		PartDefinition Chains = AngelHat.addOrReplaceChild("Chains", CubeListBuilder.create(), PartPose.offset(0.25F, 9.0F, 0.025F));
		PartDefinition L1 = Chains.addOrReplaceChild("L1", CubeListBuilder.create().texOffs(127, 124).addBox(-0.075F, -0.075F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offset(8.625F, -6.125F, -0.025F));
		PartDefinition L2 = L1.addOrReplaceChild("L2", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.125F, 0.275F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition L3 = L2.addOrReplaceChild("L3", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition L4 = L3.addOrReplaceChild("L4", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition L5 = L4.addOrReplaceChild("L5", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition L6 = L5.addOrReplaceChild("L6", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition L7 = L6.addOrReplaceChild("L7", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition L8 = L7.addOrReplaceChild("L8", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r11 = L8.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(41, 0).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, 0.15F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition R1 = Chains.addOrReplaceChild("R1", CubeListBuilder.create().texOffs(127, 124).addBox(-0.325F, -0.075F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offset(-9.125F, -6.125F, -0.025F));
		PartDefinition R2 = R1.addOrReplaceChild("R2", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(-0.125F, 0.275F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition R3 = R2.addOrReplaceChild("R3", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition R4 = R3.addOrReplaceChild("R4", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition R5 = R4.addOrReplaceChild("R5", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition R6 = R5.addOrReplaceChild("R6", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition R7 = R6.addOrReplaceChild("R7", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition R8 = R7.addOrReplaceChild("R8", CubeListBuilder.create().texOffs(127, 124).addBox(-0.2F, -0.025F, -0.025F, 0.4F, 0.4F, 0.05F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.325F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r12 = R8.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(41, 0).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, 0.15F, 0.0F, 0.0F, -1.5708F, 0.0F));
