...
public class Modelrougharmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("engies_chaos", "modelrougharmor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 71).addBox(-4.025F, -2.0F, -4.025F, 8.05F, 1.525F, 8.05F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r1 = AngelHat.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.1F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 22).addBox(-2.0F, -1.6F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 15)
						.addBox(-3.0F, -1.1F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(30, 28).addBox(-4.0F, -0.6F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 28)
						.addBox(-5.0F, -0.1F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 15).addBox(-6.0F, 0.4F, -6.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r2 = AngelHat.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(17, 126).addBox(-6.0F, -3.9648F, -5.5205F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126).addBox(-5.0F, -3.6113F, -4.4598F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(45, 126).addBox(-4.0F, -3.2577F, -3.3991F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126).addBox(-3.0F, -2.9042F, -2.3385F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126)
						.addBox(-2.0F, -2.5506F, -1.2778F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 126).addBox(-1.0F, -2.1971F, -0.2172F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 126)
						.addBox(-1.0F, -0.7828F, 1.1971F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126).addBox(-2.0F, 0.2778F, 1.5506F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126)
						.addBox(-3.0F, 1.3385F, 1.9042F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 126).addBox(-4.0F, 2.3991F, 2.2577F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126)
						.addBox(-5.0F, 3.4598F, 2.6113F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 126).addBox(-6.0F, 4.5205F, 2.9648F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = AngelHat.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(19, 126).addBox(-1.0F, -0.7828F, 1.1971F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126).addBox(-2.0F, 0.2778F, 1.5506F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126)
						.addBox(-3.0F, 1.3385F, 1.9042F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 126).addBox(-4.0F, 2.3991F, 2.2577F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126)
						.addBox(-5.0F, 3.4598F, 2.6113F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 126).addBox(-6.0F, 4.5205F, 2.9648F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 126)
						.addBox(-1.0F, -2.1971F, -0.2172F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 126).addBox(-2.0F, -2.5506F, -1.2778F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 126)
						.addBox(-3.0F, -2.9042F, -2.3385F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(45, 126).addBox(-4.0F, -3.2577F, -3.3991F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 126)
						.addBox(-5.0F, -3.6113F, -4.4598F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 126).addBox(-7.0F, 5.5811F, 3.3184F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 126)
						.addBox(-7.0F, -4.3184F, -6.5811F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 126).addBox(-6.0F, -3.9648F, -5.5205F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.8727F, 0.0F, 0.0F));
		PartDefinition cube_r4 = AngelHat.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(66, 126).addBox(-7.0F, 5.5811F, 3.3184F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 126).addBox(-7.0F, -4.3184F, -6.5811F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 2.3562F, -1.4835F, -1.5708F));
		...
		PartDefinition L8 = L7.addOrReplaceChild("L8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r5 = L8.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(42, 0).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.75F)), PartPose.offsetAndRotation(0.0F, 0.375F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition R8 = R7.addOrReplaceChild("R8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r6 = R8.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.75F)).mirror(false),
		...
		PartDefinition Goggles = Head.addOrReplaceChild("Goggles",
				CubeListBuilder.create().texOffs(73, 68).addBox(-4.0F, -0.3581F, -3.0662F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.025F)).texOffs(0, 118).addBox(-4.025F, -0.3581F, -2.0912F, 0.025F, 2.0F, 8.05F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r7 = Goggles.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 126).addBox(-2.025F, -0.025F, -0.025F, 4.05F, 2.15F, 0.05F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = R.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(60, 90).mirror().addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(-4.95F)).mirror(false),
				PartPose.offsetAndRotation(0.0112F, 0.025F, 4.7118F, -3.1416F, 0.0F, 0.0F));
		PartDefinition cube_r9 = R.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(58, 78).addBox(-3.999F, -4.0F, -1.0F, 8.0F, 8.0F, 2.0F, new CubeDeformation(-3.0F)),
		...
		PartDefinition cube_r10 = RSign.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(82, 81).mirror().addBox(-6.5F, -6.5F, 0.0F, 13.0F, 13.0F, 0.0F, new CubeDeformation(-5.7F)).mirror(false),
		...
		PartDefinition cube_r11 = L.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(60, 90).mirror().addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(-4.95F)).mirror(false),
				PartPose.offsetAndRotation(0.0112F, 0.025F, 4.7118F, -3.1416F, 0.0F, 0.0F));
		PartDefinition cube_r12 = L.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(58, 78).addBox(-3.999F, -4.0F, -1.0F, 8.0F, 8.0F, 2.0F, new CubeDeformation(-3.0F)),
				PartPose.offsetAndRotation(0.0112F, 0.0F, 1.8618F, 0.0F, 3.1416F, 0.0F));
		PartDefinition LSign = L.addOrReplaceChild("LSign", CubeListBuilder.create(), PartPose.offset(-0.0013F, 0.0F, -0.1632F));
		PartDefinition cube_r13 = LSign.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(82, 81).mirror().addBox(-6.5F, -6.5F, 0.0F, 13.0F, 13.0F, 0.0F, new CubeDeformation(-5.7F)).mirror(false),
				PartPose.offsetAndRotation(0.0125F, 0.05F, 5.7F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(80, 48).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.55F)).texOffs(64, 48).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.05F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(64, 16).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.55F)).texOffs(64, 32).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.05F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));
