...
public class Modelmindscapeengiearmor extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelmindscapeengiearmor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition AngelHat = Head.addOrReplaceChild("AngelHat",
				CubeListBuilder.create().texOffs(0, 11).addBox(-9.0F, 2.25F, -8.975F, 18.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11).addBox(-8.0F, 1.75F, -7.975F, 16.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
						.addBox(-7.0F, 1.25F, -6.975F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-6.0F, 0.75F, -5.975F, 12.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
						.addBox(-4.0F, -0.25F, -3.975F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 23).addBox(-2.0F, -1.25F, -1.975F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Goggles.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(8, 124).addBox(-2.025F, -0.025F, -0.025F, 4.05F, 3.15F, 0.05F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = R.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(60, 90).mirror().addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(-4.95F)).mirror(false),
				PartPose.offsetAndRotation(0.0112F, 1.025F, 4.7118F, -3.1416F, 0.0F, 0.0F));
		PartDefinition cube_r6 = R.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(58, 78).addBox(-3.999F, -4.0F, -1.0F, 8.0F, 8.0F, 2.0F, new CubeDeformation(-3.0F)),
		...
		PartDefinition cube_r7 = RSign.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(81, 80).mirror().addBox(-7.5F, -7.5F, 0.0F, 15.0F, 15.0F, 0.0F, new CubeDeformation(-6.625F)).mirror(false),
		...
		PartDefinition cube_r8 = L.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(60, 90).mirror().addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(-4.95F)).mirror(false),
				PartPose.offsetAndRotation(0.0112F, 1.025F, 4.7118F, -3.1416F, 0.0F, 0.0F));
		PartDefinition cube_r9 = L.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(58, 78).addBox(-3.999F, -4.0F, -1.0F, 8.0F, 8.0F, 2.0F, new CubeDeformation(-3.0F)),
				PartPose.offsetAndRotation(0.0112F, 1.0F, 1.8618F, 0.0F, 3.1416F, 0.0F));
		PartDefinition LSign = L.addOrReplaceChild("LSign", CubeListBuilder.create(), PartPose.offset(-0.0013F, 0.0F, -0.2882F));
		PartDefinition cube_r10 = LSign.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(81, 80).mirror().addBox(-7.5F, -7.5F, 0.0F, 15.0F, 15.0F, 0.0F, new CubeDeformation(-6.625F)).mirror(false),
				PartPose.offsetAndRotation(0.0125F, 1.0F, 6.75F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition Scarf = Body.addOrReplaceChild("Scarf",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r11 = Scarf.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 73).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F, new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0F, 1.4315F, 2.6042F, -2.3562F, 0.0F, 0.0F));
		PartDefinition cube_r12 = Scarf.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 73).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F, new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0F, 1.4315F, -2.6208F, -0.7854F, 0.0F, 0.0F));
		PartDefinition cube_r13 = Scarf.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(0, 73).addBox(-0.5F, -0.725F, -4.025F, 1.0F, 1.45F, 8.05F, new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0091F, -1.7409F, 3.675F, 1.5708F, -0.7854F, -1.5708F));
		PartDefinition cube_r14 = Scarf.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(0, 73).addBox(-0.5F, -0.725F, -4.025F, 1.0F, 1.45F, 8.05F, new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0091F, -1.7409F, -3.675F, 1.5708F, 0.7854F, -1.5708F));
