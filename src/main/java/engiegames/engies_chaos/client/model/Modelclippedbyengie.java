...
public class Modelclippedbyengie extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelclippedbyengie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Root.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(64, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(96, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)),
		...
		PartDefinition Headset = Head.addOrReplaceChild("Headset",
				CubeListBuilder.create().texOffs(0, 95).addBox(4.0053F, 0.2316F, -2.0F, 1.3F, 4.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(14, 98).addBox(4.0553F, 1.0316F, -1.2F, 1.4F, 2.4F, 2.4F, new CubeDeformation(0.025F)).texOffs(22, 94)
						...
						.addBox(-4.7947F, -0.2684F, -2.0F, 0.8F, 5.0F, 4.0F, new CubeDeformation(0.025F)).mirror(false).texOffs(11, 88).addBox(-4.7947F, 0.2316F, -2.5F, 0.8F, 4.0F, 5.0F, new CubeDeformation(0.025F)).texOffs(13, 55)
		...
		PartDefinition Goggles = Head.addOrReplaceChild("Goggles",
				CubeListBuilder.create().texOffs(73, 68).addBox(-4.0F, -0.3581F, -3.0662F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 118).addBox(-4.025F, -0.3581F, -2.0912F, 0.025F, 2.0F, 8.05F, new CubeDeformation(0.0F))
						...
						.addBox(-2.025F, -2.4081F, 5.9088F, 4.05F, 2.05F, 0.05F, new CubeDeformation(0.0F)).texOffs(0, 119).addBox(-2.025F, -2.4081F, -2.0912F, 4.05F, 0.05F, 8.05F, new CubeDeformation(0.0F)).texOffs(56, 64)
		...
		PartDefinition cube_r4 = RSign.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(81, 80).mirror().addBox(-7.5F, -7.5F, 0.0F, 15.0F, 15.0F, 0.0F, new CubeDeformation(-6.625F)).mirror(false),
		...
		PartDefinition cube_r7 = LSign.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(81, 80).mirror().addBox(-7.5F, -7.5F, 0.0F, 15.0F, 15.0F, 0.0F, new CubeDeformation(-6.625F)).mirror(false),
				PartPose.offsetAndRotation(0.0125F, 0.0F, 6.75F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r8 = AngelHat.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.025F)).texOffs(36, 22).addBox(-2.0F, -1.5F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(36, 15)
						.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.025F)).texOffs(30, 28).addBox(-4.0F, -0.5F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(0, 28)
						.addBox(-5.0F, 0.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.025F)).texOffs(0, 15).addBox(-6.0F, 0.5F, -6.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.025F)).texOffs(0, 0)
		...
		PartDefinition Chains = AngelHat.addOrReplaceChild("Chains", CubeListBuilder.create(), PartPose.offset(0.0F, 8.0F, 0.025F));
		...
		PartDefinition L8 = L7.addOrReplaceChild("L8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r9 = L8.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.775F)).mirror(false),
		...
		PartDefinition R8 = R7.addOrReplaceChild("R8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r10 = R8.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.775F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.35F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition Body = Root.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(80, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, -24.0F, 0.0F));
		PartDefinition Scarf = Body.addOrReplaceChild("Scarf",
				CubeListBuilder.create().texOffs(0, 71).addBox(-4.275F, -2.0F, -4.125F, 8.55F, 2.0F, 8.55F, new CubeDeformation(0.0F)).texOffs(0, 71).addBox(-4.25F, -0.5F, -3.475F, 8.5F, 2.0F, 6.925F, new CubeDeformation(0.05F)).texOffs(0, 71)
						.addBox(-4.25F, 1.325F, -1.575F, 8.5F, 2.0F, 3.0F, new CubeDeformation(0.05F)).texOffs(0, 71).addBox(-4.525F, -2.6F, -4.525F, 9.05F, 3.125F, 9.05F, new CubeDeformation(0.05F)).texOffs(0, 71)
						.addBox(-3.525F, -3.6F, -3.525F, 7.05F, 1.025F, 7.05F, new CubeDeformation(0.05F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r11 = Scarf.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 71).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F, new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0F, 1.4315F, 2.6042F, -2.3562F, 0.0F, 0.0F));
		PartDefinition cube_r12 = Scarf.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 71).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F, new CubeDeformation(0.05F)),
		...
		PartDefinition RightScarf9 = RightScarf8.addOrReplaceChild("RightScarf9",
				CubeListBuilder.create().texOffs(3, 4).addBox(-0.5747F, 0.9923F, -0.3124F, 1.0F, 1.0F, 0.325F, new CubeDeformation(0.0F)).texOffs(3, 4).addBox(-0.5747F, 1.8923F, -0.3124F, 1.0F, 1.0F, 0.325F, new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, -0.1745F, 0.0F, 0.0436F));
		PartDefinition cube_r17 = RightScarf9.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(3, 4).addBox(-1.9811F, 0.4047F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(-0.1F)).texOffs(3, 4).addBox(-1.9784F, -0.4922F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = RightScarf9.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(3, 4).addBox(1.1265F, 0.4239F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(-0.1F)).texOffs(3, 4).addBox(1.1239F, -0.473F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1481F, 1.583F, -0.1317F, 0.0F, 0.0F, -0.1309F));
		PartDefinition cube_r19 = RightScarf9.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(3, 4).addBox(-3.5292F, 0.774F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(-0.1F)).texOffs(3, 4).addBox(-3.5043F, -0.1144F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = RightScarf9.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(3, 4).addBox(2.7168F, 0.8332F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(-0.1F)).texOffs(3, 4).addBox(2.6919F, -0.0553F, -0.1807F, 1.0F, 1.0F, 0.325F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1481F, 1.583F, -0.1317F, 0.0F, 0.0F, -0.3054F));
		...
		PartDefinition LeftScarf9 = LeftScarf8.addOrReplaceChild("LeftScarf9",
				CubeListBuilder.create().texOffs(3, 4).addBox(-0.5748F, 0.9923F, -0.3124F, 1.0F, 1.0F, 0.325F, new CubeDeformation(0.0F)).texOffs(3, 4).addBox(-0.5748F, 1.8923F, -0.3124F, 1.0F, 1.0F, 0.325F, new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, -0.1745F, 0.0F, -0.0436F));
		...
		PartDefinition LeftLeg = Root.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(80, 48).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(64, 48).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(1.9F, -12.0F, 0.0F));
		PartDefinition RightLeg = Root.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(64, 16).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(64, 32).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-1.9F, -12.0F, 0.0F));
		PartDefinition Cape = Root.addOrReplaceChild("Cape", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -24.0F, 2.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition cube_r25 = Cape.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(37, 106).addBox(-5.0F, -8.0F, -0.5F, 10.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)),
