...
public class Modelboyolayaltxengie extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelboyolayaltxengie"), "main");
	...
	public Modelboyolayaltxengie(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r15 = Bell.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(22, 40).mirror().addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false),
				PartPose.offsetAndRotation(1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));
		PartDefinition RightFrontLeg = partdefinition.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(), PartPose.offset(-3.1F, 17.0F, -5.225F));
		PartDefinition RightFrontUpperLeg = RightFrontLeg.addOrReplaceChild("RightFrontUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 5.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition LeftFrontUpperLeg3 = LeftFrontLeg.addOrReplaceChild("LeftFrontUpperLeg3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 6.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackUpperLeg = LeftBackLeg.addOrReplaceChild("LeftBackUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 5.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition RightBackUpperLeg = RightBackLeg.addOrReplaceChild("RightBackUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 5.0175F, -1.3526F, 0.0F, 0.0F));
