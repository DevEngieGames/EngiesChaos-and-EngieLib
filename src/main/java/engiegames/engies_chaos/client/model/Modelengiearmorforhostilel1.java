...
public class Modelengiearmorforhostilel1 extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelengiearmorforhostilel_1"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition L8 = L7.addOrReplaceChild("L8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r4 = L8.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(42, 0).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.775F)), PartPose.offsetAndRotation(0.0F, 0.35F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition R8 = R7.addOrReplaceChild("R8",
				CubeListBuilder.create().texOffs(126, 124).addBox(-0.175F, -0.225F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F)).texOffs(126, 124).addBox(-0.175F, 0.175F, -0.025F, 0.35F, 0.05F, 0.05F, new CubeDeformation(0.025F))
						.texOffs(127, 124).addBox(0.175F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)).texOffs(127, 124).addBox(-0.225F, -0.175F, -0.025F, 0.05F, 0.35F, 0.05F, new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.3F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition cube_r5 = R8.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.775F)).mirror(false),
		...
		PartDefinition R = Goggles.addOrReplaceChild("R",
				CubeListBuilder.create().texOffs(77, 71).addBox(-0.9888F, -0.025F, -0.2882F, 2.0F, 0.025F, 0.65F, new CubeDeformation(0.0F)).texOffs(77, 75).addBox(-0.9888F, 2.0F, -0.2882F, 2.0F, 0.025F, 0.65F, new CubeDeformation(0.0F))
						...
						.addBox(-0.9888F, 0.25F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 71).addBox(-0.7388F, 0.0F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 75)
						.addBox(-0.9888F, 1.75F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 75).addBox(-0.7388F, 1.75F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 75)
						.addBox(-0.9888F, 1.5F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 75).addBox(0.7362F, 1.75F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 75)
						.addBox(0.7362F, 1.5F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 75).addBox(0.4862F, 1.75F, -0.2882F, 0.25F, 0.25F, 0.6F, new CubeDeformation(0.0F)).texOffs(77, 71)
