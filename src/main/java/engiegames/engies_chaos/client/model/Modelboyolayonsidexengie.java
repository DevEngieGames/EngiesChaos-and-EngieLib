...
public class Modelboyolayonsidexengie extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelboyolayonsidexengie"), "main");
	...
	public Modelboyolayonsidexengie(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = Ear1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(36, 31).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(-0.4875F, 0.0F, 0.0F, 0.0F, 0.4363F, 0.0F));
		PartDefinition Ear2 = Head.addOrReplaceChild("Ear2", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.4652F, -7.2736F, -0.8464F, -0.9163F, -0.4363F, 0.0F));
		...
		PartDefinition Hat = Head
				.addOrReplaceChild(
						"Hat", CubeListBuilder.create().texOffs(0, 59).addBox(-7.0F, 0.6177F, -7.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 62).addBox(-6.0F, 0.1177F, -6.0F, 12.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(0, 65).addBox(-4.0F, -0.8823F, -4.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 68).addBox(-2.0F, -1.8823F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, -5.8677F, -4.0F));
		...
		PartDefinition mid1a = mid1.addOrReplaceChild("mid1a", CubeListBuilder.create().texOffs(68, 16).addBox(-2.75F, -2.75F, 0.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
