...
public class Modelboyosleepaltxengie<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("engies_chaos", "modelboyosleepaltxengie"), "main");
	...
	public Modelboyosleepaltxengie(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Crown = Head.addOrReplaceChild("Crown",
				CubeListBuilder.create().texOffs(83, 60).addBox(-0.9977F, -1.05F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 60).addBox(-4.9977F, 0.95F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 60)
						.addBox(-4.9977F, 0.95F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 51).addBox(4.0023F, 0.95F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(-4.9977F, 0.95F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 51).addBox(4.0023F, -0.05F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-4.9977F, -0.05F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(60, 51).addBox(-4.9977F, -0.05F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-4.9977F, -0.05F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60).addBox(-0.9977F, -1.05F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 54)
						.addBox(-0.9977F, -0.05F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 56).addBox(-4.9977F, -0.05F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 54)
						.addBox(3.0023F, -0.05F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 58).addBox(-0.9977F, -0.05F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 58)
						.addBox(-4.9977F, -0.05F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 56).addBox(3.0023F, -0.05F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-4.9977F, -1.05F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(82, 59).addBox(-4.9977F, -1.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59).addBox(-4.9977F, -1.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59).addBox(4.0023F, -1.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 54)
						.addBox(-5.2477F, -0.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 54).addBox(-5.2477F, -0.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 54)
						.addBox(-5.2477F, -0.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 57).addBox(4.2273F, -0.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 57)
						.addBox(4.2273F, -0.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 57).addBox(4.2273F, -0.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(83, 60).addBox(3.0023F, -1.05F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0023F, -1.05F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60).addBox(-4.9977F, -1.05F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(-0.0023F, -9.7F, -13.0F, 1.2217F, 0.0F, 0.0F));
		...
		PartDefinition Whisker_r1 = Snout.addOrReplaceChild("Whisker_r1", CubeListBuilder.create().texOffs(54, 31).addBox(-2.0F, -1.5F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.05F, 1.01F, 1.0F, 0.0F, -0.2618F, 0.0F));
		PartDefinition Whisker_r2 = Snout.addOrReplaceChild("Whisker_r2", CubeListBuilder.create().texOffs(54, 34).addBox(0.0F, -1.5F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition tip = mid2a.addOrReplaceChild("tip", CubeListBuilder.create().texOffs(86, 33).addBox(-1.1F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, -0.2182F, 0.0F, 0.0F));
		PartDefinition tip2 = tip.addOrReplaceChild("tip2", CubeListBuilder.create().texOffs(86, 33).addBox(-1.1F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, -0.0175F, 0.0F, 0.0F));
		...
		PartDefinition Toe_r2 = LeftFrontFoot.addOrReplaceChild("Toe_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0)
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)),
				PartPose.offsetAndRotation(1.55F, 0.8772F, -2.8036F, -0.6109F, 0.0F, 0.0F));
		PartDefinition RightBackLeg = Root.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(), PartPose.offset(-3.1F, -7.0F, 5.775F));
		PartDefinition RightBackUpperLeg = RightBackLeg.addOrReplaceChild("RightBackUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -1.358F, 0.0175F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition MidLeg_r3 = RightBackMidLeg.addOrReplaceChild("MidLeg_r3", CubeListBuilder.create().texOffs(52, 16).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		PartDefinition RightBackLowerLeg = RightBackMidLeg.addOrReplaceChild("RightBackLowerLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 1.535F, 2.3715F, 0.4363F, 0.0F, 0.0F));
