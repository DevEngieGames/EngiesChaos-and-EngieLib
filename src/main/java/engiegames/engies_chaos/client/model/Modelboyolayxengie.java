...
public class Modelboyolayxengie extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelboyolayxengie"), "main");
	...
	public final ModelPart LeftFrontUpperLeg3;
	public final ModelPart LeftFrontMidLeg3;
	public final ModelPart LeftFrontLowerLeg3;
	public final ModelPart LeftFrontFoot3;
	...
	public Modelboyolayxengie(ModelPart root) {
		super(root);
		...
		this.LeftFrontUpperLeg3 = this.LeftFrontLeg.getChild("LeftFrontUpperLeg3");
		this.LeftFrontMidLeg3 = this.LeftFrontUpperLeg3.getChild("LeftFrontMidLeg3");
		this.LeftFrontLowerLeg3 = this.LeftFrontMidLeg3.getChild("LeftFrontLowerLeg3");
		this.LeftFrontFoot3 = this.LeftFrontLowerLeg3.getChild("LeftFrontFoot3");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = Head
				.addOrReplaceChild(
						"Hat", CubeListBuilder.create().texOffs(0, 59).addBox(-7.0F, -3.3824F, -7.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 62).addBox(-6.0F, -3.8824F, -6.0F, 12.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(0, 65).addBox(-4.0F, -4.8824F, -4.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 68).addBox(-2.0F, -5.8824F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, -1.8676F, -4.0F));
		PartDefinition cube_r1 = Hat.addOrReplaceChild("cube_r1",
				...
				PartPose.offsetAndRotation(0.0F, -5.8824F, 0.0F, 0.0F, 3.1416F, 0.0F));
		PartDefinition cube_r2 = Hat.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 65).addBox(-2.0F, -0.5F, -4.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 62)
				.addBox(-4.0F, 0.5F, -6.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 59).addBox(-5.0F, 1.0F, -7.0F, 10.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.3824F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition Snout = Head.addOrReplaceChild("Snout",
				...
				PartPose.offset(1.9F, -1.51F, -9.925F));
		...
		PartDefinition Crown = Head.addOrReplaceChild("Crown",
				CubeListBuilder.create().texOffs(38, 60).addBox(-5.0F, 0.75F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 60).addBox(-5.0F, 0.75F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(4.0F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(38, 51).addBox(-5.0F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(4.0F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60).addBox(-5.0F, -0.25F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(-5.0F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60).addBox(-5.0F, -0.25F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-1.0F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 54).addBox(-1.0F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 56)
						.addBox(-5.0F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 54).addBox(3.0F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 58)
						.addBox(-1.0F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 58).addBox(-5.0F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 56)
						.addBox(3.0F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60).addBox(-5.0F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-5.0F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59).addBox(4.0F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-5.0F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59).addBox(4.0F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 54).addBox(-5.25F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 54)
						.addBox(-5.25F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 54).addBox(-5.25F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 57)
						.addBox(4.225F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 57).addBox(4.225F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 57)
						.addBox(4.225F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59).addBox(-5.0F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60).addBox(3.0F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-5.0F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60).addBox(-1.0F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)),
		...
		PartDefinition tail = Body.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offsetAndRotation(0.15F, 35.2F, -18.975F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition mid1 = base2.addOrReplaceChild("mid1", CubeListBuilder.create().texOffs(68, 16).addBox(-2.75F, -2.75F, 0.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.0436F, 0.0F, 0.0F));
		PartDefinition mid1a = mid1.addOrReplaceChild("mid1a", CubeListBuilder.create().texOffs(68, 16).addBox(-2.75F, -2.75F, 0.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.0611F, 0.0F, 0.0F));
		...
		PartDefinition tip = mid2a.addOrReplaceChild("tip", CubeListBuilder.create().texOffs(85, 28).addBox(-0.875F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.1745F, 0.0F, 0.0F));
		PartDefinition tip2 = tip.addOrReplaceChild("tip2", CubeListBuilder.create().texOffs(86, 33).addBox(-0.875F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.1571F, 0.0F, 0.0F));
		...
		PartDefinition Fin = Body.addOrReplaceChild("Fin", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0269F, 8.2102F, 4.336F, -2.618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = Fin.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(44, 31).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(-0.4875F, 0.0F, 0.0F, 0.0F, 0.4363F, 0.0F));
		PartDefinition Collar = Body.addOrReplaceChild("Collar", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.0502F, 2.0579F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r15 = Bell.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(22, 40).mirror().addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false),
				PartPose.offsetAndRotation(1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));
		PartDefinition RightFrontLeg = partdefinition.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.1F, 17.0F, -5.225F, 0.0F, 0.4363F, 0.0F));
		PartDefinition RightFrontUpperLeg = RightFrontLeg.addOrReplaceChild("RightFrontUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 1.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition RightFrontMidLeg = RightFrontUpperLeg.addOrReplaceChild("RightFrontMidLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.6749F, -0.456F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition RightFrontLowerLeg = RightFrontMidLeg.addOrReplaceChild("RightFrontLowerLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 2.535F, 1.9715F, 1.0908F, 0.0F, 0.0F));
		...
		PartDefinition LeftFrontLeg = partdefinition.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(2.9F, 17.0F, -6.225F, 0.0F, -0.4363F, 0.0F));
		PartDefinition LeftFrontUpperLeg3 = LeftFrontLeg.addOrReplaceChild("LeftFrontUpperLeg3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 2.0175F, -1.3526F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r2 = LeftFrontUpperLeg3.addOrReplaceChild("UpperLegLayer_r2",
				CubeListBuilder.create().texOffs(0, 87).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.261F)).texOffs(36, 16).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, -0.3F, -0.2182F, 0.0F, 0.0F));
		PartDefinition LeftFrontMidLeg3 = LeftFrontUpperLeg3.addOrReplaceChild("LeftFrontMidLeg3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.6749F, -0.456F, -0.7854F, 0.0F, 0.0F));
		PartDefinition MidLeg_r2 = LeftFrontMidLeg3.addOrReplaceChild("MidLeg_r2", CubeListBuilder.create().texOffs(52, 16).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		PartDefinition LeftFrontLowerLeg3 = LeftFrontMidLeg3.addOrReplaceChild("LeftFrontLowerLeg3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 2.535F, 1.9715F, 1.0908F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r2 = LeftFrontLowerLeg3.addOrReplaceChild("LowerLeg_r2", CubeListBuilder.create().texOffs(36, 25).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
		PartDefinition LeftFrontFoot3 = LeftFrontLowerLeg3.addOrReplaceChild("LeftFrontFoot3",
				CubeListBuilder.create().texOffs(50, 24).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(0, 6).addBox(-2.0375F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(0, 6)
						.addBox(-1.0125F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(0, 6).addBox(0.0125F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(0, 6)
						.addBox(1.0375F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)),
				PartPose.offset(-0.005F, 1.4481F, -1.108F));
		PartDefinition Toe_r2 = LeftFrontFoot3.addOrReplaceChild("Toe_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0)
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)),
				PartPose.offsetAndRotation(1.55F, 0.8772F, -2.8036F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LeftBackLeg = partdefinition.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(2.9F, 17.0F, 5.775F, 0.0F, -0.4363F, 0.0F));
		PartDefinition LeftBackUpperLeg = LeftBackLeg.addOrReplaceChild("LeftBackUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 1.0175F, -1.3526F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r3 = LeftBackUpperLeg.addOrReplaceChild("UpperLegLayer_r3",
				CubeListBuilder.create().texOffs(0, 87).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.261F)).texOffs(36, 16).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, -0.3F, -0.2182F, 0.0F, 0.0F));
		PartDefinition LeftBackMidLeg = LeftBackUpperLeg.addOrReplaceChild("LeftBackMidLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.6749F, -0.456F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition Toe_r3 = LeftBackFoot.addOrReplaceChild("Toe_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0)
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)),
				PartPose.offsetAndRotation(1.55F, 0.8772F, -2.8036F, -0.6109F, 0.0F, 0.0F));
		PartDefinition RightBackLeg = partdefinition.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.1F, 17.0F, 5.775F, 0.0F, 0.4363F, 0.0F));
		PartDefinition RightBackUpperLeg = RightBackLeg.addOrReplaceChild("RightBackUpperLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 1.0175F, -1.3526F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r4 = RightBackUpperLeg.addOrReplaceChild("UpperLegLayer_r4",
				CubeListBuilder.create().texOffs(0, 87).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.261F)).texOffs(36, 16).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, -0.3F, -0.2182F, 0.0F, 0.0F));
		PartDefinition RightBackMidLeg = RightBackUpperLeg.addOrReplaceChild("RightBackMidLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.6749F, -0.456F, -0.7854F, 0.0F, 0.0F));
		PartDefinition MidLeg_r4 = RightBackMidLeg.addOrReplaceChild("MidLeg_r4", CubeListBuilder.create().texOffs(52, 16).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		PartDefinition RightBackLowerLeg = RightBackMidLeg.addOrReplaceChild("RightBackLowerLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 2.535F, 1.9715F, 1.0908F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r4 = RightBackLowerLeg.addOrReplaceChild("LowerLeg_r4", CubeListBuilder.create().texOffs(36, 25).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
		PartDefinition RightBackFoot = RightBackLowerLeg.addOrReplaceChild("RightBackFoot",
				CubeListBuilder.create().texOffs(50, 24).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(0, 6).addBox(-2.0375F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(0, 6)
						...
						.addBox(1.0375F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)),
				PartPose.offset(-0.005F, 1.4481F, -1.108F));
		PartDefinition Toe_r4 = RightBackFoot.addOrReplaceChild("Toe_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0)
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(0, 0).addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)),
				PartPose.offsetAndRotation(1.55F, 0.8772F, -2.8036F, -0.6109F, 0.0F, 0.0F));
