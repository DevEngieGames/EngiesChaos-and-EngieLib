...
public class Modelbigboyosleep extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("engies_chaos", "modelbigboyosleep"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = Head.addOrReplaceChild("Hat",
				CubeListBuilder.create().texOffs(0, 58).addBox(-3.95F, 0.7926F, -6.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 58).addBox(-3.45F, 0.0677F, -6.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
