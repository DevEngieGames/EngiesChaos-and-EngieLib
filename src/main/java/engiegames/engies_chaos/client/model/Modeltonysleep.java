...
public class Modeltonysleep<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("engies_chaos", "modeltonysleep"), "main");
	...
	public Modeltonysleep(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Tony = partdefinition.addOrReplaceChild("Tony", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 9.0F, 0.0F, 0.0F, 0.0F, -3.1416F));
		...
		PartDefinition tip2 = tip.addOrReplaceChild("tip2", CubeListBuilder.create().texOffs(116, 57).addBox(-0.875F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, -0.0175F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackLeg = Tony.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(), PartPose.offset(2.8F, -7.0F, 5.775F));
		...
		PartDefinition RightBackLeg = Tony.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(), PartPose.offset(-3.0F, -7.0F, 5.775F));
		PartDefinition LeftBackUpperLeg2 = RightBackLeg.addOrReplaceChild("LeftBackUpperLeg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -1.358F, 0.0175F, 0.8727F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer3_r1 = LeftBackUpperLeg2
				.addOrReplaceChild(
						"UpperLegLayer3_r1", CubeListBuilder.create().texOffs(69, 76).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.086F)).texOffs(99, 59)
								.addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.061F)).texOffs(112, 0).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
						PartPose.offsetAndRotation(0.0F, 2.5F, -0.3F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition MidLeg_r2 = LeftBackMidLeg2.addOrReplaceChild("MidLeg_r2", CubeListBuilder.create().texOffs(112, 10).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		PartDefinition LeftBackLowerLeg2 = LeftBackMidLeg2.addOrReplaceChild("LeftBackLowerLeg2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 1.535F, 2.3715F, 0.4363F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r2 = LeftBackLowerLeg2.addOrReplaceChild("LowerLeg_r2", CubeListBuilder.create().texOffs(114, 19).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition Toe_r2 = LeftBackFoot2.addOrReplaceChild("Toe_r2",
				CubeListBuilder.create().texOffs(124, 33).addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(124, 33).addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(124, 33)
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(124, 33).addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)),
				PartPose.offsetAndRotation(1.55F, 0.8772F, -2.8036F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LeftFrontLeg = Tony.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(), PartPose.offset(2.8F, -7.0F, -6.225F));
		...
		PartDefinition MidLeg_r3 = LeftFrontMidLeg.addOrReplaceChild("MidLeg_r3", CubeListBuilder.create().texOffs(112, 10).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition LowerLeg_r3 = LeftFrontLowerLeg.addOrReplaceChild("LowerLeg_r3", CubeListBuilder.create().texOffs(114, 19).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition Toe_r3 = LeftFrontFoot.addOrReplaceChild("Toe_r3",
				CubeListBuilder.create().texOffs(124, 33).addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(124, 33).addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(124, 33)
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).texOffs(124, 33).addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)),
				PartPose.offsetAndRotation(1.55F, 0.8772F, -2.8036F, -0.6109F, 0.0F, 0.0F));
		PartDefinition RightFrontLeg = Tony.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(), PartPose.offset(-3.0F, -7.0F, -6.225F));
		...
		PartDefinition MidLeg_r4 = RightFrontMidLeg.addOrReplaceChild("MidLeg_r4", CubeListBuilder.create().texOffs(112, 10).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition LowerLeg_r4 = RightFrontLowerLeg.addOrReplaceChild("LowerLeg_r4", CubeListBuilder.create().texOffs(114, 19).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
