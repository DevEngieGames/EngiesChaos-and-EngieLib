...
public class XEngieGamesTradeUIPickerScreen extends AbstractContainerScreen<XEngieGamesTradeUIPickerMenu> implements EngiesChaosModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("engies_chaos:textures/screens/x_engie_games_trade_ui_picker.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.label_pick_any_trade_ui"), 37, 1, -16777216, false);
	}

	@Override
	public void init() {
		super.init();
		button_doomsday_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_doomsday_trade_ui"), e -> {
			...
			if (DoomsdayButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(0, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}).bounds(this.leftPos + 23, this.topPos + 10, 113, 20).build();
		this.addRenderableWidget(button_doomsday_trade_ui);
		button_super_doomsday_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_super_doomsday_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (SuperDoomsdayButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(1, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}).bounds(this.leftPos + 7, this.topPos + 32, 145, 20).build();
		this.addRenderableWidget(button_super_doomsday_trade_ui);
		button_the_end_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_the_end_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (TheEndButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(2, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}).bounds(this.leftPos + 25, this.topPos + 54, 108, 20).build();
		this.addRenderableWidget(button_the_end_trade_ui);
		button_engie_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_engie_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (EngieButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(3, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}).bounds(this.leftPos + 30, this.topPos + 76, 98, 20).build();
		this.addRenderableWidget(button_engie_trade_ui);
		button_mindscape_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_mindscape_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (MindscapeButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(4, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}).bounds(this.leftPos + 20, this.topPos + 98, 119, 20).build();
		this.addRenderableWidget(button_mindscape_trade_ui);
		button_engiegames_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_engiegames_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (EngieGamesButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(5, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}).bounds(this.leftPos + 18, this.topPos + 120, 124, 20).build();
		this.addRenderableWidget(button_engiegames_trade_ui);
		button_cosmic_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_cosmic_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (CosmicButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(6, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}).bounds(this.leftPos + 28, this.topPos + 142, 103, 20).build();
		this.addRenderableWidget(button_cosmic_trade_ui);
		button_roughian_trade_ui = Button.builder(Component.translatable("gui.engies_chaos.x_engie_games_trade_ui_picker.button_roughian_trade_ui"), e -> {
			int x = XEngieGamesTradeUIPickerScreen.this.x;
			int y = XEngieGamesTradeUIPickerScreen.this.y;
			if (RoughianButtonShowProcedure.execute(world)) {
				PacketDistributor.sendToServer(new XEngieGamesTradeUIPickerButtonMessage(7, x, y, z));
				XEngieGamesTradeUIPickerButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		}).bounds(this.leftPos + 23, this.topPos + 164, 113, 20).build();
