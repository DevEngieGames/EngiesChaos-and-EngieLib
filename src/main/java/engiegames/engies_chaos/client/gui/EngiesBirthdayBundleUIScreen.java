...
import engiegames.engies_chaos.network.EngiesBirthdayBundleUIButtonMessage;
...
public class EngiesBirthdayBundleUIScreen extends AbstractContainerScreen<EngiesBirthdayBundleUIMenu> implements EngiesChaosModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("engies_chaos:textures/screens/engies_birthday_bundle_ui.png");
	...
	public void init() {
		...
		ChangeBundleName.setHint(Component.translatable("gui.engies_chaos.engies_birthday_bundle_ui.ChangeBundleName"));
		this.addWidget(this.ChangeBundleName);
		button_set_name = Button.builder(Component.translatable("gui.engies_chaos.engies_birthday_bundle_ui.button_set_name"), e -> {
