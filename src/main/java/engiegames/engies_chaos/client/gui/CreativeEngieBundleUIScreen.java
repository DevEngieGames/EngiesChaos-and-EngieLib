...
public class CreativeEngieBundleUIScreen extends AbstractContainerScreen<CreativeEngieBundleUIMenu> implements EngiesChaosModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("engies_chaos:textures/screens/creative_engie_bundle_ui.png");
	...
	public void init() {
		...
		ChangeBundleName.setHint(Component.translatable("gui.engies_chaos.creative_engie_bundle_ui.ChangeBundleName"));
		this.addWidget(this.ChangeBundleName);
		button_set_name = Button.builder(Component.translatable("gui.engies_chaos.creative_engie_bundle_ui.button_set_name"), e -> {
