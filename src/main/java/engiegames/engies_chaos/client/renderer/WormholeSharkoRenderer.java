...
public class WormholeSharkoRenderer extends MobRenderer<WormholeSharkoEntity, LivingEntityRenderState, Modelboyoxengie> {
	private WormholeSharkoEntity entity = null;
	...
	public WormholeSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/wormholesharko.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/wormholesharkotired.png");
	...
	@Override
	public void extractRenderState(WormholeSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
