...
import engiegames.engies_chaos.procedures.NormalScaleProcedure;
...
public class NormalRenderer extends MobRenderer<NormalEntity, LivingEntityRenderState, Modelmissilebombs> {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/normal.png");
	}
	...
	protected void scale(LivingEntityRenderState state, PoseStack poseStack) {
		...
		float scale = (float) NormalScaleProcedure.execute(entity);
