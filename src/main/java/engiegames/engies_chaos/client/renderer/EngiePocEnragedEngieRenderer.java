...
public class EngiePocEnragedEngieRenderer extends MobRenderer<EngiePocEnragedEngieEntity, LivingEntityRenderState, Modelengiepochostile> {
	private EngiePocEnragedEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(EngiePocEnragedEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/engiepocenragedengie.png");
	}
