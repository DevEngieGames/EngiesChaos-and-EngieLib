...
public class EpicSharkoRenderer extends MobRenderer<EpicSharkoEntity, LivingEntityRenderState, Modelboyo> {
	...
	public EpicSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/epicsharkonew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/epicsharkonewtired.png");
