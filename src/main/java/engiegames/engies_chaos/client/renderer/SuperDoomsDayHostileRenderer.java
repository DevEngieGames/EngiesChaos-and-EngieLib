...
public class SuperDoomsDayHostileRenderer extends MobRenderer<SuperDoomsDayHostileEntity, LivingEntityRenderState, Modelhostileothers> {
	...
	public SuperDoomsDayHostileRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/superdoomsdayarmorlayer1.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/superdoomsdayarmorlayer2.png");
	...
	@Override
	public void extractRenderState(SuperDoomsDayHostileEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/superdoomsdaymob.png");
	}
