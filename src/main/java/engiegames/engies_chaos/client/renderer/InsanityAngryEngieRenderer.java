...
public class InsanityAngryEngieRenderer extends MobRenderer<InsanityAngryEngieEntity, LivingEntityRenderState, Modelinsanityhostile> {
	private InsanityAngryEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(InsanityAngryEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/insanityangry.png");
	}
