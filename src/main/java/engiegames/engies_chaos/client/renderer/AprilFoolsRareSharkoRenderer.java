...
public class AprilFoolsRareSharkoRenderer extends MobRenderer<AprilFoolsRareSharkoEntity, LivingEntityRenderState, Modelboyoold> {
	private AprilFoolsRareSharkoEntity entity = null;
	...
	public AprilFoolsRareSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyora.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyorat.png");
	...
	@Override
	public void extractRenderState(AprilFoolsRareSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
