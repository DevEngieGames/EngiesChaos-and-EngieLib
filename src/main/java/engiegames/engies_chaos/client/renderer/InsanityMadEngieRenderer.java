...
public class InsanityMadEngieRenderer extends MobRenderer<InsanityMadEngieEntity, LivingEntityRenderState, Modelinsanityhostile> {
	private InsanityMadEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(InsanityMadEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/insanitymad.png");
	}
