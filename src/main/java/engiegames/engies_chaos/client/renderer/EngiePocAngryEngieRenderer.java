...
public class EngiePocAngryEngieRenderer extends MobRenderer<EngiePocAngryEngieEntity, LivingEntityRenderState, Modelengiepochostile> {
	private EngiePocAngryEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(EngiePocAngryEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/engiepocangryengie.png");
	}
