...
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayConditionProcedure;
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayCondition7Procedure;
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayCondition6Procedure;
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayCondition5Procedure;
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayCondition4Procedure;
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayCondition3Procedure;
import engiegames.engies_chaos.procedures.MythicSharkoTDisplayCondition2Procedure;
import engiegames.engies_chaos.procedures.MythicSharkoDisplayConditionProcedure;
...
public class MythicSharkoRenderer extends MobRenderer<MythicSharkoEntity, LivingEntityRenderState, Modelboyo> {
	...
	public MythicSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/mythicsharkonew.png");
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				if (MythicSharkoDisplayConditionProcedure.execute(entity)) {
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayConditionProcedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayCondition2Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayCondition3Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayCondition4Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/mythicsharkonewtired.png");
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayCondition5Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayCondition6Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (MythicSharkoTDisplayCondition7Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
