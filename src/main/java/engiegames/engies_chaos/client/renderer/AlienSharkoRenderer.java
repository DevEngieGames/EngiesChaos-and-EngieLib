...
public class AlienSharkoRenderer extends MobRenderer<AlienSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private AlienSharkoEntity entity = null;

	public AlienSharkoRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelboyo(context.bakeLayer(Modelboyo.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/aliennew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/aliennewtired.png");
	...
	@Override
	public void extractRenderState(AlienSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
