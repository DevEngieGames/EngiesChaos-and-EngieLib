...
public class ExoticSharkoRenderer extends MobRenderer<ExoticSharkoEntity, LivingEntityRenderState, Modelboyo> {
	...
	public ExoticSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/exoticsharkonew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/exoticsharkonewtired.png");
