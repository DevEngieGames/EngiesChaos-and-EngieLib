...
public class AprilFoolsEngieSharkoRenderer extends MobRenderer<AprilFoolsEngieSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private AprilFoolsEngieSharkoEntity entity = null;

	public AprilFoolsEngieSharkoRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelboyo(context.bakeLayer(Modelboyo.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyoe.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyoet.png");
	...
	@Override
	public void extractRenderState(AprilFoolsEngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
