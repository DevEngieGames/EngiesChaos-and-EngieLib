...
public class MadEngieRenderer extends MobRenderer<MadEngieEntity, LivingEntityRenderState, Modelhostile> {
	...
	public MadEngieRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/madengienew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/madnewcoldseason.png");
