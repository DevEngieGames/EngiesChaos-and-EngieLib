...
public class EngiePocMadEngieRenderer extends MobRenderer<EngiePocMadEngieEntity, LivingEntityRenderState, Modelengiepochostile> {
	private EngiePocMadEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(EngiePocMadEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/engiepocmadengie.png");
	}
