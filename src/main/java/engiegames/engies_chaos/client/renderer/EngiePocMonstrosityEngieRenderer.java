...
public class EngiePocMonstrosityEngieRenderer extends MobRenderer<EngiePocMonstrosityEngieEntity, LivingEntityRenderState, Modelengiepochostile> {
	private EngiePocMonstrosityEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(EngiePocMonstrosityEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/engiepocmonstrosityengie.png");
	}
