...
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayConditionProcedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayCondition7Procedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayCondition6Procedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayCondition5Procedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayCondition4Procedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayCondition3Procedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoTDisplayCondition2Procedure;
import engiegames.engies_chaos.procedures.EnragedDeathSharkoDisplayConditionProcedure;
...
public class EnragedDeathSharkoRenderer extends MobRenderer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>> {
	public EnragedDeathSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("engies_chaos:textures/entities/enragednew.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				Level world = entity.level;
				double x = entity.getX();
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoDisplayConditionProcedure.execute(entity)) {
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayConditionProcedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayCondition2Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayCondition3Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayCondition4Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("engies_chaos:textures/entities/enragednewtired.png");
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayCondition5Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayCondition6Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<EnragedDeathSharkoEntity, Modelboyo<EnragedDeathSharkoEntity>>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, EnragedDeathSharkoEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EnragedDeathSharkoTDisplayCondition7Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
