...
public class EnragedDeathSharkoRenderer extends MobRenderer<EnragedDeathSharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private EnragedDeathSharkoEntity entity = null;
	...
	public EnragedDeathSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/enragednew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/enragednewtired.png");
	...
	@Override
	public void extractRenderState(EnragedDeathSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
