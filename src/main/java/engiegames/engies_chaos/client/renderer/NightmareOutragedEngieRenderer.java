...
public class NightmareOutragedEngieRenderer extends MobRenderer<NightmareOutragedEngieEntity, LivingEntityRenderState, Modelnightmarehostile> {
	private NightmareOutragedEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(NightmareOutragedEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/nightmareoutraged_new.png");
	}
