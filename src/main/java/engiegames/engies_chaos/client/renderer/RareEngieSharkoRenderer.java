...
public class RareEngieSharkoRenderer extends MobRenderer<RareEngieSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private RareEngieSharkoEntity entity = null;

	public RareEngieSharkoRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelboyo(context.bakeLayer(Modelboyo.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/rareengiesharkonew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/rareengiesharkonewtired.png");
	...
	@Override
	public void extractRenderState(RareEngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
