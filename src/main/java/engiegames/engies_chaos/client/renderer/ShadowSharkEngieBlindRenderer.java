...
public class ShadowSharkEngieBlindRenderer extends MobRenderer<ShadowSharkEngieBlindEntity, LivingEntityRenderState, ModelShadowEngieSharkEntity> {
	private ShadowSharkEngieBlindEntity entity = null;
	...
	public ShadowSharkEngieBlindRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/shadowsharkengieblind.png");
	...
	@Override
	public void extractRenderState(ShadowSharkEngieBlindEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/shadowsharkengieblind.png");
	}
