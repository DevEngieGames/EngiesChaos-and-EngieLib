...
public class NightmareEnragedEngieRenderer extends MobRenderer<NightmareEnragedEngieEntity, LivingEntityRenderState, Modelnightmarehostile> {
	private NightmareEnragedEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(NightmareEnragedEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/nightmareenraged_new.png");
	}
