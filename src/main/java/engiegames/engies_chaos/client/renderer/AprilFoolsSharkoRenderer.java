...
public class AprilFoolsSharkoRenderer extends MobRenderer<AprilFoolsSharkoEntity, LivingEntityRenderState, Modelboyoold> {
	private AprilFoolsSharkoEntity entity = null;
	...
	public AprilFoolsSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyo.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyot.png");
	...
	@Override
	public void extractRenderState(AprilFoolsSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
