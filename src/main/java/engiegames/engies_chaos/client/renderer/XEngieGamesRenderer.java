...
public class XEngieGamesRenderer extends HumanoidMobRenderer<XEngieGamesEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private XEngieGamesEntity entity = null;
	...
	@Override
	public void extractRenderState(XEngieGamesEntity entity, HumanoidRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(HumanoidRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/21db06ae607a5b6a.png");
	}
