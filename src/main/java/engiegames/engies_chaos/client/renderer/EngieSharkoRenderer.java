...
import engiegames.engies_chaos.procedures.EngieSharkoTDisplayCondition5Procedure;
import engiegames.engies_chaos.procedures.EngieSharkoTDisplayCondition4Procedure;
...
public class EngieSharkoRenderer extends MobRenderer<EngieSharkoEntity, LivingEntityRenderState, Modelboyo> {
	...
	public EngieSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/engiesharkonew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EngieSharkoTDisplayCondition4Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/engiesharkonewtired.png");
			...
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, LivingEntityRenderState state, float headYaw, float headPitch) {
				...
				double y = entity.getY();
				double z = entity.getZ();
				if (EngieSharkoTDisplayCondition5Procedure.execute(entity)) {
					VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(LAYER_TEXTURE));
