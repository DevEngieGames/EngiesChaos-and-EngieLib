...
public class MonstrosityDeathSharkoRenderer extends MobRenderer<MonstrosityDeathSharkoEntity, Modelboyo<MonstrosityDeathSharkoEntity>> {
	public MonstrosityDeathSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<MonstrosityDeathSharkoEntity, Modelboyo<MonstrosityDeathSharkoEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("engies_chaos:textures/entities/monstrositynew.png");
		...
		this.addLayer(new RenderLayer<MonstrosityDeathSharkoEntity, Modelboyo<MonstrosityDeathSharkoEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("engies_chaos:textures/entities/monstrositynewtired.png");
