...
public class InsanityEnragedEngieRenderer extends MobRenderer<InsanityEnragedEngieEntity, LivingEntityRenderState, Modelinsanityhostile> {
	private InsanityEnragedEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(InsanityEnragedEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/insanityenraged.png");
	}
