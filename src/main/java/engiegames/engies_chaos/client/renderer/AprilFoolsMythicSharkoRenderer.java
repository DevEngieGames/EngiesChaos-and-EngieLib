...
public class AprilFoolsMythicSharkoRenderer extends MobRenderer<AprilFoolsMythicSharkoEntity, LivingEntityRenderState, Modelboyoold> {
	private AprilFoolsMythicSharkoEntity entity = null;

	public AprilFoolsMythicSharkoRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelboyoold(context.bakeLayer(Modelboyoold.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyomy.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyomyt.png");
	...
	@Override
	public void extractRenderState(AprilFoolsMythicSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
