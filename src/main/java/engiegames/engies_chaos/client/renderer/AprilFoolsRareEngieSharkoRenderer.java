...
public class AprilFoolsRareEngieSharkoRenderer extends MobRenderer<AprilFoolsRareEngieSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private AprilFoolsRareEngieSharkoEntity entity = null;

	public AprilFoolsRareEngieSharkoRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelboyo(context.bakeLayer(Modelboyo.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/reboyo.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/reboyot.png");
	...
	@Override
	public void extractRenderState(AprilFoolsRareEngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
