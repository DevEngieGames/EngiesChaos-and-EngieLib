...
public class DoomsDayHostileRenderer extends MobRenderer<DoomsDayHostileEntity, LivingEntityRenderState, Modelhostileothers> {
	...
	public DoomsDayHostileRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/doomsdayarmorlayer1.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/doomsdayarmorlayer2.png");
	...
	@Override
	public void extractRenderState(DoomsDayHostileEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/doomsdaymob.png");
	}
