...
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayConditionProcedure;
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayCondition7Procedure;
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayCondition6Procedure;
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayCondition5Procedure;
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayCondition4Procedure;
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayCondition3Procedure;
import engiegames.engies_chaos.procedures.UncommonSharkoTDisplayCondition2Procedure;
import engiegames.engies_chaos.procedures.UncommonSharkoDisplayConditionProcedure;
...
public class UncommonSharkoRenderer extends MobRenderer<UncommonSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private UncommonSharkoEntity entity = null;

	public UncommonSharkoRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelboyo(context.bakeLayer(Modelboyo.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/uncommonsharkonew.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/uncommonsharkonewtired.png");
	...
	@Override
	public void extractRenderState(UncommonSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
