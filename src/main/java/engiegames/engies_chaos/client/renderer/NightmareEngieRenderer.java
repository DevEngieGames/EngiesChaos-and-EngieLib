...
public class NightmareEngieRenderer extends MobRenderer<NightmareEngieEntity, LivingEntityRenderState, Modelnightmarehostile> {
	private NightmareEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(NightmareEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/nightmareengie_new.png");
	}
