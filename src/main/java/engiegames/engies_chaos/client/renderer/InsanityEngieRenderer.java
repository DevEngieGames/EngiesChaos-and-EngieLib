...
public class InsanityEngieRenderer extends MobRenderer<InsanityEngieEntity, LivingEntityRenderState, Modelinsanityhostile> {
	private InsanityEngieEntity entity = null;
	...
	@Override
	public void extractRenderState(InsanityEngieEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/insanityengie.png");
	}
