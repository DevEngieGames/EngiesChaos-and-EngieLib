...
public class AprilFoolsAlbinoSharkoRenderer extends MobRenderer<AprilFoolsAlbinoSharkoEntity, LivingEntityRenderState, Modelboyoold> {
	private AprilFoolsAlbinoSharkoEntity entity = null;
	...
	public AprilFoolsAlbinoSharkoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyoa.png");
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/boyoat.png");
	...
	@Override
	public void extractRenderState(AprilFoolsAlbinoSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
