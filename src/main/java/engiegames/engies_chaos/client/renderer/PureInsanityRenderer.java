...
public class PureInsanityRenderer extends MobRenderer<PureInsanityEntity, LivingEntityRenderState, Modelinsanityhostile> {
	...
	public PureInsanityRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("engies_chaos:textures/entities/pureinsanity.png");
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("engies_chaos:textures/entities/pureinsanity.png");
	}
