...
import engiegames.engieschaos.procedures.InsanityHostileEngieSpawningConditionProcedure;
...
public class InsanityEnragedEngieEntity extends Monster {
	public InsanityEnragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.INSANITY_ENRAGED_ENGIE.get(), world);
	}

	public InsanityEnragedEngieEntity(EntityType<InsanityEnragedEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = InsanityEnragedEngieEntity.this.getX();
				double y = InsanityEnragedEngieEntity.this.getY();
				double z = InsanityEnragedEngieEntity.this.getZ();
				Entity entity = InsanityEnragedEngieEntity.this;
				Level world = InsanityEnragedEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.INSANITY_ENRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
