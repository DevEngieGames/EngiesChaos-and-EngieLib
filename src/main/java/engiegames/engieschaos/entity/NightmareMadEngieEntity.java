...
public class NightmareMadEngieEntity extends Monster {
	public NightmareMadEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.NIGHTMARE_MAD_ENGIE.get(), world);
	}

	public NightmareMadEngieEntity(EntityType<NightmareMadEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 10;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = NightmareMadEngieEntity.this.getX();
				double y = NightmareMadEngieEntity.this.getY();
				double z = NightmareMadEngieEntity.this.getZ();
				Entity entity = NightmareMadEngieEntity.this;
				Level world = NightmareMadEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.NIGHTMARE_MAD_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
