...
import engiegames.engieschaos.procedures.TheRealEngieGamesRightClickedOnEntityTradeProcedure;
import engiegames.engieschaos.procedures.TheRealEngieGamesOnInitialEntitySpawnProcedure;
...
public class ClippedbyengieEntity extends PathfinderMob {
	public ClippedbyengieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.CLIPPEDBYENGIE.get(), world);
	}

	public ClippedbyengieEntity(EntityType<ClippedbyengieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
