...
public class ThrowbackAngryCreatorEntity extends Monster {
	public ThrowbackAngryCreatorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.THROWBACK_ANGRY_CREATOR.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.THROWBACK_ANGRY_CREATOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
