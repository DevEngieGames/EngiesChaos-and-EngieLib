...
public class AprilFoolsEngieSharkoEntity extends TamableAnimal {
	public static final EntityDataAccessor<Boolean> DATA_laying = SynchedEntityData.defineId(AprilFoolsEngieSharkoEntity.class, EntityDataSerializers.BOOLEAN);

	public AprilFoolsEngieSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.APRIL_FOOLS_ENGIE_SHARKO.get(), world);
	}

	public AprilFoolsEngieSharkoEntity(EntityType<AprilFoolsEngieSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new OwnerHurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = AprilFoolsEngieSharkoEntity.this.getX();
				double y = AprilFoolsEngieSharkoEntity.this.getY();
				double z = AprilFoolsEngieSharkoEntity.this.getZ();
				Entity entity = AprilFoolsEngieSharkoEntity.this;
				Level world = AprilFoolsEngieSharkoEntity.this.level;
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AprilFoolsEngieSharkoEntity retval = EngiesChaosModEntities.APRIL_FOOLS_ENGIE_SHARKO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.APRIL_FOOLS_ENGIE_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
