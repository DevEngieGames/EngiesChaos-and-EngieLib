...
public class InsanityAngryEngieEntity extends Monster {
	public InsanityAngryEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.INSANITY_ANGRY_ENGIE.get(), world);
	}

	public InsanityAngryEngieEntity(EntityType<InsanityAngryEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 15;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = InsanityAngryEngieEntity.this.getX();
				double y = InsanityAngryEngieEntity.this.getY();
				double z = InsanityAngryEngieEntity.this.getZ();
				Entity entity = InsanityAngryEngieEntity.this;
				Level world = InsanityAngryEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.INSANITY_ANGRY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
