...
public class AngryCreatorEntity extends Monster {
	...
	public AngryCreatorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.OUTRAGED_ENGIE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.OUTRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
