...
public class EngiePocMadEngieEntity extends Monster {
	public EngiePocMadEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_POC_MAD_ENGIE.get(), world);
	}

	public EngiePocMadEngieEntity(EntityType<EngiePocMadEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 10;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngiePocMadEngieEntity.this.getX();
				double y = EngiePocMadEngieEntity.this.getY();
				double z = EngiePocMadEngieEntity.this.getZ();
				Entity entity = EngiePocMadEngieEntity.this;
				Level world = EngiePocMadEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_POC_MAD_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
