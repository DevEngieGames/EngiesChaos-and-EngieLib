...
import engiegames.engieschaos.procedures.RiftedEntitiesOnTickUpdateProcedure;
import engiegames.engieschaos.procedures.RiftBallPlayerCollidesWithThisEntityProcedure;
import engiegames.engieschaos.procedures.RiftBallOnInitialEntitySpawnProcedure;
import engiegames.engieschaos.procedures.ReturnRiftBallSizeProcedure;
...
public class RiftBallEntity extends PathfinderMob {
	...
	public RiftBallEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.RIFT_BALL.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_size, 3);
	}
	...
	public EntityDimensions getDimensions(Pose pose) {
		...
		double y = this.getY();
		double z = this.getZ();
		return super.getDimensions(pose).scale((float) ReturnRiftBallSizeProcedure.execute(entity));
	}
