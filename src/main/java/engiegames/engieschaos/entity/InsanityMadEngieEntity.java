...
public class InsanityMadEngieEntity extends Monster {
	public InsanityMadEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.INSANITY_MAD_ENGIE.get(), world);
	}

	public InsanityMadEngieEntity(EntityType<InsanityMadEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 10;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				...
				double y = InsanityMadEngieEntity.this.getY();
				double z = InsanityMadEngieEntity.this.getZ();
				Entity entity = InsanityMadEngieEntity.this;
				Level world = InsanityMadEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.INSANITY_MAD_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
