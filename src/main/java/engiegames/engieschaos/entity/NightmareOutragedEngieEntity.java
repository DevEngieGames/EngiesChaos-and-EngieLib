...
public class NightmareOutragedEngieEntity extends Monster {
	public NightmareOutragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.NIGHTMARE_OUTRAGED_ENGIE.get(), world);
	}

	public NightmareOutragedEngieEntity(EntityType<NightmareOutragedEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 35;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = NightmareOutragedEngieEntity.this.getX();
				double y = NightmareOutragedEngieEntity.this.getY();
				double z = NightmareOutragedEngieEntity.this.getZ();
				Entity entity = NightmareOutragedEngieEntity.this;
				Level world = NightmareOutragedEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.NIGHTMARE_OUTRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
