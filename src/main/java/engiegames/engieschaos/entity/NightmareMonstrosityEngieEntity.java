...
import engiegames.engieschaos.procedures.NightmareHostileEngieySpawningConditionProcedure;
...
public class NightmareMonstrosityEngieEntity extends Monster {
	public NightmareMonstrosityEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.NIGHTMARE_MONSTROSITY_ENGIE.get(), world);
	}

	public NightmareMonstrosityEngieEntity(EntityType<NightmareMonstrosityEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 55;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = NightmareMonstrosityEngieEntity.this.getX();
				double y = NightmareMonstrosityEngieEntity.this.getY();
				double z = NightmareMonstrosityEngieEntity.this.getZ();
				Entity entity = NightmareMonstrosityEngieEntity.this;
				Level world = NightmareMonstrosityEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.NIGHTMARE_MONSTROSITY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
