...
public class ThrowbackEnragedEngieEntity extends Monster {
	public ThrowbackEnragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.THROWBACK_ENRAGED_ENGIE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.THROWBACK_ENRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
