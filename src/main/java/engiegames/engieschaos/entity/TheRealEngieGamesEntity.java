...
import engiegames.engieschaos.procedures.TheRealEngieGamesOnEntityTickUpdateProcedure;
import engiegames.engieschaos.procedures.NPCNaturalEntitySpawningProcedure;
...
public class TheRealEngieGamesEntity extends PathfinderMob {
	public TheRealEngieGamesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.THE_REAL_ENGIE_GAMES.get(), world);
	}
