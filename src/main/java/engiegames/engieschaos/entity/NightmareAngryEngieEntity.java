...
public class NightmareAngryEngieEntity extends Monster {
	public NightmareAngryEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.NIGHTMARE_ANGRY_ENGIE.get(), world);
	}

	public NightmareAngryEngieEntity(EntityType<NightmareAngryEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 15;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = NightmareAngryEngieEntity.this.getX();
				double y = NightmareAngryEngieEntity.this.getY();
				double z = NightmareAngryEngieEntity.this.getZ();
				Entity entity = NightmareAngryEngieEntity.this;
				Level world = NightmareAngryEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.NIGHTMARE_ANGRY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
