...
public class AprilFoolsSharkoEntity extends TamableAnimal {
	public static final EntityDataAccessor<Boolean> DATA_laying = SynchedEntityData.defineId(AprilFoolsSharkoEntity.class, EntityDataSerializers.BOOLEAN);

	public AprilFoolsSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.APRIL_FOOLS_SHARKO.get(), world);
	}

	public AprilFoolsSharkoEntity(EntityType<AprilFoolsSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new OwnerHurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = AprilFoolsSharkoEntity.this.getX();
				double y = AprilFoolsSharkoEntity.this.getY();
				double z = AprilFoolsSharkoEntity.this.getZ();
				Entity entity = AprilFoolsSharkoEntity.this;
				Level world = AprilFoolsSharkoEntity.this.level;
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AprilFoolsSharkoEntity retval = EngiesChaosModEntities.APRIL_FOOLS_SHARKO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.APRIL_FOOLS_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
