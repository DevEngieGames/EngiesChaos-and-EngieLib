...
import engiegames.engieschaos.procedures.BiblicallyAccurateEngieThisEntityKillsAnotherOneProcedure;
import engiegames.engieschaos.procedures.BiblicallyAccurateEngieOnInitialEntitySpawnProcedure;
import engiegames.engieschaos.procedures.BiblicallyAccurateEngieNaturalEntitySpawningConditionProcedure;
...
public class BiblicallyAccurateEngieEntity extends PathfinderMob {
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.BIBLICALLY_ACCURATE_ENGIE.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
