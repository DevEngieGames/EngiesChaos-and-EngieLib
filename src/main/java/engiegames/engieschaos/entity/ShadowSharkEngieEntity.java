...
import engiegames.engieschaos.procedures.ShadowSharkEngieOnInitialEntitySpawnProcedure;
import engiegames.engieschaos.procedures.ShadowSharkEngieOnEntityTickUpdateProcedure;
...
public class ShadowSharkEngieEntity extends PathfinderMob {
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.SHADOW_SHARK_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
