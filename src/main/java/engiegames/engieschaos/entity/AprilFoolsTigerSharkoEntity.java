...
public class AprilFoolsTigerSharkoEntity extends TamableAnimal {
	public static final EntityDataAccessor<Boolean> DATA_laying = SynchedEntityData.defineId(AprilFoolsTigerSharkoEntity.class, EntityDataSerializers.BOOLEAN);

	public AprilFoolsTigerSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.APRIL_FOOLS_TIGER_SHARKO.get(), world);
	}

	public AprilFoolsTigerSharkoEntity(EntityType<AprilFoolsTigerSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new OwnerHurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = AprilFoolsTigerSharkoEntity.this.getX();
				double y = AprilFoolsTigerSharkoEntity.this.getY();
				double z = AprilFoolsTigerSharkoEntity.this.getZ();
				Entity entity = AprilFoolsTigerSharkoEntity.this;
				Level world = AprilFoolsTigerSharkoEntity.this.level;
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AprilFoolsTigerSharkoEntity retval = EngiesChaosModEntities.APRIL_FOOLS_TIGER_SHARKO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.APRIL_FOOLS_TIGER_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
