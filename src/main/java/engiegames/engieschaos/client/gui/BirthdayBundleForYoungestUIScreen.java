...
import engiegames.engieschaos.procedures.BirthdayBundleForYoungestNameCheckProcedure;
import engiegames.engieschaos.network.BirthdayBundleForYoungestUIButtonMessage;
...
public class BirthdayBundleForYoungestUIScreen extends AbstractContainerScreen<BirthdayBundleForYoungestUIMenu> implements EngiesChaosModScreens.ScreenAccessor {
	...
	public void init() {
		super.init();
		ChangeBundleName = new EditBox(this.font, this.leftPos + 6, this.topPos + 6, 118, 18, Component.translatable("gui.engies_chaos.birthday_bundle_for_youngest_ui.ChangeBundleName"));
