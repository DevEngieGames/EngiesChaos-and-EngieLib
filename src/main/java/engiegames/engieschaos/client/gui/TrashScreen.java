...
import engiegames.engieschaos.network.TrashButtonMessage;
...
public class TrashScreen extends AbstractContainerScreen<TrashMenu> implements EngiesChaosModScreens.ScreenAccessor {
	...
	Button button_delete_the_items;

	public TrashScreen(TrashMenu container, Inventory inventory, Component text) {
