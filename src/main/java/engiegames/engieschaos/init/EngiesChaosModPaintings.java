...
public class EngiesChaosModPaintings {
	public static final DeferredRegister<PaintingVariant> REGISTRY = DeferredRegister.create(ForgeRegistries.PAINTING_VARIANTS, EngiesChaosMod.MODID);
	...
	public static final RegistryObject<PaintingVariant> THANKS_WORMHOLE = REGISTRY.register("thanks_wormhole", () -> new PaintingVariant(16, 16));
	public static final RegistryObject<PaintingVariant> ENGIESCHAOS = REGISTRY.register("engieschaos", () -> new PaintingVariant(16, 16));
	public static final RegistryObject<PaintingVariant> SUPER_DOOMSDAY_FARM_SQUARE_1 = REGISTRY.register("super_doomsday_farm_square_1", () -> new PaintingVariant(16, 16));
	public static final RegistryObject<PaintingVariant> SUPER_DOOMSDAY_FARM_SQUARE_2 = REGISTRY.register("super_doomsday_farm_square_2", () -> new PaintingVariant(32, 32));
	public static final RegistryObject<PaintingVariant> SUPER_DOOMSDAY_FARM_WIDE_1 = REGISTRY.register("super_doomsday_farm_wide_1", () -> new PaintingVariant(32, 16));
	public static final RegistryObject<PaintingVariant> SUPER_DOOMSDAY_FARM_WIDE_2 = REGISTRY.register("super_doomsday_farm_wide_2", () -> new PaintingVariant(64, 32));
	public static final RegistryObject<PaintingVariant> FATALERROR = REGISTRY.register("fatalerror", () -> new PaintingVariant(16, 16));
	public static final RegistryObject<PaintingVariant> LOCK_IN = REGISTRY.register("lock_in", () -> new PaintingVariant(16, 16));
	public static final RegistryObject<PaintingVariant> REAAE_BANNER = REGISTRY.register("reaae_banner", () -> new PaintingVariant(32, 16));
}