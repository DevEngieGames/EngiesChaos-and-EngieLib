...
public class MonstrosityEngieStyle1Procedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return false;
		if ((entity instanceof MonstrosityEngieEntity _datEntI ? _datEntI.getEntityData().get(MonstrosityEngieEntity.DATA_style) : 0) == 1
