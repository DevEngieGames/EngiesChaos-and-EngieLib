...
public class CosmicDeathSharkoTDisplayCondition6Procedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof CosmicDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(CosmicDeathSharkoEntity.DATA_SharkoState) : 0) == 2
				&& (entity instanceof CosmicDeathSharkoEntity _datEntL2 && _datEntL2.getEntityData().get(CosmicDeathSharkoEntity.DATA_AlternateState)) == true) {
			return true;
		}
		return false;
	}
