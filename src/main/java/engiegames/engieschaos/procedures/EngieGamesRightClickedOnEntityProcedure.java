	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.DETECTIVE_MODE) == true) {
			if ((entity instanceof ServerPlayer _plr1 && _plr1.level instanceof ServerLevel
					&& _plr1.getAdvancements().getOrStartProgress(_plr1.server.getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:found_engie"))).isDone()) == false) {
				if (entity instanceof ServerPlayer _player) {
					Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("engies_chaos:found_engie"));
							...
							EngiesChaosMod.queueServerWork(200, () -> {
								...
								EngiesChaosMod.queueServerWork(160, () -> {
									...
									EngiesChaosMod.queueServerWork(220, () -> {
										...
										world.getLevelData().getGameRules().getRule(EngiesChaosModGameRules.DETECTIVE_MODE).set(false, world.getServer());
										{
											Entity _ent = entity;
											if (!_ent.level.isClientSide() && _ent.getServer() != null) {
