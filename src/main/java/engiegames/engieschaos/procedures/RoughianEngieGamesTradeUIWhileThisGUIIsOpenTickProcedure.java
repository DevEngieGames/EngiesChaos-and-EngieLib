...
public class RoughianEngieGamesTradeUIWhileThisGUIIsOpenTickProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (getAmountInGUISlot(entity, 1) >= 64 && getAmountInGUISlot(entity, 2) >= 64 && getAmountInGUISlot(entity, 0) >= 64) {
			...
			(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu6 ? _menu6.getSlots().get(3).getItem() : ItemStack.EMPTY).enchant(EngiesChaosModEnchantments.ENGIES_BLESSING.get(), 10);
