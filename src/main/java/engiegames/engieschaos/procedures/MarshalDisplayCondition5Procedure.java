...
public class MarshalDisplayCondition5Procedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity.getDisplayName().getString()).equals("Marshal") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
