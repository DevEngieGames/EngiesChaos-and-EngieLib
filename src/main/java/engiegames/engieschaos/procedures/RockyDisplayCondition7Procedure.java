...
public class RockyDisplayCondition7Procedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity.getDisplayName().getString()).equals("Rocky") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
