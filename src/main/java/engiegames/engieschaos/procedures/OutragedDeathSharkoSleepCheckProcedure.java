...
public class OutragedDeathSharkoSleepCheckProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof OutragedDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(OutragedDeathSharkoEntity.DATA_SharkoState) : 0) == 4) {
			return false;
		} else if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof OutragedDeathSharkoEntity _datEntI ? _datEntI.getEntityData().get(OutragedDeathSharkoEntity.DATA_SharkoState) : 0) != 4) {
			return true;
		}
		return false;
	}
