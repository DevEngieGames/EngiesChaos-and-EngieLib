...
public class ChampDisplayCondition3Procedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity.getDisplayName().getString()).equals("Champ") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
