...
public class AntimatterEngieGamesTradeUIButtonClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(3).getItem() : ItemStack.EMPTY)
				.getItem() == EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_CRUCIFIX.get()) {
		...
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu13 ? _menu13.getSlots().get(3).getItem() : ItemStack.EMPTY)
				.getItem() == EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_SWORD.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
		...
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu21 ? _menu21.getSlots().get(3).getItem() : ItemStack.EMPTY)
				.getItem() == EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_PICKAXE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				.getItem() == EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_AXE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				.getItem() == EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_SHOVEL.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
		...
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu45 ? _menu45.getSlots().get(3).getItem() : ItemStack.EMPTY)
				.getItem() == EngiesChaosModItems.ANTIMATTER_ENGIE_GAMES_HOE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				.getItem() == EngiesChaosModItems.ANTIMATTER_THE_REAL_ENGIE_GAMESS_HELMET.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				.getItem() == EngiesChaosModItems.ANTIMATTER_THE_REAL_ENGIE_GAMESS_CHESTPLATE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				.getItem() == EngiesChaosModItems.ANTIMATTER_THE_REAL_ENGIE_GAMESS_LEGGINGS.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			EngiesChaosMod.queueServerWork(1, () -> {
				...
				.getItem() == EngiesChaosModItems.ANTIMATTER_THE_REAL_ENGIE_GAMESS_BOOTS.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof EngiesChaosModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
