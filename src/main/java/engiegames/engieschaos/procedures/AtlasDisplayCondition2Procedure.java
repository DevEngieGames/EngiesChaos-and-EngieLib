...
public class AtlasDisplayCondition2Procedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		if ((entity.getDisplayName().getString()).equals("Atlas") && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
