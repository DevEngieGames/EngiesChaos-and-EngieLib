...
public class ChallengeChaosProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		} else if (EngiesChaosModVariables.MapVariables.get(world).ChallengeToggle == true && ModList.get().isLoaded("weather2") == true) {
			{
				Entity _ent = entity;
				if (!_ent.level.isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
		...
		} else if (EngiesChaosModVariables.MapVariables.get(world).ChallengeToggle == true && ModList.get().isLoaded("enhancedcelestials") == true) {
			if (EngiesChaosModVariables.MapVariables.get(world).BYEBYE == true) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
