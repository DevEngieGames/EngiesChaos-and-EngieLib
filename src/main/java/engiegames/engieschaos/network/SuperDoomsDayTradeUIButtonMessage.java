...
import engiegames.engieschaos.procedures.SuperDDayTradeButtonClickedProcedure;
import engiegames.engieschaos.procedures.SDDaySwapToAntimatterProcedure;
...
public class SuperDoomsDayTradeUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(SuperDoomsDayTradeUIButtonMessage.class, SuperDoomsDayTradeUIButtonMessage::buffer, SuperDoomsDayTradeUIButtonMessage::new, SuperDoomsDayTradeUIButtonMessage::handler);
	}
}