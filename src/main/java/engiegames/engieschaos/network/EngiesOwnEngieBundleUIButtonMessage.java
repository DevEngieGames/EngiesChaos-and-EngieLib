...
import engiegames.engieschaos.procedures.EngiesOwnEngieBundleNameChangeProcedure;
...
public class EngiesOwnEngieBundleUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(EngiesOwnEngieBundleUIButtonMessage.class, EngiesOwnEngieBundleUIButtonMessage::buffer, EngiesOwnEngieBundleUIButtonMessage::new, EngiesOwnEngieBundleUIButtonMessage::handler);
	}
}