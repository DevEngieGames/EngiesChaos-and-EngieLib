...
import engiegames.engieschaos.procedures.EnragedEngieBundleNameChangeProcedure;
...
public class EnragedEngieBundleUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EngiesChaosMod.addNetworkMessage(EnragedEngieBundleUIButtonMessage.class, EnragedEngieBundleUIButtonMessage::buffer, EnragedEngieBundleUIButtonMessage::new, EnragedEngieBundleUIButtonMessage::handler);
	}
}