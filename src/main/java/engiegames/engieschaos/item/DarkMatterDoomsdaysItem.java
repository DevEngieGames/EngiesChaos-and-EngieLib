...
public abstract class DarkMatterDoomsdaysItem extends ArmorItem {
	public DarkMatterDoomsdaysItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 850;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{850, 850, 850, 850}[slot.getIndex()];
			}
	...
	public static class Helmet extends DarkMatterDoomsdaysItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmatterdoomsdayarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends DarkMatterDoomsdaysItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmatterdoomsdayarmorlayer2.png";
		}
	}
