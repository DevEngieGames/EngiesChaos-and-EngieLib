...
public abstract class DarkMatterSuperDoomsdaysItem extends ArmorItem {
	public DarkMatterSuperDoomsdaysItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "dark_matter_super_doomsdays";
			}
	...
	public static class Helmet extends DarkMatterSuperDoomsdaysItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmattersuperdoomsdayarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends DarkMatterSuperDoomsdaysItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmattersuperdoomsdayarmorlayer2.png";
		}
	}
