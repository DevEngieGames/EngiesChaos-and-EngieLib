...
public abstract class XEngieItem extends ArmorItem {
	...
	public static class Helmet extends XEngieItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.engies_chaos.x_engie_helmet.description_0"));
			list.add(Component.translatable("item.engies_chaos.x_engie_helmet.description_1"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/xengiearmor.png";
		}
	}
	...
	public static class Chestplate extends XEngieItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.engies_chaos.x_engie_chestplate.description_0"));
			list.add(Component.translatable("item.engies_chaos.x_engie_chestplate.description_1"));
		}
	...
	public static class Leggings extends XEngieItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.engies_chaos.x_engie_leggings.description_0"));
			list.add(Component.translatable("item.engies_chaos.x_engie_leggings.description_1"));
		}
	...
	public static class Boots extends XEngieItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.engies_chaos.x_engie_boots.description_0"));
			list.add(Component.translatable("item.engies_chaos.x_engie_boots.description_1"));
		}
