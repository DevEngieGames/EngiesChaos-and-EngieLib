...
public abstract class HostileEngiesItem extends ArmorItem {
	public HostileEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{175, 175, 175, 175}[slot.getIndex()];
			}
	...
	public static class Helmet extends HostileEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/hostileengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends HostileEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/hostileengie_layer_2.png";
		}
	}
