...
public abstract class DarkMatterTheRealEngieGamessItem extends ArmorItem {
	public DarkMatterTheRealEngieGamessItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "dark_matter_the_real_engie_gamess";
			}
	...
	public static class Helmet extends DarkMatterTheRealEngieGamessItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmattertherealengiegamesarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends DarkMatterTheRealEngieGamessItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmattertherealengiegamesarmorlayer2.png";
		}
	}
