...
import engiegames.engieschaos.procedures.BAEChestplateProcedure;
import engiegames.engieschaos.init.EngiesChaosModTabs;
import engiegames.engieschaos.init.EngiesChaosModItems;

public abstract class DarkMatterBiblicallyAccurateEngiesItem extends ArmorItem {
	public DarkMatterBiblicallyAccurateEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "dark_matter_biblically_accurate_engies";
			}
	...
	public static class Helmet extends DarkMatterBiblicallyAccurateEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/darkmatterbiblicallyaccurateengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends DarkMatterBiblicallyAccurateEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/darkmatterbiblicallyaccurateengie_layer_2.png";
		}
	}
