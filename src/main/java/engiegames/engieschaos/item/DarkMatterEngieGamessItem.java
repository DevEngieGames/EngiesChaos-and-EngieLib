...
public abstract class DarkMatterEngieGamessItem extends ArmorItem {
	public DarkMatterEngieGamessItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 925;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{925, 925, 925, 925}[slot.getIndex()];
			}
			...
			public String getName() {
				return "dark_matter_engie_gamess";
			}
	...
	public static class Helmet extends DarkMatterEngieGamessItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmatterengiegamesarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends DarkMatterEngieGamessItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/entities/darkmatterengiegamesarmorlayer2.png";
		}
	}
