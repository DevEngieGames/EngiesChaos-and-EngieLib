...
public abstract class AntimatterHostileEngiesItem extends ArmorItem {
	public AntimatterHostileEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 475;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{475, 475, 475, 475}[slot.getIndex()];
			}
			...
			public String getName() {
				return "antimatter_hostile_engies";
			}
	...
	public static class Helmet extends AntimatterHostileEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/antimatterhostileengie_layer_1.png";
		}
	}
	...
	public static class Leggings extends AntimatterHostileEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "engies_chaos:textures/models/armor/antimatterhostileengie_layer_2.png";
		}
	}
