...
public class EngiesBirthdayBundleUIMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public EngiesBirthdayBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.ENGIES_BIRTHDAY_BUNDLE_UI.get(), id);
