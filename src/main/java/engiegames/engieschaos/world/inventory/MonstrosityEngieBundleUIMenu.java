...
public class MonstrosityEngieBundleUIMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public MonstrosityEngieBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.MONSTROSITY_ENGIE_BUNDLE_UI.get(), id);
