...
public class ETCEngieBundleUIMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public ETCEngieBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.ETC_ENGIE_BUNDLE_UI.get(), id);
