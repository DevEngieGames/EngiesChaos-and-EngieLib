...
import engiegames.engieschaos.procedures.RoughianEngieGamesTradeUIWhileThisGUIIsOpenTickProcedure;
	...
	public RoughianEngieGamesTradeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 80, 8) {
			...
			public boolean mayPlace(ItemStack stack) {
				return EngiesChaosModBlocks.ENGIE_GAMES_TESSERACT_BLOCK.get().asItem() == stack.getItem();
			}
		}));
