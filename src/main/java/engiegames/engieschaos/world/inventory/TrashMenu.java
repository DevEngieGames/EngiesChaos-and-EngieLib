...
public class TrashMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public TrashMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.TRASH.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 8, 8) {
			...
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		...
		this.customSlots.put(27, this.addSlot(new SlotItemHandler(internal, 27, 8, 62) {
			private final int slot = 27;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(28, this.addSlot(new SlotItemHandler(internal, 28, 26, 62) {
			private final int slot = 28;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(29, this.addSlot(new SlotItemHandler(internal, 29, 44, 62) {
			private final int slot = 29;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(30, this.addSlot(new SlotItemHandler(internal, 30, 62, 62) {
			private final int slot = 30;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(31, this.addSlot(new SlotItemHandler(internal, 31, 80, 62) {
			private final int slot = 31;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(32, this.addSlot(new SlotItemHandler(internal, 32, 98, 62) {
			private final int slot = 32;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(33, this.addSlot(new SlotItemHandler(internal, 33, 116, 62) {
			private final int slot = 33;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(34, this.addSlot(new SlotItemHandler(internal, 34, 134, 62) {
			private final int slot = 34;
			private int x = TrashMenu.this.x;
			private int y = TrashMenu.this.y;
		}));
		this.customSlots.put(35, this.addSlot(new SlotItemHandler(internal, 35, 152, 62) {
