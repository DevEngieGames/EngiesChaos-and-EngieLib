...
public class EnragedEngieBundleUIMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public EnragedEngieBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.ENRAGED_ENGIE_BUNDLE_UI.get(), id);
