...
public class EngiesOwnEngieBundleUIMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public EngiesOwnEngieBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EngiesChaosModMenus.ENGIES_OWN_ENGIE_BUNDLE_UI.get(), id);
