...
import engiegames.engieschaos.procedures.CosmicEngieGamesTradeUIWhileThisGUIIsOpenTickProcedure;
...
public class CosmicEngieGamesTradeUIMenu extends AbstractContainerMenu implements EngiesChaosModMenus.MenuAccessor {
	...
	public CosmicEngieGamesTradeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 80, 8) {
			...
			public boolean mayPlace(ItemStack stack) {
				return EngiesChaosModBlocks.COSMIC_ENGIE_GAMES_COIN_BLOCK.get().asItem() == stack.getItem();
			}
		}));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CosmicEngieGamesTradeUIMenu menu) {
