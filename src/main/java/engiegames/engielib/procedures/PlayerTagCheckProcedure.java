...
public class PlayerTagCheckProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (ModList.get().isLoaded("engies_chaos")) {
			...
			}.UUIDSafeParse("0b2e6bf5-1776-4c90-a079-7cd0addc1320"))) {
			...
			}.UUIDSafeParse("797281dfd9d54be29a566f69e0bd189a")) || entity.getUUID().equals(new Object() {
				UUID UUIDSafeParse(String s) {
					try {
						return UUID.fromString(s);
					} catch (Exception e) {
			...
			}.UUIDSafeParse("797281df-d9d5-4be2-9a56-6f69e0bd189a"))) {
			...
			}.UUIDSafeParse("3d64b3baca8d4771a98efc748a27d9c9")) || entity.getUUID().equals(new Object() {
				UUID UUIDSafeParse(String s) {
					try {
						return UUID.fromString(s);
					} catch (Exception e) {
			...
			}.UUIDSafeParse("3d64b3ba-ca8d-4771-a98e-fc748a27d9c9"))) {
				if (entity.getPersistentData().getBoolean("EngiesChaos_Contributor") == false) {
					entity.getPersistentData().putBoolean("EngiesChaos_Contributor", true);
				}
			} else if (entity.getUUID().equals(new Object() {
			...
			}.UUIDSafeParse("253d8148104445bf92514dcd9fdf3f96")) || entity.getUUID().equals(new Object() {
				UUID UUIDSafeParse(String s) {
					try {
						return UUID.fromString(s);
					} catch (Exception e) {
			...
			}.UUIDSafeParse("253d8148-1044-45bf-9251-4dcd9fdf3f96"))) {
				if (entity.getPersistentData().getBoolean("EngiesChaos_Contributor") == false) {
					entity.getPersistentData().putBoolean("EngiesChaos_Contributor", true);
				}
			} else if (entity.getUUID().equals(new Object() {
			...
			}.UUIDSafeParse("2f7e986199864618a0495f65c6c3dd0f")) || entity.getUUID().equals(new Object() {
				UUID UUIDSafeParse(String s) {
					try {
						return UUID.fromString(s);
					} catch (Exception e) {
			...
			}.UUIDSafeParse("2f7e9861-9986-4618-a049-5f65c6c3dd0f"))) {
			...
			}.UUIDSafeParse("29930f5dd23e47b6aad6e04406663341")) || entity.getUUID().equals(new Object() {
				UUID UUIDSafeParse(String s) {
					try {
						return UUID.fromString(s);
					} catch (Exception e) {
