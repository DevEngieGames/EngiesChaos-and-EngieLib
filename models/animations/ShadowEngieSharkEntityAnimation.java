...
public class ShadowEngieSharkEntityAnimation {
	public static final AnimationDefinition ShadowEngieSharkIdle = AnimationDefinition.Builder.withLength(10.0F)
			.looping()
			.addAnimation("Head",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							...
							new Keyframe(5.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.CATMULLROM),
							new Keyframe(10.0F, KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.CATMULLROM)))
			.addAnimation("Head",
