...
public class Modellouisandotherlayonside<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "louisandotherlayonside"), "main");
	...
	public Modellouisandotherlayonside(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition UpperLeg_r1 = RightFrontUpperLeg.addOrReplaceChild("UpperLeg_r1",
				CubeListBuilder.create().texOffs(80, 46)
						.addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)).texOffs(56, 0)
