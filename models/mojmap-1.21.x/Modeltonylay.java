...
public class Modeltonylay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tonylay"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftBackLeg = Tony.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.8F, -7.0F, 5.775F, 0.0F, -0.4363F, 0.0F));
		...
		PartDefinition RightBackLeg = Tony.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.0F, -7.0F, 5.775F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition LeftFrontLeg = Tony.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.8F, -7.0F, -6.225F, 0.0F, -0.4363F, 0.0F));
		...
		PartDefinition RightFrontLeg = Tony.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.0F, -7.0F, -6.225F, 0.0F, 0.4363F, 0.0F));
