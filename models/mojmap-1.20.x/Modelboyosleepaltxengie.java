...
public class Modelboyosleepaltxengie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyosleepaltxengie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Crown = Head.addOrReplaceChild("Crown",
				CubeListBuilder.create().texOffs(83, 60)
						.addBox(-0.9977F, -1.05F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 60)
						.addBox(-4.9977F, 0.95F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 60)
						.addBox(-4.9977F, 0.95F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(4.0023F, 0.95F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(-4.9977F, 0.95F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(4.0023F, -0.05F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-4.9977F, -0.05F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(-4.9977F, -0.05F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-4.9977F, -0.05F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-0.9977F, -1.05F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 54)
						.addBox(-0.9977F, -0.05F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 56)
						.addBox(-4.9977F, -0.05F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 54)
						.addBox(3.0023F, -0.05F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 58)
						.addBox(-0.9977F, -0.05F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 58)
						.addBox(-4.9977F, -0.05F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 56)
						.addBox(3.0023F, -0.05F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-4.9977F, -1.05F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 54)
						.addBox(-5.2477F, -0.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 54)
						.addBox(-5.2477F, -0.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 54)
						.addBox(-5.2477F, -0.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 57)
						.addBox(4.2273F, -0.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 57)
						.addBox(4.2273F, -0.05F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 57)
						.addBox(4.2273F, -0.05F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.05F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0023F, -1.05F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0023F, -1.05F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-4.9977F, -1.05F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)),
		...
		PartDefinition base = tail.addOrReplaceChild("base", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -19.85F, -22.95F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition tip = mid2a.addOrReplaceChild("tip",
				CubeListBuilder.create().texOffs(86, 33).addBox(-1.1F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.025F)),
		...
		PartDefinition RightFrontUpperLeg = RightFrontLeg.addOrReplaceChild("RightFrontUpperLeg",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -1.358F, 0.0175F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition RightFrontLowerLeg = RightFrontMidLeg.addOrReplaceChild("RightFrontLowerLeg",
				CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 1.535F, 2.3715F, 0.4363F, 0.0F, 0.0F));
		...
		PartDefinition LeftFrontUpperLeg = LeftFrontLeg.addOrReplaceChild("LeftFrontUpperLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -1.358F, 0.0175F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackLowerLeg = LeftBackMidLeg.addOrReplaceChild("LeftBackLowerLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-0.005F, 1.535F, 2.3715F, 0.4363F, 0.0F, 0.0F));
