...
public class Modelboyositxengie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyositxengie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Crown = Head.addOrReplaceChild("Crown",
				CubeListBuilder.create().texOffs(38, 60)
						...
						.addBox(-4.9977F, 0.75F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(4.0023F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(-4.9977F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(4.0023F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-4.9977F, -0.25F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(-4.9977F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-4.9977F, -0.25F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-0.9977F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 54)
						.addBox(-0.9977F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 56)
						.addBox(-4.9977F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 54)
						.addBox(3.0023F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 58)
						.addBox(-0.9977F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 58)
						.addBox(-4.9977F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 56)
						.addBox(3.0023F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-4.9977F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0023F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 54)
						.addBox(-5.2477F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 54)
						.addBox(-5.2477F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 54)
						.addBox(-5.2477F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 57)
						.addBox(4.2273F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 57)
						.addBox(4.2273F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 57)
						.addBox(4.2273F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-4.9977F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0023F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0023F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-4.9977F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
		...
		PartDefinition tip = mid2a.addOrReplaceChild("tip",
				CubeListBuilder.create().texOffs(85, 28).addBox(-1.125F, -0.8726F, -0.0037F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.1745F, 0.0F, 0.0F));

		PartDefinition tip2 = tip.addOrReplaceChild("tip2",
				CubeListBuilder.create().texOffs(86, 33).addBox(-1.125F, -0.8732F, -0.004F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
