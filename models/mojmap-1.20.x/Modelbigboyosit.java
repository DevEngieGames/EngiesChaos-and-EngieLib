	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = Head.addOrReplaceChild("Hat",
				CubeListBuilder.create().texOffs(0, 58)
						.addBox(-6.5F, 2.6176F, -6.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 58)
						.addBox(-6.0F, 1.8926F, -6.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = Collar.addOrReplaceChild("cube_r14",
		...
		PartDefinition cube_r16 = Bell.addOrReplaceChild("cube_r16",
		...
		PartDefinition cube_r17 = Bell.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(22, 40).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.075F)),
		...
		PartDefinition cube_r19 = Fin.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(44, 31).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.4875F, 0.0F, 0.0F, 0.0F, -0.4363F, 0.0F));

		PartDefinition cube_r20 = Fin.addOrReplaceChild("cube_r20",
