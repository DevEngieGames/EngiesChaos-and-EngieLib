...
public class Modelnightmaremon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "nightmaremon"), "main");
	...
	public Modelnightmaremon(ModelPart root) {
		...
		this.RightArm3 = this.bone.getChild("RightArm3");
		this.LeftArm = this.bone.getChild("LeftArm");
		this.LeftArm2 = this.bone.getChild("LeftArm2");
		this.LeftArm3 = this.bone.getChild("LeftArm3");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = bone.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(32, 0)
				...
				.mirror(false).texOffs(0, 71).addBox(-4.025F, -1.6F, -4.025F, 8.05F, 1.525F, 8.05F,
						new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Lh2_r1 = Head.addOrReplaceChild("Lh2_r1",
				CubeListBuilder.create().texOffs(0, 41)
						.addBox(4.025F, 0.325F, -2.0F, 1.3F, 4.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(12, 35)
						...
						.addBox(4.025F, 0.325F, -2.5F, 0.8F, 4.0F, 5.0F, new CubeDeformation(0.025F)).texOffs(12, 35)
						.addBox(-5.475F, 1.125F, -1.2F, 1.4F, 2.4F, 2.4F, new CubeDeformation(0.025F)).texOffs(0, 41)
		...
		PartDefinition RightArm2 = bone.addOrReplaceChild("RightArm2",
				CubeListBuilder.create().texOffs(80, 16)
						.addBox(-4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 32)
						.addBox(-4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(-4.0F, 2.0F, 0.0F, 0.2182F, 0.0F, 0.2182F));

		PartDefinition RightArm3 = bone.addOrReplaceChild("RightArm3",
				CubeListBuilder.create().texOffs(80, 16)
						.addBox(-4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 32)
						.addBox(-4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(-4.0F, 2.0F, 0.0F, -0.2132F, -0.0469F, -0.2132F));
		...
		PartDefinition LeftArm3 = bone.addOrReplaceChild("LeftArm3",
				CubeListBuilder.create().texOffs(64, 48)
						.addBox(0.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 48)
						.addBox(0.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(4.0F, 2.0F, 0.0F, -0.2132F, 0.0469F, 0.2132F));
