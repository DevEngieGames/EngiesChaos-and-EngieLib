...
public class Modelbigboyolayonside<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bigboyolayonside"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = Head.addOrReplaceChild("Hat",
				CubeListBuilder.create().texOffs(0, 58)
						.addBox(-6.5F, 2.8926F, -6.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 58)
						.addBox(-6.0F, 2.1677F, -6.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
