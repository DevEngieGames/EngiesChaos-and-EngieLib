...
public class Modelboyolayxengie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyolayxengie"), "main");
	...
	private final ModelPart LeftFrontUpperLeg3;
	private final ModelPart LeftFrontMidLeg3;
	private final ModelPart LeftFrontLowerLeg3;
	private final ModelPart LeftFrontFoot3;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = Head.addOrReplaceChild("Hat",
				CubeListBuilder.create().texOffs(0, 59)
						.addBox(-7.0F, -3.3824F, -7.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 62)
						.addBox(-6.0F, -3.8824F, -6.0F, 12.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 65)
						.addBox(-4.0F, -4.8824F, -4.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 68)
						.addBox(-2.0F, -5.8824F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = Hat.addOrReplaceChild("cube_r2",
				...
				PartPose.offsetAndRotation(0.0F, -4.3824F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition Crown = Head.addOrReplaceChild("Crown",
				CubeListBuilder.create().texOffs(38, 60)
						...
						.addBox(-5.0F, 0.75F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(4.0F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(38, 51)
						.addBox(-5.0F, 0.75F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(4.0F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-5.0F, -0.25F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(60, 51)
						.addBox(-5.0F, -0.25F, -5.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.001F)).texOffs(60, 60)
						.addBox(-5.0F, -0.25F, -5.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-1.0F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 54)
						.addBox(-1.0F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 56)
						.addBox(-5.0F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 54)
						.addBox(3.0F, -0.25F, -5.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(78, 58)
						.addBox(-1.0F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 58)
						.addBox(-5.0F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(72, 56)
						.addBox(3.0F, -0.25F, 4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(-5.0F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-5.0F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0F, -1.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-5.0F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0F, -1.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(4.0F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 54)
						.addBox(-5.25F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 54)
						.addBox(-5.25F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 54)
						.addBox(-5.25F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(64, 57)
						.addBox(4.225F, -0.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(58, 57)
						.addBox(4.225F, -0.25F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(52, 57)
						.addBox(4.225F, -0.25F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(82, 59)
						.addBox(-5.0F, -1.25F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0F, -1.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
						.addBox(3.0F, -1.25F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(83, 60)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-5.1F, 0.025F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(60, 72)
						.addBox(-5.1F, 0.025F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.275F)),
		...
		PartDefinition Fin = Body.addOrReplaceChild("Fin", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-0.0269F, 8.2102F, 4.336F, -2.618F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Fin.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(44, 31).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.4875F, 0.0F, 0.0F, 0.0F, -0.4363F, 0.0F));

		PartDefinition cube_r9 = Fin.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(44, 31).mirror()
						.addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(-0.4875F, 0.0F, 0.0F, 0.0F, 0.4363F, 0.0F));

		PartDefinition Collar = Body.addOrReplaceChild("Collar", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -0.0502F, 2.0579F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = Collar.addOrReplaceChild("cube_r11",
		...
		PartDefinition cube_r12 = Collar.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 40).addBox(-5.0F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F,
						new CubeDeformation(0.05F)),
		...
		PartDefinition cube_r14 = Bell.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(22, 40).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.075F)),
				PartPose.offsetAndRotation(-1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r15 = Bell.addOrReplaceChild("cube_r15",
		...
		PartDefinition tail = Body.addOrReplaceChild("tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.15F, 35.2F, -18.975F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition tip = mid2a.addOrReplaceChild("tip",
				CubeListBuilder.create().texOffs(85, 28).addBox(-1.125F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.025F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.1745F, 0.0F, 0.0F));

		PartDefinition tip2 = tip.addOrReplaceChild("tip2",
				CubeListBuilder.create().texOffs(86, 33).addBox(-1.125F, -0.875F, 0.0F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightFrontLeg = partdefinition.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1F, 17.0F, -5.225F, 0.0F, 0.4363F, 0.0F));

		PartDefinition RightFrontUpperLeg = RightFrontLeg.addOrReplaceChild("RightFrontUpperLeg",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 1.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition RightFrontMidLeg = RightFrontUpperLeg.addOrReplaceChild("RightFrontMidLeg",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.6749F, -0.456F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition LeftFrontLeg = partdefinition.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.9F, 17.0F, -6.225F, 0.0F, -0.4363F, 0.0F));

		PartDefinition LeftFrontUpperLeg3 = LeftFrontLeg.addOrReplaceChild("LeftFrontUpperLeg3",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 4.742F, 2.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition LeftFrontMidLeg3 = LeftFrontUpperLeg3.addOrReplaceChild("LeftFrontMidLeg3",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.6749F, -0.456F, -0.7854F, 0.0F, 0.0F));

		PartDefinition MidLeg_r2 = LeftFrontMidLeg3.addOrReplaceChild("MidLeg_r2",
				CubeListBuilder.create().texOffs(52, 16).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));

		PartDefinition LeftFrontLowerLeg3 = LeftFrontMidLeg3.addOrReplaceChild("LeftFrontLowerLeg3",
				CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 2.535F, 1.9715F, 1.0908F, 0.0F, 0.0F));

		PartDefinition LowerLeg_r2 = LeftFrontLowerLeg3.addOrReplaceChild("LowerLeg_r2",
				CubeListBuilder.create().texOffs(36, 25).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackUpperLeg = LeftBackLeg.addOrReplaceChild("LeftBackUpperLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 4.742F, 1.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition RightBackLeg = partdefinition.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1F, 17.0F, 5.775F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition MidLeg_r4 = RightBackMidLeg.addOrReplaceChild("MidLeg_r4",
				CubeListBuilder.create().texOffs(52, 16).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition LowerLeg_r4 = RightBackLowerLeg.addOrReplaceChild("LowerLeg_r4",
				CubeListBuilder.create().texOffs(36, 25).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
