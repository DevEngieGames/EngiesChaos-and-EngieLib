...
public class Modelboyorockylay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyorockylay"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TobyWhiskers = Head.addOrReplaceChild("TobyWhiskers", CubeListBuilder.create(),
				PartPose.offset(2.989F, -0.5131F, -8.0F));
		...
		PartDefinition cube_r5 = Fin.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(44, 31).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.4875F, 0.0F, 0.0F, 0.0F, -0.4363F, 0.0F));

		PartDefinition cube_r6 = Fin.addOrReplaceChild("cube_r6",
