...
public class Modeltonysleep<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tonysleep"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Tony.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)).texOffs(0, 110)
						.addBox(-5.125F, -7.0F, -8.5F, 1.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-2.1F, -1.5F, -10.025F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(0, 9)
