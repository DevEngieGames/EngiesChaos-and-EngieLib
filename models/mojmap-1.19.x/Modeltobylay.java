...
public class Modeltobylay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tobylay"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)).texOffs(36, 28)
						.addBox(-5.0F, -6.5F, -9.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(64, 13)
						.addBox(-4.0F, -7.0F, -8.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 55)
						.addBox(-3.0F, -7.5F, -7.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 56)
						.addBox(-2.0F, -8.0F, -6.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 32)
						.addBox(-1.0F, -8.5F, -5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-7.0F, -5.5F, -11.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 15)
						.addBox(-6.0F, -6.0F, -10.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 17.5F, -5.025F));

		PartDefinition Whisker_r1 = Head.addOrReplaceChild("Whisker_r1",
				CubeListBuilder.create().texOffs(80, 89).addBox(-2.0F, -1.5F, 0.0F, 2.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -0.5F, -8.5F, 0.0F, -0.2618F, 0.0F));

		PartDefinition Whisker_r2 = Head.addOrReplaceChild("Whisker_r2",
				CubeListBuilder.create().texOffs(80, 92).addBox(0.0F, -1.5F, 0.0F, 2.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -0.5F, -8.5F, 0.0F, 0.2618F, 0.0F));

		PartDefinition HeadFin_r1 = Head.addOrReplaceChild("HeadFin_r1",
				CubeListBuilder.create().texOffs(0, 68).addBox(-0.25F, -1.0F, 0.0F, 6.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28)
						.addBox(-5.1F, 0.025F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(60, 55)
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 16.1F, 0.025F, -1.4399F, 0.0F, 0.0F));

		PartDefinition TailPrimary = Tail.addOrReplaceChild("TailPrimary", CubeListBuilder.create(),
				PartPose.offset(0.0F, -2.0F, -3.95F));
		...
		PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1",
				CubeListBuilder.create().texOffs(80, 37)
						.addBox(-2.0F, 3.75F, -0.8F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(48, 19)
						.addBox(-2.0F, 3.75F, -0.8F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = Collar.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(92, 81)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.05F)).texOffs(92, 81)
		...
		PartDefinition cube_r2 = Collar.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(74, 79).addBox(-5.0F, 0.5F, -0.5F, 10.0F, 1.0F, 1.0F,
		...
		PartDefinition Bell = Collar.addOrReplaceChild("Bell",
				CubeListBuilder.create().texOffs(90, 94)
						.addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).texOffs(90, 89)
		...
		PartDefinition cube_r4 = Bell.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(90, 94).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F,
		...
		PartDefinition cube_r6 = Bell.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(90, 94).mirror()
		...
		PartDefinition UpperLeg_r1 = RightFrontUpperLeg.addOrReplaceChild("UpperLeg_r1",
				CubeListBuilder.create().texOffs(80, 46)
						.addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.111F)).texOffs(56, 0)
