...
public class Modelcosmolay<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cosmolay"), "main");
	private final ModelPart Cosmo;
	...
	public Modelcosmolay(ModelPart root) {
		this.Cosmo = root.getChild("Cosmo");
		this.Body = this.Cosmo.getChild("Body");
		...
		this.Head = this.Cosmo.getChild("Head");
		this.bone = this.Head.getChild("bone");
		this.bone2 = this.Head.getChild("bone2");
		this.RightFrontLeg = this.Cosmo.getChild("RightFrontLeg");
		...
		this.LeftFrontLeg = this.Cosmo.getChild("LeftFrontLeg");
		...
		this.RightBackLeg = this.Cosmo.getChild("RightBackLeg");
		...
		this.LeftBackLeg = this.Cosmo.getChild("LeftBackLeg");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Cosmo = partdefinition.addOrReplaceChild("Cosmo", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Body = Cosmo.addOrReplaceChild("Body",
				...
				PartPose.offsetAndRotation(-0.1F, -6.6F, 2.475F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition base2 = base.addOrReplaceChild("base2",
				...
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.2356F, 0.0F, 0.0F));
		...
		PartDefinition mid1a = mid1.addOrReplaceChild("mid1a",
				CubeListBuilder.create().texOffs(107, 33).addBox(-2.75F, -2.75F, 0.0F, 5.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.0175F, 0.0F, 0.0F));
		...
		PartDefinition mid2 = mid1a.addOrReplaceChild("mid2", CubeListBuilder.create().texOffs(114, 42).addBox(-2.125F,
				-2.125F, 0.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.025F)), PartPose.offset(0.0F, 0.0F, 2.8125F));
		...
		PartDefinition Head = Cosmo.addOrReplaceChild("Head",
				...
				PartPose.offset(0.0F, -5.5F, -5.525F));
		...
		PartDefinition RightFrontLeg = Cosmo.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1F, -7.0F, -6.225F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition LeftFrontLeg = Cosmo.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.9F, -7.0F, -6.225F, 0.0F, -0.4363F, 0.0F));
		...
		PartDefinition RightBackLeg = Cosmo.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1F, -7.0F, 5.775F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition LeftBackLeg = Cosmo.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.9F, -7.0F, 5.775F, 0.0F, -0.4363F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
		...
		Cosmo.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
