...
public class Modelchamp<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "champ"), "main");
	...
	public Modelchamp(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Collar = Body.addOrReplaceChild("Collar", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.1F, -10.5502F, -0.4671F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition RightFrontLeg = Champ.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offset(-3.1F, -7.0F, -6.225F));
		...
		PartDefinition LeftFrontLeg = Champ.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
				PartPose.offset(2.9F, -7.0F, -6.225F));
		...
		PartDefinition RightBackLeg = Champ.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offset(-3.1F, -7.0F, 5.775F));
		...
		PartDefinition LeftBackLeg = Champ.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(),
				PartPose.offset(2.9F, -7.0F, 5.775F));
