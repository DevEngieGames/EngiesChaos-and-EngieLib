...
public class Modelboyooldlay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyooldlay"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 27).addBox(-5.0F, 0.0F, -7.0F, 10.0F, 16.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition fin = Body.addOrReplaceChild("fin",
				CubeListBuilder.create().texOffs(26, 1)
						...
						.addBox(-0.5F, -2.0F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(64, 0)
						.addBox(-0.5F, 0.0F, -3.5F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.0F, 2.0F, -1.5708F, 0.0F, 0.0F));
