...
public class Modelhalloweenenraged<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "halloweenenraged"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(32, 0)
						...
						.addBox(1.15F, -4.125F, -4.1F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 8)
		...
		PartDefinition BackFin_r1 = Body.addOrReplaceChild("BackFin_r1",
				CubeListBuilder.create().texOffs(10, 9)
						.addBox(-1.0F, 2.0F, -3.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(10, 9)
		...
		PartDefinition TailFin_r1 = TailPrimary.addOrReplaceChild("TailFin_r1",
				CubeListBuilder.create().texOffs(8, 5)
						.addBox(-4.0F, 4.0F, -0.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 5)
		...
		PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1",
				CubeListBuilder.create().texOffs(8, 5).addBox(-2.0F, -1.075F, 0.375F, 4.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.875F, 0.85F, 1.9199F, 0.0F, 0.0F));

		PartDefinition Base_r2 = TailPrimary
				.addOrReplaceChild("Base_r2",
						CubeListBuilder.create().texOffs(8, 5).addBox(-2.0F, 0.75F, -0.8F, 4.0F, 8.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition Base_r3 = TailSecondary
				.addOrReplaceChild("Base_r3",
						CubeListBuilder.create().texOffs(8, 5).addBox(-1.5F, -1.3563F, -0.6088F, 3.0F, 5.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition Base_r4 = TailTertiary.addOrReplaceChild("Base_r4",
				CubeListBuilder.create().texOffs(8, 5)
						.addBox(-0.5F, 5.3462F, -1.8296F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F)).texOffs(8, 5)
		...
		PartDefinition Base_r5 = TailTertiary.addOrReplaceChild("Base_r5",
				CubeListBuilder.create().texOffs(8, 5)
						.addBox(-0.5F, -6.1668F, 0.8821F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 5)
		...
		PartDefinition Base_r6 = TailTertiary.addOrReplaceChild("Base_r6",
				CubeListBuilder.create().texOffs(8, 5).addBox(-1.0F, -0.3449F, -0.7203F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
