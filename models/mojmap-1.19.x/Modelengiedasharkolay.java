...
public class Modelengiedasharkolay<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "engiedasharkolay"), "main");
	private final ModelPart CBE;
	...
	public Modelengiedasharkolay(ModelPart root) {
		this.CBE = root.getChild("CBE");
		this.Body = this.CBE.getChild("Body");
		...
		this.Head = this.CBE.getChild("Head");
		this.RightFrontLeg = this.CBE.getChild("RightFrontLeg");
		...
		this.LeftFrontLeg = this.CBE.getChild("LeftFrontLeg");
		...
		this.RightBackLeg = this.CBE.getChild("RightBackLeg");
		...
		this.LeftBackLeg = this.CBE.getChild("LeftBackLeg");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition CBE = partdefinition.addOrReplaceChild("CBE", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Body = CBE.addOrReplaceChild("Body",
				...
				PartPose.offsetAndRotation(-0.1F, -7.75F, 2.475F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition shark_r1 = tip2.addOrReplaceChild("shark_r1",
				CubeListBuilder.create().texOffs(92, 24).addBox(-0.5F, -2.0F, -4.0F, 1.0F, 4.0F, 4.0F,
						new CubeDeformation(-0.025F)),
		...
		PartDefinition shark_r2 = tip2.addOrReplaceChild("shark_r2",
				CubeListBuilder.create().texOffs(79, 25).addBox(-0.5F, -1.5F, -2.0F, 1.0F, 7.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head = CBE.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						...
						.addBox(-5.0F, -6.5F, -9.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(48, 16)
						.addBox(-4.0F, -7.0F, -8.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(68, 39)
						.addBox(-3.0F, -7.5F, -7.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(88, 0)
						.addBox(-2.0F, -8.0F, -6.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 25)
				...
				PartPose.offset(0.0F, -6.75F, -5.525F));
		...
		PartDefinition RightFrontLeg = CBE.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
		...
		PartDefinition LeftFrontLeg = CBE.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
		...
		PartDefinition RightBackLeg = CBE.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
		...
		PartDefinition MidLeg_r1 = RightBackMidLeg.addOrReplaceChild("MidLeg_r1",
				CubeListBuilder.create().texOffs(112, 10)
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).texOffs(112, 65)
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.11F)),
		...
		PartDefinition LeftBackLeg = CBE.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(),
		...
		PartDefinition MidLeg_r2 = LeftBackMidLeg.addOrReplaceChild("MidLeg_r2",
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
		...
		CBE.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
