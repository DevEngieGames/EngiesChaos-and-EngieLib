...
public class Modelnightmarehostile<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "nightmarehostile"), "main");
	...
	public Modelnightmarehostile(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = bone.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(32, 0)
				.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(64, 0)
				.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(0, 29)
				.addBox(1.0F, -5.0F, -4.101F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)).texOffs(0, 20)
				.addBox(1.0F, -5.0F, -4.302F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.3F)).texOffs(0, 29)
				.addBox(1.0F, -5.0F, -4.403F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.4F)).texOffs(0, 29).mirror()
				.addBox(-3.0F, -5.0F, -4.101F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false)
				.texOffs(6, 20).addBox(-3.0F, -5.0F, -4.302F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.3F))
				.texOffs(0, 29).mirror().addBox(-3.0F, -5.0F, -4.403F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.4F))
				.mirror(false).texOffs(0, 10).addBox(-4.025F, -1.6F, -4.025F, 8.05F, 1.525F, 8.05F,
						new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Lh2_r1 = Head.addOrReplaceChild("Lh2_r1",
				CubeListBuilder.create().texOffs(16, 21)
						.addBox(4.025F, 0.325F, -2.0F, 1.3F, 4.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(27, 20)
						.addBox(4.075F, 1.125F, -1.2F, 1.4F, 2.4F, 2.4F, new CubeDeformation(0.025F)).texOffs(0, 32)
						.addBox(4.025F, -0.175F, -2.0F, 0.8F, 5.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(0, 32)
						.addBox(4.025F, 0.325F, -2.5F, 0.8F, 4.0F, 5.0F, new CubeDeformation(0.025F)).texOffs(27, 20)
						.addBox(-5.475F, 1.125F, -1.2F, 1.4F, 2.4F, 2.4F, new CubeDeformation(0.025F)).texOffs(16, 21)
						.addBox(-5.275F, 0.325F, -2.0F, 1.3F, 4.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(0, 32)
						.addBox(-4.775F, -0.175F, -2.0F, 0.8F, 5.0F, 4.0F, new CubeDeformation(0.025F)).texOffs(0, 32)
						.addBox(-4.775F, 0.325F, -2.5F, 0.8F, 4.0F, 5.0F, new CubeDeformation(0.025F)).texOffs(0, 32)
						.addBox(-4.375F, -1.925F, -1.0F, 0.4F, 2.95F, 2.0F, new CubeDeformation(0.0F)).texOffs(18, 35)
						.addBox(-4.75F, -2.45F, -0.5F, 0.5F, 0.5F, 1.0F, new CubeDeformation(0.025F)).texOffs(18, 35)
						.addBox(4.3F, -2.45F, -0.5F, 0.5F, 0.5F, 1.0F, new CubeDeformation(0.025F)).texOffs(0, 32)
						.addBox(-4.775F, -2.325F, 0.5F, 0.3F, 2.15F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-4.775F, -2.325F, -1.0F, 0.3F, 2.15F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(4.525F, -2.325F, -1.0F, 0.3F, 2.15F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(4.525F, -2.325F, 0.5F, 0.3F, 2.15F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(4.025F, -1.925F, -1.0F, 0.4F, 2.95F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-4.225F, -2.075F, -1.0F, 8.5F, 0.4F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-4.625F, -2.475F, -1.0F, 9.3F, 0.3F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 32)
		...
		PartDefinition Body = bone.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(56, 32)
		...
		PartDefinition Hood = Body.addOrReplaceChild("Hood", CubeListBuilder.create().texOffs(0, 7)
				.addBox(-4.2513F, -0.1224F, -3.3532F, 8.5F, 2.0F, 6.925F, new CubeDeformation(0.0F)).texOffs(0, 7)
				.addBox(-4.2513F, 1.3026F, -1.8532F, 8.5F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
		...
		PartDefinition cube_r15 = Hood.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 7).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = Hood.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(0, 7).addBox(-4.225F, -0.6625F, -2.0F, 8.45F, 1.325F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = Hood.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.725F, -4.025F, 1.0F, 1.45F, 8.05F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg = bone.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 32)
		...
		PartDefinition RightArm = bone.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(80, 16)
						.addBox(-4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 32)
						.addBox(-4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(-4.0F, 2.0F, 0.0F, 0.0F, -0.0873F, 0.0F));
