...
public class Modelchamplay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "champlay"), "main");
	...
	private final ModelPart LeftBackUpperLeg3;
	private final ModelPart LeftBackMidLeg3;
	private final ModelPart LeftBackLowerLeg3;
	private final ModelPart LeftBackFoot3;
	private final ModelPart LeftFrontLeg;
	private final ModelPart LeftBackUpperLeg4;
	private final ModelPart LeftBackMidLeg4;
	private final ModelPart LeftBackLowerLeg4;
	private final ModelPart LeftBackFoot4;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = Champ.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28)
						.addBox(-5.1F, 0.025F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(33, 72)
						.addBox(-5.1F, 0.025F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.125F)),
		...
		PartDefinition Collar = Body.addOrReplaceChild("Collar", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -0.0252F, 1.5329F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Collar.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(124, 113)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.05F)).texOffs(124, 113)
		...
		PartDefinition cube_r2 = Collar.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(106, 111).addBox(-5.0F, 0.5F, -0.5F, 10.0F, 1.0F, 1.0F,
						new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0F, 1.0252F, -0.1829F, -0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Collar.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(106, 111).addBox(-5.0F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F,
						new CubeDeformation(0.05F)),
				PartPose.offsetAndRotation(0.0F, -2.0498F, 0.3671F, -0.1745F, 0.0F, 0.0F));

		PartDefinition Bell = Collar.addOrReplaceChild("Bell",
				CubeListBuilder.create().texOffs(122, 126)
						.addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).texOffs(122, 121)
						.addBox(-1.0F, 0.5F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 2.9752F, -0.2579F));

		PartDefinition cube_r4 = Bell.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(122, 126).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.075F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, 0.0F, 3.1416F));

		PartDefinition cube_r5 = Bell.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(122, 126).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.075F)),
				PartPose.offsetAndRotation(-1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r6 = Bell.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(122, 126).mirror()
						.addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false),
				PartPose.offsetAndRotation(1.5F, 1.5F, 0.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition tail = Body.addOrReplaceChild("tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.15F, 35.7F, -18.975F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition mid1a = mid1.addOrReplaceChild("mid1a",
				CubeListBuilder.create().texOffs(107, 33).addBox(-2.75F, -2.75F, 0.0F, 5.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.0611F, 0.0F, 0.0F));
		...
		PartDefinition Head = Champ.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)).texOffs(0, 12)
						.addBox(-2.1F, -1.5F, -10.025F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(0, 16)
						.addBox(-2.1F, 0.0F, -9.775F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(0, 0)
						.addBox(-5.0F, -6.0F, -9.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.05F)).texOffs(2, 0)
						.addBox(3.5F, -6.5F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
						.addBox(-5.5F, -6.5F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(3, 2)
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(3, 2)
						.addBox(-4.0F, -7.65F, -7.9F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(6, 4)
						.addBox(-3.0F, -8.95F, -6.5F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(6, 4)
						.addBox(-3.0F, -7.8F, -6.7F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.5F)).texOffs(9, 6)
						.addBox(-2.0F, -8.85F, -5.3F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(9, 6)
						.addBox(-2.0F, -9.65F, -5.1F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(12, 8)
						.addBox(-1.0F, -9.55F, -3.9F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.5F)).texOffs(12, 8)
						.addBox(-1.0F, -10.45F, -3.7F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(15, 10)
						.addBox(0.0F, -10.1F, -3.4F, 0.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -6.5F, -5.525F));

		PartDefinition Snout_r1 = Head.addOrReplaceChild("Snout_r1",
				CubeListBuilder.create().texOffs(22, 12).addBox(0.0F, 1.01F, 0.0F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.1F, -1.01F, -9.775F, 0.0F, -0.4625F, 0.0F));

		PartDefinition Snout_r2 = Head.addOrReplaceChild("Snout_r2",
				CubeListBuilder.create().texOffs(22, 12).addBox(-2.0F, 1.01F, 0.0F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.9F, -1.01F, -9.775F, 0.0F, 0.4625F, 0.0F));

		PartDefinition Snout_r3 = Head.addOrReplaceChild("Snout_r3",
				CubeListBuilder.create().texOffs(12, 12).addBox(0.0F, 0.01F, 0.0F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.1F, -1.51F, -10.025F, 0.0F, -0.4625F, 0.0F));

		PartDefinition Snout_r4 = Head.addOrReplaceChild("Snout_r4",
				CubeListBuilder.create().texOffs(12, 12).addBox(-2.0F, 0.01F, 0.0F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone = Head.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(0.0F, -3.9429F, -4.25F));

		PartDefinition cube_r7 = bone.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(1, 8)
						.addBox(-3.3284F, 2.3284F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-2.6213F, 1.6213F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-1.9142F, 0.9142F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-1.2071F, 0.2071F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-0.5F, -0.5F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(0.2071F, -1.2071F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(0.9142F, -1.9142F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(1.6213F, -2.6213F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(2.3284F, -3.3284F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-3.3284F, 2.3284F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-2.6213F, 1.6213F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-1.9142F, 0.9142F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-1.2071F, 0.2071F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(-0.5F, -0.5F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(0.2071F, -1.2071F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(0.9142F, -1.9142F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(1.6213F, -2.6213F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 8)
						.addBox(2.3284F, -3.3284F, 3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition bone2 = Head.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -3.9429F, -4.25F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition RightFrontLeg = Champ.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1F, -0.9F, -5.225F, 0.0F, 0.4363F, 0.0F));

		PartDefinition LeftBackUpperLeg3 = RightFrontLeg.addOrReplaceChild("LeftBackUpperLeg3",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -1.358F, 0.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackMidLeg3 = LeftBackUpperLeg3.addOrReplaceChild("LeftBackMidLeg3",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.0499F, -0.331F, -0.7854F, 0.0F, 0.0F));

		PartDefinition MidLeg_r1 = LeftBackMidLeg3.addOrReplaceChild("MidLeg_r1",
				CubeListBuilder.create().texOffs(112, 65)
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.11F)).texOffs(112, 10)
		...
		PartDefinition LeftBackLowerLeg3 = LeftBackMidLeg3.addOrReplaceChild("LeftBackLowerLeg3",
				CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 2.535F, 1.9715F, 1.0908F, 0.0F, 0.0F));

		PartDefinition LowerLeg_r1 = LeftBackLowerLeg3.addOrReplaceChild("LowerLeg_r1",
				CubeListBuilder.create().texOffs(114, 74)
						.addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.1091F)).texOffs(114, 19)
		...
		PartDefinition LeftFrontLeg = Champ.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.9F, -0.9F, -5.225F, 0.0F, -0.4363F, 0.0F));

		PartDefinition LeftBackUpperLeg4 = LeftFrontLeg.addOrReplaceChild("LeftBackUpperLeg4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -1.358F, 0.0175F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackMidLeg4 = LeftBackUpperLeg4.addOrReplaceChild("LeftBackMidLeg4",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.01F, 3.0499F, -0.331F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition LeftBackLowerLeg4 = LeftBackMidLeg4.addOrReplaceChild("LeftBackLowerLeg4",
				CubeListBuilder.create(), PartPose.offsetAndRotation(-0.005F, 2.535F, 1.9715F, 1.0908F, 0.0F, 0.0F));
		...
		PartDefinition RightBackLeg = Champ.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1F, -0.9F, 6.775F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition LeftBackLeg = Champ.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.9F, -0.9F, 6.775F, 0.0F, -0.4363F, 0.0F));
		...
		PartDefinition LeftBackMidLeg = LeftBackUpperLeg.addOrReplaceChild("LeftBackMidLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.01F, 3.0499F, -0.331F, -0.7854F, 0.0F, 0.0F));
